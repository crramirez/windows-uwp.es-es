...
Visual Studio puede configurarse para volver a implementar el paquete principal cada vez que implementa un paquete opcional. Para establecer la dependencia de compilación en Visual Studio, debes:
