...
Eso es todo lo que tendrás que hacer para que el último archivo `AppxContentGroupMap.xml` esté listo en la aplicación. Aún hay más que hacer antes de que su aplicación está totalmente preparada para la Store de Microsoft. Para obtener más información sobre el proceso completo de la instalación en streaming de aplicaciones para UWP, consulta [esta entrada de blog](https://blogs.msdn.microsoft.com/appinstaller/2017/03/15/uwp-streaming-app-installation/).
