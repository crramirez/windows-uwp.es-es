...
En las propiedades de la aplicación web, selecciona la pestaña de la **Web** . En la sección de **servidores** , elija **IIS Local** en el menú desplegable y haz clic en **Crear directorio Virtual**. 
...
Una vez que se crea la página HTML, haz clic con el botón derecho en la página HTML en el Explorador de soluciones y seleccione **Establecer como página de inicio**.  
...
Incluir el siguiente código HTML en la página web. La clave para invocar correctamente el instalador de aplicación es usar el esquema personalizado que registra el instalador de aplicación con el sistema operativo: `ms-appinstaller:?source=`. Vea el ejemplo de código siguiente para obtener más detalles.
