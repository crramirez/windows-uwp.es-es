...
Este diseño de empaquetado creará un solo archivo plano .appxbundle con un paquete de arquitectura x64 y otro paquete de activos "Media". 
...
El elemento **PrebuiltPackage** se usa para agregar paquetes que no están definidos en el diseño de empaquetado para incluirse o referenciarse en el archivo o archivos .appxbundle que se van a crear. En este caso, aquí se incluye otro paquete opcional DLC para que pueda hacerse referenciar al archivo appxbundle principal y tenerlo como parte del conjunto relacionado.
