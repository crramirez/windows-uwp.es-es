...
- [Portal de dispositivos para Xbox](device-portal-xbox.md)
...
La página de seguimiento de rendimiento permite ver el [Windows Performance Recorder (WPR)](https://msdn.microsoft.com/library/hh448205.aspx) seguimientos desde el dispositivo host.
...
Captura. Se pueden abrir los archivos ETL para su análisis en el [Windows Performance Analyzer](https://msdn.microsoft.com/library/windows/desktop/hh448170.aspx).
