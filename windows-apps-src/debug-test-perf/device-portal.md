...
Windows Device Portal es un servidor web en el dispositivo puede conectarse a desde un explorador web en un equipo. Si el dispositivo tiene un explorador web, también puedes conectarte localmente con el explorador en ese dispositivo.
...
- **Energía**: acceder a opciones de energía.
...
El Administrador de aplicaciones proporciona instalación o desinstalación de paquetes de funcionalidad de administración de aplicación y lotes en el dispositivo host.

![Página de administrador de aplicaciones de Portal de dispositivo](images/device-portal/wdp-apps.png)

- **Las aplicaciones instaladas**: usar el menú desplegable para quitar o iniciar las aplicaciones que están instaladas en el dispositivo. Instalar una nueva aplicación haciendo clic en **Agregar**. Esto inicia la instalación de experiencia de usuario para implementar las aplicaciones empaquetadas desde local, red o web hospeda y registrar en archivos sueltos desde recursos compartidos de red.
...
3.  Haga clic en **Examinar** y busca el paquete de la aplicación.
...
- **GPU**: por ciento de GPU disponible total del motor de utilización
...
- **Historial de proveedores**: muestra los proveedores de ETW que estaban habilitados durante la sesión actual. Haz clic o pulsa en **Activar** para activar un proveedor deshabilitado. Haz clic o pulsa en **Borrar** para borrar el historial.
