...
**Herramienta Capacidad de respuesta de interfaz de usuario XAML en Visual Studio**. Una de las mejores herramientas para usar a la hora de medir el impacto en el rendimiento de tu aplicación es la herramienta Capacidad de respuesta de interfaz de usuario XAML. Esta se ha [actualizado](https://devblogs.microsoft.com/wpf/new-ui-performance-analysis-tool-for-wpf-applications/) para admitir aún más escenarios.

Consulte también:

|           |             |
|-----------|-------------|
| [Analizar el rendimiento de las aplicaciones para UWP con las herramientas de diagnóstico de Visual Studio](https://docs.microsoft.com/visualstudio/profiling/profiling-tools) | Al mostrar en qué punto invierte el tiempo el código tu aplicación durante la ejecución del programa, los perfiles de Visual Studio pueden ayudarte a encontrar los cuellos de botella de rendimiento en tus aplicaciones, funciones y algoritmos. |
| [Rendimiento de XAML: Técnicas para maximizar las experiencias de las aplicaciones universales de Windows compiladas con XAML](https://channel9.msdn.com/Events/Build/2015/3-698) | En esta sesión //build, aprenderás sobre las características de la nueva plataforma, sobre las nuevas características de herramientas y técnicas para aumentar significativamente el rendimiento de tu aplicación universal de Windows basada en XAML. |
| [Nuevas herramientas de XAML en Visual Studio](https://channel9.msdn.com/Events/Build/2015/2-697) | En esta sesión //build, aprenderás sobre algunas de las nuevas capacidades de Visual Studio 2015, incluida la experiencia de Blend rediseñada, las herramientas de depuración de la interfaz de usuario y las mejoras del editor de XAML. Estas herramientas también están disponibles en Visual Studio 2019 |
