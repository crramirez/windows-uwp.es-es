...
[**CoreDispatcher.RunIdleAsync** ](https://docs.microsoft.com/uwp/api/windows.ui.core.coredispatcher.runidleasync) pone en cola trabajos para que el subproceso de interfaz de usuario procesar cuando no está ocupado.
...
> **Tenga en cuenta**  también hay un [ **ThreadPool** ](https://docs.microsoft.com/uwp/api/Windows.System.Threading.ThreadPool) y [ **ThreadPoolTimer** ](https://docs.microsoft.com/uwp/api/windows.system.threading.threadpooltimer) API para UWP, que puede ser se utiliza para escenarios similares. Para obtener más información, consulta [Subprocesamiento y programación asincrónica](https://docs.microsoft.com/windows/uwp/threading-async/index).
