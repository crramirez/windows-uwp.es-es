...
> **Nota**  La versión de depuración de una aplicación producirá esta prueba, incluso si la aplicación utiliza sólo [las API para aplicaciones UWP](https://msdn.microsoft.com/library/windows/apps/xaml/bg124285.aspx).
...
> **Nota**  Esta prueba sólo se aplica a aplicaciones UWP desarrolladas para Windows 8.1 y posterior.
