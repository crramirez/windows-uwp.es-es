...
-   Animaciones de las propiedades [**Canvas.Left**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.left?view=netframework-4.8) y [**Canvas.Top**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.top?view=netframework-4.8)
...
-   Animaciones de las siguientes propiedades [**UIElement**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.UIElement) cuando tienen como destino las subpropiedades de esos tipos de valores devueltos:
    ...
    -   [**Proyección**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.projection)
