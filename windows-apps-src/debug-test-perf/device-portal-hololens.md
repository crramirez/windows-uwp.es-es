...
> [!IMPORTANT]
> Si tu equipo no puede encontrar el dispositivo, prueba a usar la dirección IP de red real del dispositivo HoloLens, en lugar de `http://127.0.0.1:10080`.
