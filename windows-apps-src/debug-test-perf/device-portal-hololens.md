...
2. Buscar la dirección IP del dispositivo. Busque la dirección IP en el dispositivo en **configuración > red & Internet > Wi-Fi > hardware propiedades**. También puede decir: "Hola Cortana, ¿cuál es mi dirección IP?"
...
> [!IMPORTANT]
> Si el equipo no encuentra el dispositivo, pruebe a usar la dirección IP de red real del dispositivo HoloLens, en lugar de `http://127.0.0.1:10080`.
