...
2. Busca la dirección IP de tu dispositivo. Busca la dirección IP en el dispositivo en **configuración > red & > Wi-Fi > Hardware propiedades de Internet**. También puede decir: "Hola Cortana, ¿cuál es mi dirección IP?"
