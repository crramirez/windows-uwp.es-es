...
## Configurar Device Portal en HoloLens
...
7. 
            [Desplázate hacia abajo](https://dev.windows.com/holographic/Gestures.html#Navigation) y habilita Device Portal.
...
### Página de volcados de memoria de la aplicación 
