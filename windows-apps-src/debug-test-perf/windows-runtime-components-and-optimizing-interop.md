...
---
# <a name="universal-windows-platform-components-and-optimizing-interop"></a>Componentes de la Plataforma universal de Windows y optimización de la interoperabilidad
