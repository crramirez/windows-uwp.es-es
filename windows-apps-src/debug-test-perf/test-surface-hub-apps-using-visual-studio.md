...
Para obtener más información, consulta [Ejecutar aplicaciones de la Tienda Windows en el simulador](https://msdn.microsoft.com/en-us/library/hh441475.aspx).
...
4. Ejecuta la aplicación en el emulador de Visual Studio. Haz clic en el botón **Cambiar resolución** en la paleta y selecciona una configuración de Surface Hub en la lista.
   ...
   > **Sugerencia**&nbsp;&nbsp;[Activa el modo de tableta](http://windows.microsoft.com/en-us/windows-10/getstarted-like-a-tablet) para simular mejor la experiencia en un Surface Hub.
...
> **Nota**&nbsp;&nbsp;Después de que se haya habilitado el modo de desarrollador, deberás restablecer el Surface Hub para deshabilitarlo de nuevo. Al restablecer el dispositivo se eliminan todas las configuraciones y los archivos de usuario locales y luego se vuelve a instalar Windows.

1. En el menú **Inicio** de Surface Hub, abre la aplicación Configuración.

   >  **Nota**&nbsp;&nbsp;Se requieren privilegios administrativos para tener acceso a la aplicación Configuración.
...
Para obtener más información, consulta [Implementación y depuración de las aplicaciones de la Plataforma universal de Windows (UWP)](https://msdn.microsoft.com/en-us/windows/uwp/debug-test-perf/deploying-and-debugging-uwp-apps).
...
2. Escribe la dirección IP del Surface Hub. Asegúrate de que el modo de autenticación **Universal** está seleccionado.
   ...
   > **Sugerencia**&nbsp;&nbsp;Después de haber habilitado el modo de desarrollador, encontrarás la dirección IP del Surface Hub en la pantalla de bienvenida.
...
3. Elige **Iniciar depuración (F5)** para implementar y depurar la aplicación en el Surface Hub o presiona Ctrl+F5 para implementar únicamente la aplicación.
   ...
   > **Sugerencia**&nbsp;&nbsp;Si se encuentra el Surface Hub en la pantalla de bienvenida, descártalo seleccionando cualquier botón.
