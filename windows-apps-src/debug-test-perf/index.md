...
description: Usar Microsoft Visual Studio y otras herramientas para depurar y probar la aplicación y prepararla para el proceso de certificación de Microsoft Store.
ms.date: 02/08/2017
ms.topic: article
