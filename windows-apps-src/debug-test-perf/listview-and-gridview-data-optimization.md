...
[**IItemsRangeInfo**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.IItemsRangeInfo) proporciona información sobre los elementos que el control está usando activamente. El control de elementos llamará a este método siempre que cambie su vista e incluirá estos dos conjuntos de intervalos.
