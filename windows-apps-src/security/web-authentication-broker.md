...
**Nota** Para obtener una muestra completa y funcional del código, clona el [repositorio WebAuthenticationBroker en GitHub](http://go.microsoft.com/fwlink/p/?LinkId=620622).
