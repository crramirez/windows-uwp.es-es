...
**Sugerencia** Puedes usar makecert.exe para crear un archivo PFX para usar con este inicio rápido. Para obtener información sobre cómo usar makecert.exe, consulta [MakeCert.](https://msdn.microsoft.com/library/windows/desktop/aa386968)
