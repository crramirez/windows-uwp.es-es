...
# [Referencia de identificador de recursos universal (URI)](uri/atoc-xboxlivews-reference-uris.md)
## [URI de logros](uri/achievements/atoc-reference-achievementsv2.md)
...
## [URI de servidor de juego](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [URI de DVR de juego](uri/dvr/atoc-reference-dvr.md)
...
## [URI de Gamerpic](uri/gamerpic/atoc-reference-gamerpic.md)
### [/users/me/gamerpic](uri/gamerpic/uri-usersmegamerpic.md)
#### [PUT (/users/me/gamerpic)](uri/gamerpic/uri-usersmegamerpicput.md)
## [URI de tablas de clasificación](uri/leaderboard/atoc-reference-leaderboard.md)
...
## [URI de listas](uri/lists/atoc-reference-lists.md)
...
## [URI concordantes](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [URI de personas](uri/people/atoc-reference-people.md)
...
## [URI de presencia](uri/presence/atoc-reference-presence.md)
...
## [URI de privacidad](uri/privacy/atoc-reference-privacyv2.md)
...
## [URI de perfiles](uri/profileV2/atoc-reference-profiles.md)
...
## [URI de reputación](uri/reputation/atoc-reference-reputation.md)
...
## [URI de directorio de sesión](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [URI de historial de títulos de logros](uri/titlehistory/atoc-reference-titlehistoryv2.md)
...
## [URI de almacenamiento de títulos](uri/storage/atoc-reference-storagev2.md)
...
## [URI de validación de cadenas de sistema](uri/stringserver/atoc-reference-systemstringsvalidate.md)
...
## [URI de usuarios](uri/users/atoc-reference-users.md)
...
## [URI de estadísticas de usuario](uri/userstats/atoc-reference-userstats.md)
...
# [Referencia de objeto de notación de objetos JavaScript (JSON)](json/atoc-xboxlivews-reference-json.md)
## [Logro (JSON)](json/json-achievementv2.md)
...
## [Miniatura de GameClip (JSON)](json/json-gameclipthumbnail.md)
...
## [Persona (JSON)](json/json-person.md)
## [PersonSummary (JSON)](json/json-personsummary.md)
## [Reproductor (JSON)](json/json-player.md)
## [PresenceRecord (JSON)](json/json-presencerecord.md)
## [Perfil (JSON)](json/json-profile.md)
## [Progresión (JSON)](json/json-progression.md)
## [Propiedad (JSON)](json/json-property.md)
...
## [Recompensa (JSON)](json/json-reward.md)
...
## [Usuario (JSON)](json/json-user.md)
...
# [Enumeraciones usadas en objetos de que utilizan en notación de objetos JavaScript (JSON)](enums/atoc-xboxlivews-reference-enums.md)
## [Enumeración de GameClipSource](enums/gvr-enum-gameclipsource.md)
## [Enumeración de GameClipState](enums/gvr-enum-gameclipstate.md)
## [Enumeración de GameClipType](enums/gvr-enum-gamecliptypes.md)
## [Enumeración de GameClipUriType](enums/gvr-enum-gameclipuritype.md)
## [Enumeración de GameClipVisibility](enums/gvr-enum-gameclipvisibility.md)
## [Enumeración de ThumbnailSource](enums/gvr-enum-thumbnailsource.md)
## [Enumeración de ThumbnailType](enums/gvr-enum-thumbnailtype.md)
## [Enumeración de PermissionId](enums/privacy-enum-permissionid.md)
# [Referencia adicional](additional/atoc-xboxlivews-reference-additional.md)
## [Tipos de autorización](additional/authorizationtypes.md)
## [Información general sobre el tipo de datos](additional/datatypeoverview.md)
## [API de EDS auxiliares](additional/eds-apis.md)
## [Autorización de EDS](additional/edsauthorization.md)
## [Títulos comunes de EDS](additional/edscommonheaders.md)
## [Parámetros de EDS](additional/edsparameters.md)
## [Refinadores de consulta EDS](additional/edsqueryrefiners.md)
## [Búsqueda inversa de EDS para vídeo](additional/edsreverselookup.md)
## [Tablas de EDS](additional/edstables.md)
## [Parámetros de paginación](additional/pagingparameters.md)
## [Solicitud HTTP estándar y títulos de respuesta](additional/httpstandardheaders.md)
## [Códigos de estado HTTP estándar](additional/httpstatuscodes.md)
