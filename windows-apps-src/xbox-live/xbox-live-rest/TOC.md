# [Referencia de RESTful de los Servicios de Xbox Live](atoc-xboxlivews-reference.md)
...
## [URI de servidor de juegos](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [URI de Game DVR](uri/dvr/atoc-reference-dvr.md)
...
## [URI de marcadores](uri/leaderboard/atoc-reference-leaderboard.md)
...
# [Enumeraciones usadas en objetos de notación de objetos JavaScript (JSON)](enums/atoc-xboxlivews-reference-enums.md)
