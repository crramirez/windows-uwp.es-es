...
El objeto GetClipResponse tiene la especificación siguiente.
 
| Miembro| Tipo| Descripción| 
| --- | --- | --- | 
| gameClip| [GameClip](json-gameclip.md)| Un solo juego clip que satisface la consulta.| 
