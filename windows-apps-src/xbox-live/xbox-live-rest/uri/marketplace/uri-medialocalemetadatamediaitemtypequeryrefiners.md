...
Tiene acceso a los refinadores de consulta para los medios de determinado tipo de elemento. Es el dominio para estos URI `eds.xboxlive.com`.
...
&nbsp;&nbsp;Enumera los refinadores de consulta para el tipo de elemento de medio determinado.
