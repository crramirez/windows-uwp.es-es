...
Enumera los valores aceptables para el nombre de la matriz de consulta determinada y tipo de elemento multimedia especificado. Es el dominio para estos URI `eds.xboxlive.com`.
