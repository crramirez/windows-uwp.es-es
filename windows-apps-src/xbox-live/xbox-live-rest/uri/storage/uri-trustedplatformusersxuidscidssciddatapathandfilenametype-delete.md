...
Elimina un archivo. Es el dominio para estos URI `titlestorage.xboxlive.com`.
 
  * [Parámetros de URI](#ID4EX)
  * [Autorización](#ID4EEB)
  * [Encabezados de solicitud necesarios](#ID4ERB)
  * [Encabezados de solicitud opcionales](#ID4E1C)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | 
| 200| Aceptar | El archivo se ha eliminado correctamente o no existe.| 
