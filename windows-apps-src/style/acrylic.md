...
## <a name="acrylic-and-the-fluent-design-system"></a>Acrylic y Fluent Design System
 ...
 Fluent Design System te ayuda a crear interfaces de usuario modernas y claras que incorporan luz, profundidad, movimiento, materiales y escala. Acrylic es un componente de Fluent Design System que agrega textura física (material) y profundidad a tu aplicación. 
...
## <a name="extending-acrylic-into-your-title-bar"></a>Extender el acrílico a la barra de título

Para obtener un aspecto unificado y fluido dentro de la ventana de la aplicación, se recomienda colocar acrílico en el área de la barra de título de la aplicación. Para ello, agrega el siguiente código a App.xaml.cs.
...
Además, deberás dibujar el título de la aplicación, que normalmente aparece automáticamente en la barra de título, con una clase TextBlock mediante `CaptionTextBlockStyle`.
