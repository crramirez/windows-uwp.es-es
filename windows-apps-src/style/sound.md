...
Por lo general, este sonido solo se reproduce cuando un usuario destina explícitamente un control simple o una parte del control a través de un [dispositivo de entrada](../input-and-devices/input-primer.md).
