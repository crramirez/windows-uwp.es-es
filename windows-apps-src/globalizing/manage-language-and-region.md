...
title: "Administrar el idioma y la región"
...
# <a name="manage-language-and-region"></a>Administrar el idioma y la región
...
<li>[**Espacio de nombres WinJS.Resources**](https://msdn.microsoft.com/library/windows/apps/br229779)</li>
</ul>
</div>
...
### <a name="users-can-set-their-language-preferences"></a>Los usuarios pueden establecer sus preferencias de idioma.
...
### <a name="specify-the-supported-languages-in-the-apps-manifest"></a>Especifica los idiomas admitidos en el manifiesto de la aplicación.
...
### <a name="specify-the-default-language"></a>Especifica el idioma predeterminado.
...
### <a name="qualify-resources-with-their-language"></a>Califica los recursos con su idioma.
...
### <a name="create-the-application-language-list"></a>Crea la lista de idiomas de la aplicación.
