...
## Implementar la interfaz IBasicAudioEffect
...
[!code-cs[Cerrar](./code/AudioGraph/AudioEffectComponent/ExampleAudioEffect.cs#SnippetClose)]
...
### Agregar el efecto personalizado a un nodo de AudioGraph
