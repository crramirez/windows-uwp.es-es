...
-   DRM de PlayReady ahora admite la especificación HDCP de tipo 1 (versión 2.2 o posterior). PlayReady cumple con la directiva en la licencia que debe aplicar el dispositivo. Esta característica puede habilitarse en la licencia del SDK del servidor PlayReady v3.0 (el servidor controla esta directiva en la licencia mediante el habilitador de reproducción **GUID**). Para obtener más información, consulta [PlayReady Compliance and Robustness Rules (Reglas de solidez y cumplimiento de PlayReady)](http://www.microsoft.com/playready/licensing/compliance/).
...
En lo relacionado con el administrador de protección multimedia, asegúrate de que el código tenga la siguiente configuración si no la tiene ya:
