...
## Conversión de multimedia integrada con MediaElement

La forma más sencilla de convertir multimedia desde una aplicación Universal de Windows es usar la funcionalidad de conversión integrada del control de [**MediaElement**](https://msdn.microsoft.com/library/windows/apps/br242926).

Para permitir al usuario que abra un archivo para reproducir con el control de **MediaElement**, agrega los siguientes espacios de nombres al proyecto.
...
Llama a [**PickSingleFileAsync**](https://msdn.microsoft.com/library/windows/apps/jj635275) para iniciar el cuadro de diálogo del selector de archivos. Cuando se devuelve este método, el resultado es un objeto [**StorageFile**](https://msdn.microsoft.com/library/windows/apps/br227171) que representa el archivo de vídeo. Comprueba que el archivo no es null, que sí lo será si el usuario cancela la operación de selección. Llama al método del archivo [**OpenAsync**](https://msdn.microsoft.com/library/windows/apps/br227221.aspx) para obtener una [**IRandomAccessStream**](https://msdn.microsoft.com/library/windows/apps/br241731) para el archivo. Por último, llama al método [**SetSource**](https://msdn.microsoft.com/library/windows/apps/br244338) del objeto **MediaElement** para lograr que el archivo de vídeo sea la fuente para el control.

[!code-cs[OpenButtonClick](./code/MediaCastingWin10/cs/MainPage.xaml.cs#SnippetOpenButtonClick)]

Una vez cargado el vídeo en la clase **MediaElement**, el usuario simplemente puede presionar el botón de conversión en los controles de transporte para iniciar un cuadro de diálogo integrado que le permite elegir un dispositivo al que se convierta el contenido multimedia cargado.

![botón de conversión de mediaelement](images/media-element-casting-button.png)

## Conversión de multimedia con el CastingDevicePicker

Una segunda forma de convertir multimedia con un dispositivo es usar la clase [**CastingDevicePicker**](https://msdn.microsoft.com/library/windows/apps/dn972525). Para usar esta clase, se incluye el espacio de nombres de [**Windows.Media.Casting**](https://msdn.microsoft.com/library/windows/apps/dn972568) en el proyecto.
...
Iniciar la transmisión de contenido multimedia llamando a [**RequestStartCastingAsync**](https://msdn.microsoft.com/library/windows/apps/dn972520), pasando el origen de conversión devuelto por una llamada al método **MediaElement** [**GetAsCastingSource**](https://msdn.microsoft.com/library/windows/apps/dn920012). Por último, haz visible al botón desconectar para permitir al usuario detener la conversión de multimedia.
