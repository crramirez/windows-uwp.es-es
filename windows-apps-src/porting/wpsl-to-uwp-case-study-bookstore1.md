...
## Saldar la deuda de elementos y algunos estilos iniciales
...
Consulta [Cambios de tema](wpsl-to-uwp-porting-xaml-and-ui.md#theme-changes) para ver cómo controlar el tema de la aplicación.
