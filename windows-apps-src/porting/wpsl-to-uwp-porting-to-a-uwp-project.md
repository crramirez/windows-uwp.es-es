...
Si tienes código que compartes entre una aplicación de WindowsPhone Silverlight y una aplicación de Windows Runtime 8.x, a continuación, posiblemente ya tengas código fuente con una lógica como esta:
