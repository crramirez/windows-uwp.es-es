...
|-----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Propiedades **ApplicationCurrentMemoryUsage** y **ApplicationCurrentMemoryUsageLimit** | Propiedades [
...
| Propiedad **DeviceFirmwareVersion**                                                      | Propiedad [
...
| Propiedad **DeviceHardwareVersion**                                                      | Propiedad [
...
| Propiedad **DeviceManufacturer**                                                         | Propiedad [
...
| Propiedad **DeviceName**                                                                 | Propiedad [
