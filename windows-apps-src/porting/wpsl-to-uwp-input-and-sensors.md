...
| Propiedad **DeviceFirmwareVersion**                                                      | Propiedad [**EasClientDeviceInformation.SystemFirmwareVersion**](https://msdn.microsoft.com/library/windows/apps/dn608144) (familia de dispositivos de escritorio solamente)                                                                                                                                                                             |
| Propiedad **DeviceHardwareVersion**                                                      | Propiedad [**EasClientDeviceInformation.SystemHardwareVersion**](https://msdn.microsoft.com/library/windows/apps/dn608145) (familia de dispositivos de escritorio solamente)                                                                                                                                                                             |
| Propiedad **DeviceManufacturer**                                                         | Propiedad [**EasClientDeviceInformation.SystemManufacturer**](https://msdn.microsoft.com/library/windows/apps/hh701398) (familia de dispositivos de escritorio solamente)                                                                                                                                                                                |
| Propiedad **DeviceName**                                                                 | Propiedad [**EasClientDeviceInformation.SystemProductName**](https://msdn.microsoft.com/library/windows/apps/hh701401) (familia de dispositivos de escritorio solamente)                                                                                                                                                                                 |
