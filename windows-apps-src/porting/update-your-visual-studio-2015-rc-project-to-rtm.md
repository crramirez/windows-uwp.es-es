---
description: Si tienes un proyecto de Windows 10 que has creado con Visual Studio 2015 RC, tienes dos opciones para actualizar los archivos del proyecto al formato adecuado para Visual Studio 2015 RTM.
