...
|-MakeMSIX [&lt;SwitchParameter&gt;]  |Opcional |Un modificador que, cuando está presente, indica a esta secuencia de comandos para empaquetar el resultado como un paquete de MSIX. |
