...
>[!IMPORTANT]
> Después de crear el paquete de aplicación de Windows, por favor, probar la aplicación para garantizar que funciona correctamente en sistemas que ejecutan Windows 10 S. Todas las aplicaciones enviadas a Microsoft Store deben ser compatibles con aplicaciones de Windows 10 S. que no son compatibles no se aceptarán en la tienda. Consulta [Probar la aplicación de Windows en Windows 10 S](desktop-to-uwp-test-windows-s.md).
