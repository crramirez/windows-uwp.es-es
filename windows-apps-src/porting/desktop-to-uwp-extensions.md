...
title: "Puente de dispositivo de escritorio a UWP, extensiones de aplicación"
ms.author: normesta
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
...
translationtype: HT
---
# <a name="desktop-to-uwp-bridge-app-extensions"></a>Puente de dispositivo de escritorio a UWP: extensiones de aplicación
...
- *StartupTask TaskId* es un identificador exclusivo para la tarea. Con este identificador, la aplicación puede llamar a las API de la clase [**Windows.ApplicationModel.StartupTask**](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.StartupTask) para habilitar o deshabilitar una tarea de inicio mediante programación.
