...
| correcciones | DLL | Ruta de acceso relativa del paquete para la corrección,.msix/.appx para cargar. |
| correcciones | config | (Opcional) Controla cómo se comporta la lista de distribución de la corrección. El formato exacto de este valor varía según una corrección por corrección como cada corrección puede interpretar este blob"", como los que quiere. |
...
>[!NOTE]
> Recuerda que tienes que primero el paquete de la desinstalación.
...
Para obtener más información sobre el proyecto de empaquetado de aplicaciones de Windows, consulte el [paquete de la aplicación mediante Visual Studio](desktop-to-uwp-packaging-dot-net.md).
...
| correcciones | config | (Opcional) Controla cómo se comporta la DLL de corrección. El formato exacto de este valor varía según una corrección por corrección como cada corrección puede interpretar este blob"", como los que quiere. |
...
Opcionalmente, puede aplicar la `reentrancy_guard` tipo a sus funciones que protegen frente a recursiva llamadas a funciones de correcciones de tiempo de ejecución.
