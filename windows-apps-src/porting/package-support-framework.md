...
Puedes usar la [Corrección de redirección de archivos](https://github.com/Microsoft/MSIX-PackageSupportFramework/tree/develop/FileRedirectionShim) para redirigir intentos de escritura o lectura de los datos en un directorio que no sea accesible desde una aplicación que se ejecuta en un contenedor MSIX.
...
| correcciones | config | (Opcional) Controla cómo se comporta la lista de distribución de corrección. El formato exacto de este valor varía en una base de corrección por corrección como cada reparación puede interpretar este blob de"" como los que quiere. |
...
>[!NOTE]
> Recuerda que desinstalar el paquete de la primera vez.
...
Agregar el paquete de Nuget **PSF** a este proyecto mediante el uso de la misma guía que se describe en la sección anterior.
...
>[!NOTE]
> Si no tienes el código fuente para la aplicación, simplemente elija el proyecto de selector PSF. Te mostraremos cómo se hace referencia el archivo ejecutable cuando se crea un archivo de configuración.
...
| correcciones | config | (Opcional) Controla cómo se comporta la corrección DLL. El formato exacto de este valor varía en una base de corrección por corrección como cada reparación puede interpretar este blob de"" como los que quiere. |
