...
**Nota**si vas a usar los emuladores de dispositivo de Visual Studio, primero **debes** instalar una versión de 64 bits (x 64) de Windows 10 Pro o mejor. Por desgracia, algunos Mac antiguos no pueden ejecutar Windows de 64 bits. Ponte en contacto con Apple en esta[página de asistencia de Apple](http://go.microsoft.com/fwlink/p/?LinkID=397959)para saber si tu hardware es compatible.
