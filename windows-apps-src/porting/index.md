...
| [Migración de una aplicación web a la UWP](hwa-to-uwp-root.md) | Convierte tu aplicación web en aplicaciones para la Plataforma universal de Windows (UWP). * Incluye instrucciones para usar Windows o Mac como la plataforma de desarrollo, así como instrucciones para convertir una aplicación de Chrome para que funcione con la UWP. |
