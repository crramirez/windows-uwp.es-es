...
Si tu aplicación finaliza y todo lo que sabes es que se produjo una excepción no controlada durante el análisis de marcado XAML, podría ser el resultado de una referencia a un recurso ausente (es decir, un recurso cuya clave existe para aplicaciones WindowsPhone Silverlight pero no para aplicaciones de Windows10 como, por ejemplo, algunas clave de estilo **TextBlock** del sistema). O bien, podría tratarse de una excepción dentro de un **UserControl**, un control personalizado o un panel de diseño personalizado.
...
-   En primer lugar, determina el número de versión del SDK de Windows 10 que tienes instalada. Navega a **C:\\Archivos de programa (x86)\\Windows Kits\\10\\Include\\&lt;nombre_de_carpeta_de_versión&gt;** y crea una nota de *&lt;nombre_de_carpeta_de_versión&gt;* que estará en notación cuádruple, "Principal.Secundaria.Compilación.Revisión".
