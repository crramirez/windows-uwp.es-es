...
:uno: [Agregar una extensión de protocolo a ese proyecto](#protocol)

:dos: [Iniciar la aplicación para UWP desde tu aplicación de escritorio](#start)

:tres: [En el proyecto de UWP, muestra la página que quieres](#parse)
