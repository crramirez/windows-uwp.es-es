...
: heavy_check_mark: asigna fácilmente una identidad a tu aplicación desde un nombre que ya has reservado en [El centro de partners](https://partner.microsoft.com/dashboard).
