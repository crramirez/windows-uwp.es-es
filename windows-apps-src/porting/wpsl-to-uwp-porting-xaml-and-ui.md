...
Aunque todavía se admiten las mismas características de enlace, Windows 10 ofrece la opción de un mecanismo de enlace nuevo y de mayor rendimiento denominado enlaces compilados, que usan la extensión de marcado {x:Bind}. Consulta [Data Binding: Boost Your Apps' Performance Through New Enhancements to XAML Data Binding](https://channel9.msdn.com/Events/Build/2015/3-635) y un [ejemplo de x:Bind](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/XamlBind).
