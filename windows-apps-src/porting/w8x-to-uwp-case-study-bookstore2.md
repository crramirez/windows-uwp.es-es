...
-   Vuelva a la Bookstore2\_81. WindowsPhone del proyecto y abra SeZoUC.xaml. Copia el marcado del elemento [**SemanticZoom**](https://msdn.microsoft.com/library/windows/apps/hh702601) fuera de ese archivo y pégalo inmediatamente después de `wideSeZo` en el nuevo proyecto. Establece `x:Name="narrowSeZo"` en el elemento que acabas de pegar.
