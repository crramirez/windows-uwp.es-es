...
| [Realizar un seguimiento de cambios de sistema de archivos en segundo plano](change-tracking-filesystem.md) | Controla los cambios en el sistema de archivos, incluso cuando no se está ejecutando la aplicación.|
