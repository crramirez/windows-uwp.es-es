...
En este ejemplo, se agrega la `broadFileSystemAccess`funcionalidad restringida. Además de especificar la funcionalidad, se debe agregar el espacio de nombres `rescap` y también se debe agregar a `IgnorableNamespaces`:
