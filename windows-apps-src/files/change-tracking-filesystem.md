...
La clase [StorageLibraryChangeTracker](https://docs.microsoft.com/uwp/api/Windows.Storage.StorageLibraryChangeTracker) permite a las aplicaciones controlar los cambios en archivos y carpetas, como los usuarios les moverse por el sistema. Uso de la clase **StorageLibraryChangeTracker** , una aplicación puede realizar un seguimiento de:
...
Usa a esta guía para obtener el modelo de programing para trabajar con el seguimiento de cambios, ver algún código de ejemplo y comprender los distintos tipos de operaciones de archivos que están registrados por **StorageLibraryChangeTracker**.

**StorageLibraryChangeTracker** funciona para las bibliotecas del usuario, o para cualquier carpeta en el equipo local. Esto incluye unidades secundarias o unidades extraíbles, pero no incluye las unidades NAS o unidades de red.
...
- Cualquier cambio en los descendientes de las carpetas de la biblioteca de raíz se representará en el seguimiento de cambios. Las carpetas de la biblioteca de raíz se pueden encontrar mediante la propiedad de [carpetas](https://docs.microsoft.com/uwp/api/windows.storage.storagelibrary.folders) .
...
Aquí es todo el código que se usa para registrar los cambios de la biblioteca de vídeos e iniciar extraer los cambios desde el seguimiento de cambios.
