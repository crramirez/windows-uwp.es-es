...
-   De manera implícita, especificando solo un [TargetType](https://msdn.microsoft.com/library/windows/apps/br208857) para el [Style](https://msdn.microsoft.com/library/windows/apps/br208849).
...
En este ejemplo, el primer estilo tiene un atributo [Atributo x:Key](../xaml-platform/x-key-attribute.md) y su tipo de destino es [Button](https://msdn.microsoft.com/library/windows/apps/br209265). La propiedad [Style](https://msdn.microsoft.com/library/windows/apps/br208743) del primer botón se establece en su clave, por lo que este estilo se aplica de manera explícita. El segundo estilo se aplica de manera implícita al segundo botón porque su tipo de destino es **Botón** y el estilo no tiene un atributo x:Key.
