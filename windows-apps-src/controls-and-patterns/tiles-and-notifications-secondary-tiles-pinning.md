---
author: anbare
Description: "Obtén información sobre cómo anclar un icono secundario desde tu aplicación para UWP."
...
Para obtener más información sobre iconos secundarios, consulta [Introducción a los iconos secundarios](tiles-and-notifications-secondary-tiles.md).
...
> [!IMPORTANT]
> Si tienes una aplicación de escritorio de Windows que usa el Puente de dispositivo de escritorio, primero debes seguir un paso adicional, conforme se describe en [Anclar desde aplicación de escritorio](tiles-and-notifications-secondary-tiles-desktop-pinning.md)
...
Para obtener información sobre cómo mostrar contenido enriquecido en el icono mediante notificaciones de icono, consulta [Enviar una notificación de icono local](tiles-and-notifications-sending-a-local-tile-notification.md).


## <a name="related"></a>Relacionados

* [Información general sobre iconos secundarios](tiles-and-notifications-secondary-tiles.md)
* [Instrucciones sobre iconos secundarios](tiles-and-notifications-secondary-tiles-guidance.md)
* [Activos de icono](tiles-and-notifications-app-assets.md)
* [Documentación del contenido de iconos](tiles-and-notifications-create-adaptive-tiles.md)
