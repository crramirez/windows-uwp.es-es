---
Description: Las notificaciones periódicas, también denominadas notificaciones sondeadas, actualizan los iconos y los distintivos a intervalos fijos mediante la descarga de contenido directamente desde un servicio de nube.
...
**Note**   Para obtener más información, descarga el [Ejemplo de notificaciones de inserción y periódicas](http://go.microsoft.com/fwlink/p/?linkid=231476) para Windows 8.1 y vuelve a usar su código fuente en la aplicación de Windows 10.
...
## <span id="URI_location_and_XML_content"></span><span id="uri_location_and_xml_content"></span><span id="URI_LOCATION_AND_XML_CONTENT"></span>Ubicación del URI y contenido XML
...
## <span id="Polling_Behavior"></span><span id="polling_behavior"></span><span id="POLLING_BEHAVIOR"></span>Comportamiento del sondeo
...
### <span id="The_recurrence_interval"></span><span id="the_recurrence_interval"></span><span id="THE_RECURRENCE_INTERVAL"></span>Intervalo de periodicidad
...
### <span id="The_start_time"></span><span id="the_start_time"></span><span id="THE_START_TIME"></span>Hora de inicio
...
### <span id="Automatic_retry_behavior"></span><span id="automatic_retry_behavior"></span><span id="AUTOMATIC_RETRY_BEHAVIOR"></span>Comportamiento de reintentos automáticos
...
## <span id="taggo"></span><span id="TAGGO"></span>Notificaciones periódicas en la cola de notificaciones
...
### <span id="Polling_for_more_than_one_notification_at_a_time"></span><span id="polling_for_more_than_one_notification_at_a_time"></span><span id="POLLING_FOR_MORE_THAN_ONE_NOTIFICATION_AT_A_TIME"></span>Sondeo de más de una notificación al mismo tiempo
