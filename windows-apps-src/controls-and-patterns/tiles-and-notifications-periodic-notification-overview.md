...
-   [
              **StartPeriodicUpdate**
            ](https://msdn.microsoft.com/library/windows/apps/hh701684) (icono)
-   [
              **StartPeriodicUpdate**
            ](https://msdn.microsoft.com/library/windows/apps/hh701611) (distintivo)
-   [
              **StartPeriodicUpdateBatch**
            ](https://msdn.microsoft.com/library/windows/apps/hh967945) (icono)
