...
(Para obtener más información sobre cómo crear las notificaciones de inserción, consulta la [Introducción a los Servicios de notificaciones de inserción de Windows (WNS)](../tiles-and-notifications-windows-push-notification-services--wns--overview.md)). 
...
Son los más usados actualmente en Windows y son adecuados para casi todos los escenarios donde la aplicación vaya a distribuirse a través de la Tienda Windows. Permiten enviar todos los tipos de notificaciones a la aplicación. 
...
-   Requiere que tu aplicación esté registrada en la Tienda Windows
...
Los canales alternativos permiten a las aplicaciones enviar notificaciones de inserción sin registrarse en la Tienda Windows ni crear canales de inserción distintos del principal utilizado para la aplicación. 
...
-   Los canales de inserción alternativos pueden crearse sin registrar una aplicación en la Tienda Windows. Si tu aplicación va a instalarse en dispositivos sin registrarla en la Tienda Windows, podrá seguir recibiendo notificaciones de inserción.
...
<th align="left">**¿Notificación del sistema?**</th>
<th align="left">**¿Notificación de icono, distintivo?**</th>
<th align="left">**¿Notificaciones de inserción sin procesar?**</th>
<th align="left">**Autenticación**</th>
<th align="left">**API**</th>
<th align="left">**¿Es obligatorio el registro en la Tienda?**</th>
<th align="left">**Canales**</th>
<th align="left">**Cifrado**</th>
</tr>
