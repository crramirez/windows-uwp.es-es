...
* **No crean actividades para las acciones que los usuarios no necesitan que se reanude.** Si la aplicación se usa para completar operaciones simples única que no se conserva el estado, probablemente no es necesario crear una actividad del usuario.
...
* Cada actividad es necesario para proporcionar un nombre de la actividad, que siempre se deben mostrar.
