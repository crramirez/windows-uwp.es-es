...
* Los datos visuales, que consta de un conjunto de propiedades necesarias y opcionales (por ejemplo: título, una descripción o elementos de tarjeta adaptable), permitir a los usuarios identificar visualmente una actividad. Consulta a continuación para obtener instrucciones sobre cómo crear elementos visuales de tarjeta adaptable para la actividad.
