...
keywords: comunicación de la aplicación para app, comunicación entre procesos, IPC, fondo, fondo comunicación, la aplicación para la aplicación, la aplicación servicio de mensajería
ms.author: twhitney
ms.date: 09/18/2017
ms.topic: article
ms.prod: windows
