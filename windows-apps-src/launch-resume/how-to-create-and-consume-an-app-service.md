...
keywords: comunicación de la aplicación para la aplicación, la comunicación entre procesos, IPC, fondo mensajería, servicio de aplicación para la aplicación, de aplicaciones de comunicación, fondo
ms.author: twhitney
ms.date: 09/18/2017
ms.topic: article
ms.prod: windows
