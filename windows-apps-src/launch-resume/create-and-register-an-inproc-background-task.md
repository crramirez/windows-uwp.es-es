...
Para obtener un ejemplo más completo de **OnBackgroundActivated** , vea [convertir un servicio de la aplicación se ejecute en el mismo proceso que su aplicación host](convert-app-service-in-process.md).
