...
## <a name="declare-that-your-app-uses-background-tasks-in-the-app-manifest"></a>Declarar que tu aplicación usa tareas en segundo plano en el manifiesto de la aplicación
