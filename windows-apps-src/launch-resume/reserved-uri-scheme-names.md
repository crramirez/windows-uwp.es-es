...
Hay dos tipos de tipos de archivo reservados: los tipos de archivo reservados para las aplicaciones integradas y los reservados para el sistema operativo de tipos de archivo. Cuando se inicia un tipo de archivo reservado para una aplicación integrada, se iniciará solo la aplicación integrada. Por lo tanto, se ignorarán todos los intentos de registrar la aplicación con dicho tipo de archivo. Del mismo modo, también se omitirán los intentos de registrar la aplicación con un tipo de archivo reservado para el sistema operativo.

Tipos de archivo reservados para las aplicaciones integradas
...
A continuación se muestran los tipos de archivo que están reservados para el sistema operativo.
...
## <a name="reserved-uri-scheme-names"></a>Nombres de esquema de URI reservados
