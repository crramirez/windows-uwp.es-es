...
En el método **OnCanceled** que creó en el paso 1, establezca la variable de marca **\_CancelRequested** en **true**.

[Ejemplo de tarea de fondo]( http://go.microsoft.com/fwlink/p/?linkid=227509) completo (método) **OnCanceled** **\_CancelRequested** se establece en **true** y escribe los resultados de la depuración potencialmente útil.
...
En método de **ejecución** de la tarea en segundo plano, registre el método de controlador de eventos de **OnCanceled** antes de empezar a trabajar. En una tarea en segundo plano dentro de proceso, puedes hacer este registro como parte de la inicialización de la aplicación. Por ejemplo, use la siguiente línea de código.
...
Cuando se recibe una solicitud de cancelación, el método que realiza el trabajo en segundo plano necesita detener el trabajo y finalizarse cuando **\_cancelRequested** se establezca en **true**. Para tareas de fondo en proceso, esto significa volver del método **OnBackgroundActivated** . Para tareas en segundo plano de fuera de proceso, esto significa que devolver desde el método **Run** .

Modifica el código de la clase de tarea en segundo plano para comprobar la variable de marca mientras está en funcionamiento. Si **\_cancelRequested** se convierte en establece en true, Detener trabajo continuar.

El [ejemplo de tarea de fondo](http://go.microsoft.com/fwlink/p/?LinkId=618666) incluye una comprobación de que se detiene la devolución de llamada del temporizador periódico si se cancela la tarea en segundo plano.
...
Con fines ilustrativos, el código de ejemplo muestra sólo las partes del método **Run** (y el temporizador de devolución de llamada) desde el [ejemplo de tarea de fondo](http://go.microsoft.com/fwlink/p/?LinkId=618666).

## <a name="run-method-example"></a>Ejemplo de método Run

La complete el método **Run** y código de devolución de llamada del temporizador, desde el [ejemplo de tarea de fondo](http://go.microsoft.com/fwlink/p/?LinkId=618666) se muestra a continuación para el contexto.
