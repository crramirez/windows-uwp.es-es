...
Si el usuario haya establecido las directivas de privacidad o de energía que impide que la aplicación realice la actividad en segundo plano que puede devolver [DisabledByPolicy](https://docs.microsoft.com/uwp/api/windows.applicationmodel.background.applicationtriggerresult) .
