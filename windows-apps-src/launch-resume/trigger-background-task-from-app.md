...
Para obtener un ejemplo de cómo crear un desencadenador de aplicación, consulta en este [ejemplo](https://github.com/Microsoft/Windows-universal-samples/blob/v2.0.0/Samples/BackgroundTask/cs/BackgroundTask/Scenario5_ApplicationTriggerTask.xaml.cs).
...
Si el usuario ha establecido directivas de privacidad o de energía que impiden que la aplicación realiza la actividad en segundo plano que puede devolver [DisabledByPolicy](https://docs.microsoft.com/uwp/api/windows.applicationmodel.background.applicationtriggerresult) .
