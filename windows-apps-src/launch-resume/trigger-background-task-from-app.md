...
Si el usuario ha establecido directivas de privacidad o de energía que impide que la aplicación realice actividad en segundo plano que puede devolver [DisabledByPolicy](https://docs.microsoft.com/uwp/api/windows.applicationmodel.background.applicationtriggerresult) .
