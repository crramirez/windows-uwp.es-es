...
description: Asegúrate de que una aplicación cumple los requisitos para ejecutar tareas en segundo plano.
...
Asegúrate de que una aplicación cumple los requisitos para ejecutar tareas en segundo plano.
