...
| [Inicie la aplicación UWP](launch-store-app.md) | En este tema se describe el esquema de URI ms-windows-store. La aplicación puede usar este esquema de URI para iniciar la aplicación para UWP en páginas específicas en la Store. |
...
| [Iniciar recortes de pantalla](launch-screen-snipping.md) | Aprenda a utilizar esquemas de URI para abrir un nuevo recorte o abrir la aplicación recorte & boceto. |
| [Habilitar aplicaciones para sitios Web que utilizan controladores URI de la aplicación](web-to-app-linking.md) | Unidad de contratación de usuario con la aplicación mediante el soporte de las aplicaciones para la característica de sitios Web. |
