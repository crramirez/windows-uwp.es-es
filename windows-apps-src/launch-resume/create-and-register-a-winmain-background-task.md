---
title: Crear y registrar una tarea en segundo plano de WinMain
description: Cree una tarea en segundo plano COM que se pueda ejecutar en el proceso principal o fuera de proceso cuando la aplicación de WinMain empaquetada no se esté ejecutando.
ms.assetid: 8CBD4986-6E65-4374-BC7C-C38908E417E1
ms.date: 03/27/2020
ms.topic: article
keywords: Windows 10, puente de escritorio, paquete disperso firmado, WinMain, tarea en segundo plano
...
2.  Una vez que el proceso se inicia con los argumentos correctos, debe indicar a COM que es el servidor COM actual para las nuevas instancias de SampleTask. En el código de ejemplo siguiente se muestra cómo el proceso de aplicación debe registrarse con COM. Tenga en cuenta que estos ejemplos indican el modo en que el proceso se declararía a sí mismo como el servidor COM de SampleTask para que se completara al menos una instancia antes de salir. Esto es opcional y controlar una tarea en segundo plano puede iniciar las funciones de proceso principales.
...
Por ejemplo, este código crea una nueva tarea en segundo plano y la establece para que se ejecute en un [**TimeTrigger**]()periódico de 15 minutos:
...
En los ejemplos de código siguientes se muestra el código completo necesario para ejecutar y registrar la tarea en segundo plano COM WinMain:

<details>
<summary>Completar el manifiesto del paquete de aplicación WinMain</summary>
<p>
...
<details>
<summary>Ejemplo de código de tarea en segundo plano completo</summary>
<p>
