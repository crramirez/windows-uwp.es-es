...
<div class="alert">
<b>Note</b>  A title can be used for a location if the location is specified by the <b>pos</b> parameter value. En lugar de mostrar la latitud y la longitud, se mostrará el título.
</div>
<div>
 
</div></td>
