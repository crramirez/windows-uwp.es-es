...
| [Ampliar tu aplicación con servicios de aplicaciones, extensiones y paquetes](extend-your-app-with-services-extensions-packages.md) | Hay distintas tecnologías en Windows 10 que te ayudarán a ampliar y separar tu aplicación por componentes. Este tema te ayudará a determinar qué tecnología es la correcta de usar y proporciona una breve introducción de cada una. |
...
| [Crear y registrar una tarea en segundo plano dentro de proceso](create-and-register-an-inproc-background-task.md)       | Crea y registra una tarea en segundo plano que se ejecute en el mismo proceso que la aplicación en primer plano. |
...
| [Ejecutar una tarea en segundo plano en un temporizador](run-a-background-task-on-a-timer-.md)                                    | Aprende a programar una tarea en segundo plano única o a a ejecutar una tarea en segundo plano periódica. |
