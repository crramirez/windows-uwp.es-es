...
Consulte **Scenario4** en la [muestra de activación en segundo plano](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/BackgroundActivation) para ver un ejemplo de cómo implementar el tiempo de tarea en segundo plano desencadenadas se describe en este tema.
...
 
Por ejemplo, este desencadenador hará que una tarea en segundo plano ejecute una vez cada hora.
