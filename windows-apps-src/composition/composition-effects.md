...
ms.locfileid: "89175599"
---
# <a name="composition-effects"></a>Efectos de composición

Las API de [**Windows. UI. Composition**](/uwp/api/Windows.UI.Composition) permiten aplicar efectos en tiempo real a las imágenes y la interfaz de usuario con propiedades de efecto que se pueden animar. En esta introducción, veremos las funciones disponibles que permiten aplicar efectos a una composición visual.

Para respaldar la coherencia de la [Plataforma universal de Windows (UWP)](../get-started/universal-application-platform-guide.md) para los desarrolladores que describen efectos en sus aplicaciones, los efectos de composición aprovechan la interfaz IGraphicsEffect de Win2D para usar las descripciones de efectos a través del espacio de nombre [Microsoft.Graphics.Canvas.Effects](https://microsoft.github.io/Win2D/html/N_Microsoft_Graphics_Canvas_Effects.htm).
...
También se pueden aplicar efectos a UIElements XAML con un pincel de efecto con [**XamlCompositionBrushBase**](/uwp/api/windows.ui.xaml.media.xamlcompositionbrushbase).
...
| Compuesto            | Combina dos imágenes. La composición proporciona los 13 [modos compuestos](https://microsoft.github.io/Win2D/html/T_Microsoft_Graphics_Canvas_CanvasComposite.htm) que se admiten en Win2D.                                              |
...
### <a name="installing-visual-studio"></a>Instalar Visual Studio
...
1. Crear un SpriteVisual en el árbol de composición y aplicar el efecto
...
1. Cree el origen de la imagen para cargarlo.
...
1. Tamaño y pincel en la superficie del SpriteVisual

    ```cs
    brush.Surface = imageSource.Surface;
    ```

1. Ejecutar la aplicación: los resultados deben ser un gato dessaturado:

![Imagen sin saturación](images/composition-cat-desaturated.png)

## <a name="more-information"></a>Más información

- [Microsoft: tema sobre la composición en GitHub](https://github.com/microsoft/WindowsCompositionSamples)
