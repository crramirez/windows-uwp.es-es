...
ms.locfileid: "58174183"
---
# <a name="using-the-visual-layer-with-windows-forms"></a>Uso de la capa Visual con Windows Forms

Puede usar las API de composición de Windows en tiempo de ejecución (también denominado el [capa Visual](visual-layer.md)) en las aplicaciones de Windows Forms para crear experiencias modernas es clara para los usuarios de Windows 10.
...
![La interfaz de usuario de aplicación en ejecución](images/interop/wf-comp-interop-app-ui.png)
