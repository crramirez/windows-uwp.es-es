...
Los objetos [**XamlLight**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.xamllight) se usan para aplicar objetos [**CompositionLights**](https://docs.microsoft.com/uwp/api/Windows.UI.Composition.CompositionLight) para iluminar dinámicamente los elementos de interfaz de usuario de XAML. XamlLight proporciona métodos para la identificación de elementos de IU o pinceles XAML, aplicar las luces a árboles de elementos de IU, y ayudar a administrar la duración de CompositionLight recursos en función de si están actualmente en usan.
...
En este ejemplo se muestra la definición para un XamlLight personalizado que se aplica un foco multicolor a elementos de IU de destino y pinceles.
...
A continuación, puede aplicar esta luz a cualquier XAML UIElement o pincel para ellos claro. En este ejemplo se muestran diferentes usos posibles.

> [!Important]
> Para [C + + / WinRT](/windows/uwp/cpp-and-winrt-apis/intro-to-using-cpp-with-winrt), quitar las dos repeticiones de `local:OrangeSpotLight.IsTarget="True"` desde el marcado siguiente. Ya se establecen las propiedades asociadas en código subyacente.
...
![Ejemplos de elementos de iluminación por una luz xaml](images/orange-spot-light.png)
