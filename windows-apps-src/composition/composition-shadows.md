...
## <a name="shaping-the-shadow"></a>La forma de la sombra
...
![Imagen de web conectada con círculo enmascarada por la sombra paralela](images/ms-brand-web-masked-dropshadow.png)
...
Si quieres agregar una sombra a los elementos de marco más complejos, hay un par de formas para la interoperabilidad con sombras entre XAML y la composición:
...
1. Crear un elemento Visual para usar como el host de sombra & Vincular al documento de XAML Visual.
