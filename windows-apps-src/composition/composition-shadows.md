...
En algunos casos, es posible que quieras la sombra de forma que no coincide con el contenido de tu Visual. Para lograr este efecto, debes establecer explícitamente la propiedad de máscara con un pincel alfa.
...
1. Crear un objeto Visual para usar como el host de sombra & Vincular a la entrega XAML Visual.
