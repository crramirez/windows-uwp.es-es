...
## <span id="when_to_use_in_app_help"></span><span id="WHEN_TO_USE_IN_APP_HELP"></span>Cuándo usar páginas de ayuda en la aplicación
...
## <span id="types_of_in_app_help"></span><span id="TYPES_OF_IN_APP_HELP"></span>Tipos de ayuda en la aplicación
...
#### <span id="help_pages"></span><span id="HELP_PAGES"></span>Páginas de ayuda
...
-   **Sé conciso:** incluir una gran biblioteca de temas de ayuda resultará difícil de usar y no es apto para la ayuda en la aplicación.
...
#### <span id="popups"></span><span id="POPUPS"></span>Elementos emergentes
...
-   **No uses demasiados recursos:** la ayuda no debe retrasarse o cargarse lentamente. Si incluyes vídeos o archivos de audio de alta resolución en los elementos emergentes, es más probable que frustres al usuario en lugar de ayudarlo.

#### <span id="descriptions"></span><span id="DESCRIPTIONS"></span>Descripciones
...
-   **Describe interacciones interesantes:** uno de los usos recomendados para las descripciones es enseñar al usuario el modo en que interactúan las características que ya conocen. De este modo, obtendrá más información sobre algo que ya le gusta usar.
