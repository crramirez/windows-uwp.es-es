...
description: Puedes distribuir el componente de Windows Runtime mediante una copia de archivos.
...
2.  Crear un nuevo proyecto usando la plantilla VSIX Project. Puedes encontrar la plantilla en Visual C# o Visual Basic, en la categoría de extensibilidad. Esta plantilla se instala como parte del SDK de Visual Studio. [Walkthrough: Creating an SDK using C# or Visual Basic (Tutorial: crear un SDK mediante C# o Visual Basic)](https://msdn.microsoft.com/library/jj127119.aspx) o [Walkthrough: Creating an SDK using C++ (Tutorial: crear un SDK con C++)](https://msdn.microsoft.com/library/jj127117.aspx): estos tutoriales indican cómo puedes usar la plantilla en un escenario muy simple. )
3.  Determinar la estructura de carpetas para el SDK. La estructura de carpetas comienza en el nivel de raíz del proyecto VSIX, con las carpetas **References**, **Redist** y **DesignTime**.
    ...
    -   En la carpeta **Redist** se ubican otros archivos que deben distribuirse con los archivos binarios, en aquellas aplicaciones que se crearon mediante tu componente.
    -   En la carpeta **DesignTime** se ubican los archivos que se usan solo cuando los desarrolladores están creando aplicaciones que usan tu componente.
