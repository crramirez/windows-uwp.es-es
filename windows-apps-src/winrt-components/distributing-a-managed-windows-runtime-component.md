...
Tus archivos binarios se instalarán en los paquetes de aplicación, posiblemente con archivos binarios de otros desarrolladores. Vea "Extension SDK" en [Cómo: Crear un Kit de desarrollo de Software](https://msdn.microsoft.com/library/hh768146.aspx), en MSDN Library.
...
2.  Crear un nuevo proyecto usando la plantilla VSIX Project. Puedes encontrar la plantilla en Visual C# o Visual Basic, en la categoría de extensibilidad. Esta plantilla se instala como parte del SDK de Visual Studio. ([Tutorial: Creación de un SDK con C# o Visual Basic](https://msdn.microsoft.com/library/jj127119.aspx) o [Tutorial: Creación de un SDK con C++](https://msdn.microsoft.com/library/jj127117.aspx), se muestra el uso de esta plantilla en un escenario muy sencillo. ) simple
...
* [Opciones de comando MakePRI.exe](https://msdn.microsoft.com/library/windows/apps/jj552945.aspx)
