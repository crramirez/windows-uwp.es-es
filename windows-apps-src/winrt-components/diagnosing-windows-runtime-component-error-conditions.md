...
| Número de error | Texto de mensaje                                                                                                                                                                      |
|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| WME1059      | Se representan varias sobrecargas del parámetro {0} de '{1}.{2}' con Windows.Foundation.Metadata.DefaultOverloadAttribute.                                                            |
| WME1085      | Las sobrecargas del parámetro {0} de {1}.{2} deben tener exactamente un método especificado como la sobrecarga predeterminada al representarla con Windows.Foundation.Metadata.DefaultOverloadAttribute. |
...
| WME1044      | Un tipo público tiene un espacio de nombres ('{1}') que no comparte un prefijo común con otros espacios de nombres ('{0}'). Todos los tipos dentro de un archivo de metadatos de Windows deben existir en un subespacio de nombres del espacio de nombres que se determina según el nombre de archivo.                                                                                                                              |
| WME1067      | Los nombres de espacio de nombres no pueden diferir sólo en las mayúsculas o minúsculas: '{0}', '{1}'.                                                                                                                                                                                                                                                                                                |
...
<td align="left">El método '{0}' tiene un parámetro de tipo '{1}' en su firma. Aunque este tipo no es un tipo válido de Windows Runtime, implementa interfaces que son tipos válidos de Windows Runtime. Considera la posibilidad de cambiar la firma de método para utilizar uno de los siguientes tipos en su lugar: '{2}'.</td>
</tr>
<tr class="odd">
...
| Número de error | Texto de mensaje                                                                                                                                                                                                                                                            |
|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| WME1060      | La estructura '{0}' tiene un campo '{1}' de tipo '{2}'. '{2}' no es un tipo de campo válido de Windows Runtime. Cada campo en una estructura de Windows Runtime solo puede ser UInt8, Int16, UInt16, Int32, UInt32, Int64, UInt64, Single, Double, Boolean, String, Enum o una estructura en sí mismo. |
...
| Número de error | Texto de mensaje                                                                                                                                                     |
|--------------|--------------------|
| WME1034      | El método '{0}' tiene una matriz de tipo '{1}' con el límite inferior distinto a cero en su firma. Las matrices de firmas de método de Windows Runtime deben tener un límite inferior de cero. |
| WME1035      | El método '{0}' tiene una matriz multidimensional de tipo '{1}' en su firma. Las matrices de firmas de método de Windows Runtime deben ser unidimensionales.                  |
| WME1036      | El método '{0}' tiene una matriz anidada de tipo '{1}' en su firma. Las matrices de firmas de método de Windows Runtime no pueden anidarse.                                    |
...
| Número de error | Texto de mensaje         |
|--------------|----------------------|
| WME1101      | El método '{0}' tiene el parámetro '{1}', que es una matriz, y que tiene tanto {2} como {3}. En Windows Runtime, los parámetros de la matriz de contenido deben ser o bien de lectura o bien de escritura. Quita uno de los atributos de '{1}'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| WME1103      | El método '{0}' tiene el parámetro '{1}', que es una matriz, y que tiene un System.Runtime.InteropServices.InAttribute o un System.Runtime.InteropServices.OutAttribute. En Windows Runtime, los parámetros de la matriz deben tener {2} o {3}. Quita estos atributos o reemplázalos con el atributo de Windows Runtime apropiado si es necesario.                                                                                                                                                                                                                                                                                                                                                                                          |
| WME1104      | El método {0} tiene el parámetro '{1}' que no es una matriz, y que tiene un {2} o un {3}. Windows Runtime no es compatible con parámetros que no son de matriz de marcado con {2} o {3}.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
