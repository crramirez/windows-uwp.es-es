...
>**Nota:** La instalación en paralelo se puede activar en configuración- &gt; actualizar & seguridad- &gt; para desarrolladores.
...
Esto se realiza con los siguientes scripts. Agregue los scripts a la línea de comandos del evento posterior a la compilación, en **propiedades** del proyecto  >  **eventos de compilación**.
...
c) un \* \_ archivo i. c (por ejemplo, MyWinRTComponent \_ i. c)

d) un \* \_ archivo p. c (por ejemplo, MyWinRTComponent \_ p. c)
...
**> definiciones del preprocesador de C/C++ > agregar**
...
-   [Plantillas de proyecto de componente de WinRT negociado para Windows 10 y VS 2015](https://marketplace.visualstudio.com/items?itemName=vs-publisher-713547.VS2015TemplateBrokeredComponents)
...
-   [Cómo instalar aplicaciones en Windows 10](/windows/apps/get-started/enable-your-device-for-development)
