---
title: Tutorial para crear un componente de Windows Runtime en C++/CX y llamarlo desde JavaScript o C#
...
8. En el panel central, seleccione WinRT_CPP y, a continuación, elija el botón **Aceptar** .
...
Pegue este código HTML en el <body> nodo de la página default.html:
...
2. En el panel izquierdo del Examinador de objetos, expanda el \_ nodo CPP de WinRT para mostrar los tipos y métodos definidos en el componente.
