...
description: Las animaciones con guión gráfico no son solo animaciones en un sentido visual.
---
...
-   Animar el valor [**X**](https://msdn.microsoft.com/library/windows/apps/BR243029) de [**TranslateTransform**](https://msdn.microsoft.com/library/windows/apps/BR243027), tal como se aplica a [**RenderTransform**](https://msdn.microsoft.com/library/windows/apps/BR208980): `(UIElement.RenderTransform).(TranslateTransform.X)`
-   Animar un [**Color**](https://msdn.microsoft.com/library/windows/apps/BR242963) dentro de [**GradientStop**](https://msdn.microsoft.com/library/windows/apps/BR210078) de [**LinearGradientBrush**](https://msdn.microsoft.com/library/windows/apps/BR210108), tal como se aplica a [**Relleno**](https://msdn.microsoft.com/library/windows/apps/BR243378): `(Shape.Fill).(GradientBrush.GradientStops)[0].(GradientStop.Color)`
-   Animar el valor [**X**](https://msdn.microsoft.com/library/windows/apps/BR243029) de [**TranslateTransform**](https://msdn.microsoft.com/library/windows/apps/BR243027), que es una de cuatro transformaciones en [**TransformGroup**](https://msdn.microsoft.com/library/windows/apps/BR243022), tal como se aplica a [**RenderTransform**](https://msdn.microsoft.com/library/windows/apps/BR208980):`(UIElement.RenderTransform).(TransformGroup.Children)[3].(TranslateTransform.X)`
...
-   [**Doble**](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx), se puede animar con cualquier [**DoubleAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243136)
-   [**Punto**](https://msdn.microsoft.com/library/windows/apps/BR225870), se puede animar con cualquier [**PointAnimation**](https://msdn.microsoft.com/library/windows/apps/BR210346)
-   [**Color**](https://msdn.microsoft.com/library/windows/apps/Hh673723), se puede animar con cualquier [**ColorAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243066)
...
Los tipos de animación que hemos descrito muchas veces se conocen como animaciones **De origen**/**De destino**/**Por**. Esto significa que la animación cambia el valor de una propiedad, a lo largo del tiempo, con una o varias de las entradas que provienen de la definición de la animación:
...
Hasta ahora, hemos mostrado las animaciones personalizadas que se animan entre dos valores y después cómo interpolar de forma lineal los valores según sea necesario mientras se ejecuta la animación. Se denominan animaciones **De origen**/**De destino**/**Por**. Hay otro tipo de animación que permite declarar valores intermedios que se encuentran entre el inicio y el final. Estas se denominan *animaciones de fotograma clave*. También hay una forma de alterar la lógica de interpolación en una animación **De origen**/**De destino**/**Por** o una animación de fotograma clave. Esto comprende aplicar una función de aceleración. Para más información sobre estos conceptos, consulta [Fotograma clave y animaciones de función de aceleración](key-frame-and-easing-function-animations.md).
