...
En primer lugar, el siguiente ejemplo muestra a un delegado firma que no toma ningún parámetro (esencialmente una señal simple) y, a continuación, que toma una cadena.
...
Ten en cuenta que estas directrices no se aplican necesariamente si estás diseñando una API interna. Aunque API internas suelen ser públicas con el tiempo.
