...
- Agregue un miembro privado para almacenar la cadena de título. Tenga en cuenta que tenemos un constructor que toma el valor [**winrt::hstring**](/uwp/cpp-ref-for-winrt/hstring). Ese valor es la cadena de título.
...
Para usar la construcción uniforme en lugar de [**winrt::make**](/uwp/cpp-ref-for-winrt/make), en `MainPage.h` declare e inicialice *m_mainViewModel* en un solo paso, como se muestra a continuación.
