...
A continuación, en lugar de buscar los tres **await_xxx** funciones que coinciden con **IAsyncXxx**, el compilador de C++ busca funciones que coinciden con **argumento de sin cambios**.
