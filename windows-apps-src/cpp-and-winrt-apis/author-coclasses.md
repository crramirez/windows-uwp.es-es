...
Comienza creando un proyecto nuevo en Microsoft Visual Studio Crear un **aplicación de consola de Windows (C++/WinRT)** del proyecto y asígnele el nombre *ToastAndCallback*.
