---
author: stevewhims
description: El Windows SDK incluye C++/WinRT. Esto es una proyección de lenguaje C++ estándar para las API de Windows Runtime, implementada únicamente en los archivos de encabezado y diseñada para darte acceso de primera clase a la moderna API de Windows. Con C++/WinRT, puedes crear y consumir API de Windows Runtime usando cualquier compilador de C ++ compatible con estándares.
title: C++/WinRT
ms.author: stwhi
ms.date: 04/10/2018
ms.topic: article
...
| [Interoperabilidad entre C++/WinRT y la ABI](interop-winrt-abi.md) | Este tema muestra cómo convertir entre la interfaz binaria (ABI) de la aplicación y objetos C++/WinRT. |
