...
Funciones de *Overridable* presenten distinto en las proyecciones de diferentes idiomas. En C#, por ejemplo, función reemplazable normalmente aparecen como funciones virtuales protegidas. En C++ / WinRT, que estén ni virtual ni protegidos, pero podrás seguir reemplazarlos y proporcionar tu propia implementación, como se mostró anteriormente.
