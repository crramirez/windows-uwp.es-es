...
## ¿Debo incluir una página de configuración en mi aplicación?

Estos son ejemplos de opciones de la aplicación que pertenecen a una página de configuración de la aplicación: 

-   Las opciones de configuración que afectan al comportamiento de la aplicación y que no se ajustan con frecuencia, como la selección entre Celsius o Fahrenheit como unidades de temperatura predeterminadas en una aplicación del tiempo, el cambio de configuración de una cuenta para una aplicación de correo, la configuración de las notificaciones o las opciones de accesibilidad.
...
Los comandos que forman parte del flujo de trabajo habitual de la aplicación (por ejemplo, cambiar el tamaño del pincel en una aplicación de dibujo) no deben estar en una página de configuración. Para obtener información sobre la colocación de los comandos, consulta los [Conceptos básicos del diseño de comandos](../layout/commanding-basics.md).
...
-   Crea un punto de entrada para todas las configuraciones en tu página de configuración de la aplicación.
...
Si usas una barra de la aplicación o una barra de herramientas, que normalmente forma parte de un diseño de navegación centralizada, con pestañas o tablas dinámicas, coloca el punto de entrada como último elemento del menú del control flotante "Más". Si es importante tener una mayor detectabilidad del punto de entrada de configuración de la aplicación, colócalo directamente en la barra de la aplicación y no en el menú del control flotante "Más".
...
## Sección "Acerca de" y botón "Enviar comentarios"
...
### Contenido de la página de configuración de la aplicación
...
-   Muestra las mismas opciones de configuración sin importar el contexto de la aplicación. Si algunas opciones de configuración no son relevantes en un determinado contexto, deshabilítalas en el control flotante de configuración de la aplicación.
...
* [Conceptos básicos del diseño de comandos](../layout/commanding-basics.md)
* [Directrices sobre los controles de progreso](../controls-and-patterns/progress-controls.md)
