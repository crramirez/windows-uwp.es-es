...
-   **Configuración**
    ...
    Los siguientes son los tipos de datos que puedes usar para la configuración de la aplicación:
...
## Almacenar datos de aplicación en los almacenes de datos de la aplicación
...
### Recuperar el almacén de datos de la aplicación local
...
### Crear y recuperar una configuración local simple
...
### Crear y recuperar un valor compuesto local
...
### Registrarse para recibir notificaciones cuando cambian los datos de itinerancia
...
### Crear y recuperar la configuración de itinerancia
...
### Crear y recuperar archivos móviles
...
## Datos de aplicaciones temporales
...
### Recuperar el contenedor de datos temporales
...
### Crear y leer archivos temporales
...
## Organizar los datos de aplicación con contenedores
...
## Eliminar los contenedores y la configuración de aplicación
...
## Control de versiones de los datos de aplicación
...
* [Directrices para la configuración de una aplicación](guidelines-for-app-settings.md)
