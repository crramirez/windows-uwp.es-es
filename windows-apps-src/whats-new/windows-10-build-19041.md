...
Portabilidad de aplicaciones de C# | Hemos documentado el proceso de portabilidad de una aplicación de C# a C++/WinRT. El tema [Portabilidad del ejemplo de Clipboard a C++/WinRT desde C#](../cpp-and-winrt-apis/clipboard-to-winrt-from-csharp.md) es contextual y se basa en una experiencia de portabilidad del mundo real en particular. Su tema complementario [Migrar a C++/WinRT desde C#](../cpp-and-winrt-apis/move-to-winrt-from-csharp.md) es una visión más enciclopédica de los detalles técnicos y los pasos implicados en la portabilidad. 
C++/WinRT | Lee acerca de las actualizaciones de C++/WinRT con respecto a las mejoras de rendimiento en tiempo de compilación y en tiempo de ejecución (se logra en conjunto con el equipo del compilador de Visual C++), en [Paquete acumulativo de mejoras o adiciones recientes a partir de marzo de 2020](../cpp-and-winrt-apis/news.md#rollup-of-recent-improvementsadditions-as-of-march-2020). </br> En el caso de C++/WinRT, se ha agregado más información a estos temas: [portabilidad desde C++/CX](../cpp-and-winrt-apis/move-to-winrt-from-cx.md#boxing-and-unboxing), [portabilidad desde C#](../cpp-and-winrt-apis/move-to-winrt-from-csharp.md#boxing-and-unboxing), [ejemplo sencillo de biblioteca de interfaz de usuario de Windows de C++/WinRT](../cpp-and-winrt-apis/simple-winui-example.md), [simultaneidad](../cpp-and-winrt-apis/concurrency.md), [get_unknown()](/uwp/cpp-ref-for-winrt/get-unknown) y [controles personalizados (con plantilla) de XAML con C++/WinRT](../cpp-and-winrt-apis/xaml-cust-ctrl.md).
