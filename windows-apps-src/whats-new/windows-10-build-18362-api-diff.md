---
title: Cambios en las API de Windows 10, compilación 18362
description: Los desarrolladores pueden usar la siguiente lista para identificar los espacios de nombres nuevos o cambiados en Windows 10, compilación 18362
keywords: novedades, novedad, actualizaciones, Windows 10, más reciente, api, 18362
ms.date: 04/19/2019
ms.topic: article
...
ms.locfileid: "63780366"
---
# <a name="new-apis-in-windows-10-build-18362"></a>Nuevas API en la compilación 18362 de Windows 10

Se han puesto a disposición de los desarrolladores espacios de nombres de API nuevos y actualizados en la compilación 18362 de Windows 10 (también conocida como SDK versión 1903). A continuación encontrarás una lista de la documentación publicada para los espacios de nombres que se agregaron o se modificaron en esta versión.

Si quieres obtener más información sobre las API que se agregaron en la versión pública anterior, consulta [New APIs in the Windows 10 October Update (Nuevas API en la Actualización de octubre de Windows 10)](windows-10-build-17763-api-diff.md).
