...
* Compatibilidad con la Microsoft Store, la administración de empresa y muchos de los modelos de distribución personalizada.

Herramientas para crear estos paquetes estarán disponibles en una versión futura de Visual Studio y SDK de Windows.

El formato de empaquetado MSIX es un formato de código abierto que es más fácil para nuestros partners admitir el ecosistema MSIX con sus soluciones y herramientas. Para obtener más información sobre el formato de empaquetado MSIX, consulte el [SDK de MSIX](https://github.com/Microsoft/msix-packaging). 
