...
* [Tipografía](../design/style/typography.md) consolida la información de artículos similares, poner todo en un único lugar con instrucciones actualizadas e ilustraciones.
...
* Soporte técnico de Microsoft Store, la administración de la empresa y muchos de los modelos de distribución personalizado.
...
Este tutorial crea una aplicación básica de UWP para administrar una lista de clientes y presenta los conceptos y procedimientos recomendados útiles en el desarrollo empresarial. Te guiará a través de la implementación de elementos de la interfaz de usuario y agregar las operaciones en una base de datos SQLite local y se proporcionan instrucciones dinámica para la conexión a una base de datos REST remota si quieres ir más allá. [Echa un vistazo a este tutorial](../enterprise/customer-database-tutorial.md)