...
Anunciado en la conferencia de Microsoft de 2018 de compilación, MSIX es un nuevo formato de paquete de inclusión en contenedores que se aplica a todas las aplicaciones de Windows como Win32, Windows Forms, WPF y UWP. Este nuevo formato hereda excelentes características de UWP:
...
El formato de empaquetado de MSIX es un formato de código abierto, lo cual facilita a nuestros partners admitir el ecosistema MSIX con sus soluciones y herramientas. Para obtener más información sobre el formato de empaquetado MSIX, consulta [MSIX SDK](https://github.com/Microsoft/msix-packaging). 
...
En este tutorial se crea una aplicación básica de UWP para administrar una lista de clientes y presenta los conceptos y procedimientos recomendados útiles en el desarrollo empresarial. Te guiará a través de implementar los elementos de la interfaz de usuario y agregar las operaciones en una base de datos SQLite local y se proporcionan instrucciones sueltos para la conexión a una base de datos REST remoto si quieres ir más allá. [Echa un vistazo a este tutorial](../enterprise/customer-database-tutorial.md)