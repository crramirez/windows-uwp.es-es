...
description: Se agregaron nuevas características, vídeos y directrices para los desarrolladores a la documentación del desarrollador de Windows 10 de mayo de 2018 y la conferencia de Build de Microsoft.
...
El usuario de movimiento en Fluent Design System evoluciona integradas en los conceptos básicos de temporización de aceleración, direccionalidad y gravedad. Estos conceptos básicos de la aplicación te ayudarán a guiar al usuario a través de la aplicación y se conecta con su experiencia digital que refleja el mundo natural. Más información en este artículo:
...
Actualizaciones Visual y pequeños cambios realizados en las páginas de Fluent Design siguientes:
...
Además, nos hemos vuelto a escribir las páginas siguientes con nueva información en sus áreas de contenido:

* [Los iconos](../design/style/icons.md) ahora proporciona recomendaciones prácticas para usar iconos y hacer que puede hacer clic.
* [Tipografía](../design/style/typography.md) consolida la información de artículos similares, colocar todo el contenido en un único lugar con instrucciones actualizadas e ilustraciones.
...
Mostrar el contenido web en la aplicación de escritorio mediante el control de WebView anteriormente, solo está disponible para aplicaciones para UWP. Este control usa el motor de insertar una vista que representa el formato enriquecido HTML de procesamiento contenido desde un servidor web remoto, el código generado dinámicamente o archivos de contenido de Microsoft Edge. Busca el control WebView en la versión más reciente de la [Kit de herramientas de comunidad Windows.](https://docs.microsoft.com/windows/uwpcommunitytoolkit/)
...
* Compatibilidad con la Microsoft Store, la administración de la empresa y muchos de los modelos de distribución personalizado.

Herramientas para crear estos paquetes estarán disponibles en una versión futura de Visual Studio y SDK de Windows.

El formato de empaquetado MSIX es un formato de código abierto, lo cual facilita a nuestros partners admitir el ecosistema MSIX con sus soluciones y herramientas. Para obtener más información sobre el formato de empaquetado MSIX, consulta [El SDK de MSIX](https://github.com/Microsoft/msix-packaging). 
...
El equipo de Project Rome ha renovado su iOS y Android SDK, agrega nuevas características como las actividades del usuario y la refactorización de gran parte de su código para proporcionar una experiencia coherente de programación en el SDK de diferentes. [Todos los nueva referencia de API y documentos de procedimientos](https://docs.microsoft.com/windows/project-rome/) pasará dinámicos durante la conferencia de desarrolladores de compilación de 2018.

### <a name="sets"></a>Conjuntos

La funcionalidad conjuntos está disponible en las versiones preliminares de Windows Insider. Al usar la característica de conjuntos, la aplicación se dibuja en una ventana que puede compartirse con otras aplicaciones, donde cada aplicación tiene su propia pestaña en la barra de título. [Diseños para conjuntos](../design/shell/design-for-sets.md) tiene instrucciones sobre cómo optimizar tu aplicación para proporcionar la mejor experiencia en la interfaz de usuario establece.

## <a name="developer-guidance"></a>Guía para desarrolladores

### <a name="get-started"></a>Comenzar

Nos hemos revitalizado nuestro Get iniciado contenido con nuevas pistas de aprendizaje. Estos temas nuevos se pretende proporcionar nuevos desarrolladores de Windows 10 con la información en algunas tareas comunes que podría querer realizar. No te encuentras tutoriales y no proporcionas un tutorial de mano, pero señale donde existe documentación existente y cómo usarla. Echa un vistazo a la actualización de la herramienta de [empezar a codificar](../get-started/create-uwp-apps.md) la página, o para explorar cada pista de aprendizaje individual:
...
![Obtener la imagen de inicio](../get-started/images/build-your-app.png)
...
Este tutorial crea una aplicación básica de UWP para la administración de una lista de clientes y presenta los conceptos y procedimientos recomendados útiles en el desarrollo empresarial. Te guiará a través de implementar los elementos de la interfaz de usuario y agregar las operaciones en una base de datos SQLite local y se proporcionan instrucciones sueltos para la conexión a una base de datos REST remota si lo deseas ir más allá. [Echa un vistazo a este tutorial](../enterprise/customer-database-tutorial.md)