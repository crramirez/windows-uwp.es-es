...
keywords: novedades, novedad, actualizaciones, actualización, Windows 10, 1709, fall, creators, api, 16299
ms.date: 11/02/2017
ms.topic: article
...
ms.locfileid: "63780445"
---
# <a name="new-apis-in-windows-10-build-16299"></a>Nuevas API en la compilación 16299 de Windows 10

Se han puesto a disposición de los desarrolladores espacios de nombres de API nuevos y actualizados en la compilación 16299 de Windows 10, también conocida como Fall Creators Update o versión 1709. A continuación encontrarás una lista de la documentación publicada para los espacios de nombres que se agregaron o se modificaron en esta versión.

Si quieres obtener más información sobre las API que se agregaron en la versión pública anterior, consulta [New APIs in the Windows 10 Creators Update (Nuevas API en Windows 10 Creators Update)](windows-10-build-15063-api-diff.md).
...
.columnspacing <br> grid.columnspacingproperty <br> grid.rowspacing <br> grid.rowspacingproperty
