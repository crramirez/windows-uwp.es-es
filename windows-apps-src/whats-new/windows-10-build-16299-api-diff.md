...
ms.locfileid: "57647960"
---
# <a name="new-apis-in-windows-10-build-16299"></a>Nuevas API en la compilación 16299 de Windows 10

Hay espacios de nombres de API nuevos y actualizados que se han puesto a disposición de los desarrolladores de la compilación 16299 de Windows 10 (también conocida como Fall Creators Update o versión 1709. A continuación encontrarás una lista de la documentación que se publicó y que incluye los espacios de nombres que se agregaron o se modificaron en esta versión.

Si quieres obtener más información acerca de las API que se agregaron en la versión pública anterior, consulta [New APIs in the Windows 10 Creators Update (Nuevas API en Windows 10 Creators Update)](windows-10-build-15063-api-diff.md).
...
#### <a name="accelerometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsaccelerometer"></a>[Acelerómetro](https://docs.microsoft.com/uwp/api/windows.devices.sensors.accelerometer)
...
#### <a name="barometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsbarometer"></a>[Barómetro](https://docs.microsoft.com/uwp/api/windows.devices.sensors.barometer)
...
#### <a name="gyrometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsgyrometer"></a>[Girómetro](https://docs.microsoft.com/uwp/api/windows.devices.sensors.gyrometer)
...
#### <a name="inclinometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsinclinometer"></a>[Inclinómetro](https://docs.microsoft.com/uwp/api/windows.devices.sensors.inclinometer)
...
#### <a name="magnetometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsmagnetometer"></a>[magnetómetro](https://docs.microsoft.com/uwp/api/windows.devices.sensors.magnetometer)
...
#### <a name="dropshadowhttpsdocsmicrosoftcomuwpapiwindowsuicompositiondropshadow"></a>[objeto DropShadow](https://docs.microsoft.com/uwp/api/windows.ui.composition.dropshadow)
...
#### <a name="spotlighthttpsdocsmicrosoftcomuwpapiwindowsuicompositionspotlight"></a>[Contenido destacado](https://docs.microsoft.com/uwp/api/windows.ui.composition.spotlight)
...
springvector2naturalmotionanimation <br> springscalarnaturalmotionanimation.dampingratio <br> springvector2naturalmotionanimation.period
...
#### <a name="comboboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscombobox"></a>[cuadro combinado](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.combobox)
...
fonticonsource <br> fonticonsource.FontFamily <br> fonticonsource.fontfamilyproperty <br> fonticonsource.fonticonsource <br> fonticonsource.fontsize <br> fonticonsource.fontsizeproperty <br> fonticonsource.fontstyle <br> fonticonsource.fontstyleproperty <br> fonticonsource.fontweight <br> fonticonsource.fontweightproperty <br> fonticonsource.glyph <br> fonticonsource.glyphproperty <br> Control.IsTextScaleFactorEnabled <br> fonticonsource.istextscalefactorenabledproperty <br> fonticonsource.mirroredwhenrighttoleft <br> fonticonsource.mirroredwhenrighttoleftproperty

#### <a name="gridhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsgrid"></a>[Cuadrícula](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### <a name="navigationviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsnavigationview"></a>[control navigationview](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.navigationview)
...
#### <a name="navigationviewitemhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsnavigationviewitem"></a>[elemento navigationviewitem](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.navigationviewitem)
...
#### <a name="stackpanelhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsstackpanel"></a>[elemento StackPanel](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.stackpanel)
...
#### <a name="textboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstextbox"></a>[Cuadro de texto](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox)
...
#### <a name="blockhttpsdocsmicrosoftcomuwpapiwindowsuixamldocumentsblock"></a>[Bloque](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)

block.horizontaltextalignment <br> block.horizontaltextalignmentproperty

#### <a name="hyperlinkhttpsdocsmicrosoftcomuwpapiwindowsuixamldocumentshyperlink"></a>[Hipervínculo](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.hyperlink)
