...
#### [<a name="package"></a>Paquete](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### [<a name="frame"></a>Marco](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
Barra de menús <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> Barra de menús. #ctor
...
Botón de división <br> SplitButton.Click <br> SplitButton.Command <br> SplitButton.CommandParameter <br> SplitButton.CommandParameterProperty <br> SplitButton.CommandProperty <br> SplitButton.Flyout <br> SplitButton.FlyoutProperty <br> Botón de división. #ctor
