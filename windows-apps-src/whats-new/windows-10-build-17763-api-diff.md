...
ms.locfileid: "89167009"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Nuevas API en la compilación 17763 de Windows 10

Se han puesto a disposición de los desarrolladores espacios de nombres de API nuevos y actualizados en la compilación 17763 de Windows 10 (también conocida como Actualización de octubre de 2018 o versión 1809). A continuación encontrarás una lista de la documentación publicada para los espacios de nombres que se agregaron o se modificaron en esta versión.

Si quieres obtener más información sobre las API que se agregaron en la versión pública anterior, consulta [New APIs in the Windows 10 April Update (Nuevas API en la Actualización de abril de Windows 10)](windows-10-build-17134-api-diff.md).
...
#### <a name="clipboard"></a>[Portapapeles](/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="frame"></a>[Frame](/uwp/api/windows.ui.xaml.controls.frame)

Frame.IsNavigationStackEnabled <br> Frame.IsNavigationStackEnabledProperty <br> Frame.NavigateToType

#### <a name="grid"></a>[cuadrícula](/uwp/api/windows.ui.xaml.controls.grid)
