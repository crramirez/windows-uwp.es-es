---
title: Cambios en la API de 17763 de compilación de Windows 10
description: Los desarrolladores pueden usar en la lista siguiente para identificar los espacios de nombres nuevo o modificado en Windows 10, compilación 17763
keywords: Novedades, novedades nuevas, actualizaciones, Windows 10 más recientes, API, 17763, octubre
ms.date: 10/02/2018
ms.topic: article
...
ms.locfileid: "57596330"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Nuevas API de Windows 10 17763 de compilación

Los espacios de nombres de las API nuevas y actualizadas están disponibles para los desarrolladores en Windows 10, compilación 17763 (también conocido como el de octubre de 2018 actualización o versión 1809). A continuación encontrarás una lista de la documentación que se publicó y que incluye los espacios de nombres que se agregaron o se modificaron en esta versión.

Para obtener información acerca de las API agregadas en la versión pública anterior, consulte [nuevas API en la actualización Windows 10 de abril](windows-10-build-17134-api-diff.md).
...
#### <a name="clipboardhttpsdocsmicrosoftcomuwpapiwindowsapplicationmodeldatatransferclipboard"></a>[Portapapeles](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="packagehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelpackage"></a>[Paquete](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### <a name="displaypathhttpsdocsmicrosoftcomuwpapiwindowsdevicesdisplaycoredisplaypath"></a>[Mostrar ruta](https://docs.microsoft.com/uwp/api/windows.devices.display.core.displaypath)

Mostrar ruta <br> DisplayPath.ApplyPropertiesFromMode <br> DisplayPath.FindModes <br> DisplayPath.IsInterlaced <br> DisplayPath.IsStereo <br> DisplayPath.PresentationRate <br> DisplayPath.Properties <br> DisplayPath.Rotation <br> DisplayPath.Scaling <br> DisplayPath.SourcePixelFormat <br> DisplayPath.SourceResolution <br> DisplayPath.Status <br> DisplayPath.Target <br> DisplayPath.TargetResolution <br> DisplayPath.View <br> DisplayPath.WireFormat
...
#### <a name="borderhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsborder"></a>[Borde](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### <a name="menubarhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsmenubar"></a>[Barra de menús](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

MenuBar <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> #Ctor de barra de menús.
...
#### <a name="tooltiphttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstooltip"></a>[Información sobre herramientas](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)

ToolTip.PlacementRect <br> ToolTip.PlacementRectProperty

#### <a name="treeviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstreeview"></a>[Vista de árbol](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.treeview)
...
#### <a name="treeviewitemhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstreeviewitem"></a>[Elemento TreeViewItem](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.treeviewitem)
