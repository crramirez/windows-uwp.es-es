...
ms.locfileid: "4351299"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Nuevas API en Windows 10 compilación 17763

Espacios de nombres de API nuevos y actualizados que se han puesto a disposición para los desarrolladores en Windows 10, compilación 17763 (también conocida como la de 2018 octubre Update o versión 1809). A continuación encontrarás una lista de la documentación que se publicó y que incluye los espacios de nombres que se agregaron o se modificaron en esta versión.

Para obtener información acerca de las API que se agregaron en la versión pública anterior, consulta [Las nuevas API en la actualización de abril de Windows 10](windows-10-build-17134-api-diff.md).
...
#### [<a name="clipboard"></a>portapapeles](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### [<a name="displaypath"></a>Mostrar ruta](https://docs.microsoft.com/uwp/api/windows.devices.display.core.displaypath)
...
#### [<a name="frame"></a>fotograma](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### [<a name="menubar"></a>barra de menús](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

barra de menús <br> MenuBar.Items <br> MenuBar.itemsproperty <br> MenuBar.MenuBar
...
#### [<a name="splitbutton"></a>botón de división](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.splitbutton)

botón de división <br> SplitButton.Click <br> SplitButton.Command <br> SplitButton.CommandParameter <br> SplitButton.commandparameterproperty <br> SplitButton.commandproperty <br> SplitButton.Flyout <br> SplitButton.flyoutproperty <br> SplitButton.SplitButton
...
#### [<a name="tooltip"></a>información sobre herramientas](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
