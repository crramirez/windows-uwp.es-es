---
author: QuinnRadich
title: "Cambios en la API de Windows 10, versión 16190"
description: Los desarrolladores pueden usar la siguiente lista para identificar los espacios de nombres nuevos o cambiados en Windows 10 SDK Preview Build 16190
keywords: "novedades, novedad, actualización, piloto, pilotos, API, 15021, what's new, whats new, update, flighted, flights, API, 15021,"
ms.author: quradic
ms.date: 5/11/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16190"></a>Nuevas API en Windows 10 SDK Preview Build 16190

Espacios de nombres de API nuevos y actualizados se han puesto a disposición de los usuarios de [Windows Insider](https://insider.windows.com/) en Windows 10 SDK Preview Build 16190. Esta versión se incluye en la [conferencia de desarrolladores de Microsoft Build 2017](https://developer.microsoft.com/windows/projects/events/build/2017?ocid=wdgbld17_intreferral_devcenterhp_null_null_devcenter_hppost&utm_campaign=wdgbld17&utm_medium=internalreferral&utm_source=devcenterhp&utm_content=devcenter_hppost).

A continuación se proporciona una lista de la documentación de versión preliminar para los espacios de nombres agregados o modificados desde la última versión de Windows 10 pública, [versión 1703](windows-10-version-1703-api-diff.md). Ten en cuenta que la documentación de versión preliminar podría estar incompleta y estar sujeta a cambios.
