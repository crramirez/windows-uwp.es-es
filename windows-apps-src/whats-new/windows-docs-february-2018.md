...
description: Se han agregado nuevas características, vídeos e instrucciones para desarrolladores en la documentación de febrero de 2018 para desarrolladores de Windows 10
keywords: novedades, actualización, características, instrucciones para desarrolladores, Windows 10, febrero
ms.date: 02/05/2018
ms.topic: article
...
Agrupa y organiza tus notificaciones con los [Encabezados de notificaciones del sistema](../design/shell/tiles-and-notifications/toast-headers.md) y la [Activación de actualización pendiente](../design/shell/tiles-and-notifications/toast-pending-update.md).
...
Se ha mejorado nuestra [Introducción al diseño de aplicaciones para UWP](../design/basics/design-and-ui-intro.md) con una gran cantidad de nuevos ejemplos visuales. La descripción general de las características de diseño universal de cada aplicación para UWP destaca ahora cómo puedes poner en acción las funcionalidades del sistema Fluent Design.

Hemos agregado una presentación de patrones de página comunes a nuestros [Conceptos básicos del diseño de contenido](../design/basics/content-basics.md), que proporciona una galería de ejemplos de cómo tu aplicación puede mostrar diferentes tipos de contenido.
