---
author: QuinnRadich
title: "Cambios en la API de Windows 10, versión 16225"
description: "Los desarrolladores pueden usar la siguiente lista para identificar los espacios de nombres nuevos o cambiados en la compilación 16190 de Windows 10 SDK Preview."
keywords: "novedades, novedad, actualización, piloto, pilotos, API, 16225"
ms.author: quradic
ms.date: 7/6/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Nuevas API en la compilación 16225 de Windows 10 SDK Preview

Espacios de nombres de API nuevos y actualizados se han puesto a disposición de los usuarios de [Windows Insider](https://insider.windows.com/) en la compilación 16225 de Windows 10 SDK Preview.

A continuación se proporciona una lista de la documentación de versión preliminar para los espacios de nombres agregados o modificados desde la última versión de Windows 10 pública, [versión 1703](windows-10-version-1703-api-diff.md). **Ten en cuenta que puede tratarse de documentación preliminar incompleta y sujeta a cambios y se puede cambiar el nombre de estas API o eliminarlas en compilaciones posteriores.**
...
mapelementslayerclickeventargs <br> mapelementslayerclickeventargs <br> mapelementslayerclickeventargs.mapelements <br> mapelementslayerclickeventargs.mapelementslayerclickeventargs <br> mapelementslayerclickeventargs.position
