...
#### <a name="audiographhttpsdocsmicrosoftcomuwpapiwindowsmediaaudioaudiograph"></a>[elemento audiograph](https://docs.microsoft.com/uwp/api/windows.media.audio.audiograph)
...
#### <a name="inkpresenterhttpsdocsmicrosoftcomuwpapiwindowsuiinputinkinginkpresenter"></a>[objeto InkPresenter](https://docs.microsoft.com/uwp/api/windows.ui.input.inking.inkpresenter)
