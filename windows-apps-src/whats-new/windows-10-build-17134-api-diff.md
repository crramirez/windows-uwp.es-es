---
title: Cambios en las API de Windows 10, compilación 17134
...
keywords: novedades, novedad, actualizaciones, Windows 10, más reciente, api, 17134
ms.date: 04/10/2018
ms.topic: article
...
ms.locfileid: "67322008"
---
# <a name="new-apis-in-windows-10-build-17134"></a>Nuevas API en la compilación 17134 de Windows 10

Se han puesto a disposición de los desarrolladores espacios de nombres de API nuevos y actualizados en la compilación 17134 de Windows 10 (también conocida como Actualización de abril o versión 1803). A continuación encontrarás una lista de la documentación publicada para los espacios de nombres que se agregaron o se modificaron en esta versión.

Si quieres obtener más información sobre las API que se agregaron en la versión pública anterior, consulta [New APIs in the Windows 10 Fall Creators Update](windows-10-build-16299-api-diff.md) (Nuevas API en Windows 10 Fall Creators Update).
