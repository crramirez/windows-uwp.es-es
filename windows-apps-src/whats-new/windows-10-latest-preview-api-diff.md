---
author: QuinnRadich
title: "Cambios en la API de Windows 10, versión 16257"
description: Los desarrolladores pueden usar la siguiente lista para identificar los espacios de nombres nuevos o cambiados en la actual Windows 10 SDK Preview Build.
keywords: "novedades, novedad, actualización, piloto, pilotos, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Nuevas API en la compilación 16257 de Windows 10 SDK Preview

Espacios de nombres de API nuevos y actualizados se han puesto a disposición de los usuarios de [Windows Insider](https://insider.windows.com/) en la compilación 16257 de Windows 10 SDK Preview.

A continuación se proporciona una lista de la documentación de versión preliminar para los espacios de nombres agregados desde la última versión de Windows 10 pública, [versión 1703](windows-10-version-1703-api-diff.md). **Ten en cuenta que puede tratarse de documentación preliminar incompleta y sujeta a cambios y se puede cambiar el nombre de estas API o eliminarlas en compilaciones posteriores.** También se adjunta es una lista de espacios de nombres API modificados o a los que se ha cambiado el nombre desde las compilaciones preliminares de SDK.
...
#### [<a name="block"></a>bloque](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)
...
## <a name="apis-changed-or-removed-since-build-16232"></a>API cambiadas o eliminadas desde la compilación 16232

Las siguientes API fueron puestas a disposición en o antes de compilación 16232, pero ya no están presentes en esta compilación. Se les ha cambiado el nombre o se han eliminado por completo y su documentación ya no está disponible.
...
## <a name="apis-changed-or-removed-since-build-16225"></a>API cambiadas o eliminadas desde la compilación 16225

Las siguientes API fueron puestas a disposición en o antes de compilación 16225, pero ya no están presentes en esta compilación. Se les ha cambiado el nombre o se han eliminado por completo y su documentación ya no está disponible.
