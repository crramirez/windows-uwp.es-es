...
|----------|-------------|
| [**Camino**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.data.binding.path) | Consulta la sección [Ruta de acceso de propiedades](#property-path) anteriormente. |
