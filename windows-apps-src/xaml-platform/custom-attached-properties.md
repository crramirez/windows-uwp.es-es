...
> [!NOTE]
> Para obtener más información acerca de cómo funcionan los paneles, consulta la [Introducción a los paneles personalizados de XAML](https://msdn.microsoft.com/library/windows/apps/mt228351).
