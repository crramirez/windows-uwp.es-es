...
**Tenga en cuenta**  la compatibilidad C++ con la indización de los orígenes de datos es limitada; consulte [enlace de datos en profundidad](https://docs.microsoft.com/windows/uwp/data-binding/data-binding-in-depth).
