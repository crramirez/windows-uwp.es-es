...
-   Si sueles usar el mismo color de pincel en tu código XAML, define una clase [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/br242962) como un recurso en lugar de usar cada vez un color con nombre como valor de atributo.
