...
**Precaución** Existe una limitación en la implementación XAML de Windows Runtime, y es que no se puede animar una propiedad adjunta personalizada.
