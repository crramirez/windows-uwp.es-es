...
Una *propiedad adjunta* es un concepto de XAML. Conceptualmente es similar a una propiedad global que se puede establecer en cualquier elemento de objeto en XAML. Por lo general, las propiedades adjuntas se definen como una forma especializada de propiedad de dependencia que no tiene un contenedor de propiedades convencional en el modelo de objetos del tipo de propietario.

## Requisitos previos

Se da por hecho que comprendes el concepto básico de propiedad de dependencia y que leíste [Introducción a las propiedades de dependencia](dependency-properties-overview.md).
...
Las propiedades adjuntas de Windows en tiempo de ejecución se implementan como propiedades de dependencia para que el sistema de propiedades pueda almacenar los valores en el almacén de propiedades de dependencia compartido, al igual que se almacenan las propiedades de instancias convencionales. Por lo tanto, las propiedades adjuntas exponen un identificador de propiedad de dependencia en la clase propietaria.
