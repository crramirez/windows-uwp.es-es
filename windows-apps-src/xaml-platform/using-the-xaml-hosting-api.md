...
El XAML UWP API de hospedaje proporciona la base para un conjunto más amplio de controles que ofrecemos para permitir a los desarrolladores incorporar la interfaz de usuario Fluent a que no son de UWP de aplicaciones de escritorio. Esta característica se denomina *XAML Islas*. Para obtener información general de esta característica, consulte [controles UWP en aplicaciones de escritorio](xaml-host-controls.md).
...
* Configurar el proyecto para usar Windows Runtime APIs y habilitar XAML Islas siguiendo [estas instrucciones](xaml-host-controls.md#requirements).
