...
-   Define un identificador [**DependencyProperty**](https://msdn.microsoft.com/library/windows/apps/br242362) como un miembro de propiedad **public****static****readonly** en el tipo propietario.
