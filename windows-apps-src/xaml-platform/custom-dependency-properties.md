...
Ejemplos de propiedades de dependencia en el Windows Runtime son: [**Control. Background**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.background), [**FrameworkElement. width**](/uwp/api/Windows.UI.Xaml.FrameworkElement.Width)y [**TextBox. Text**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox.text), entre muchos otros.
