...
Los siguientes controles UWP ajustados están actualmente disponibles para aplicaciones de WPF y Windows Forms. Controles UWP encapsulada más son previstos para las versiones futuras del Kit de herramientas de comunidad Windows.
