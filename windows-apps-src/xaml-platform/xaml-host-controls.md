...
| [WebViewCompatible](https://docs.microsoft.com/windows/communitytoolkit/controls/wpf-winforms/webviewcompatible) | Windows7 | Proporciona una versión de **WebView** que sea compatible con versiones de sistema operativo más. Este control usa el motor de representación de Microsoft Edge para mostrar contenido web en Windows 10, 1803 y versiones posteriores y el motor de representación de Internet Explorer para mostrar contenido web en versiones anteriores de Windows 10, Windows 8.x y Windows 7. |
