...
**Tenga en cuenta**  para obtener información general sobre el uso de enlace de datos en su aplicación con **{x: Bind}** (y para obtener una comparación total entre **{x: Bind}** y **{Binding}** ), consulte [enlace de datos en profundidad](https://docs.microsoft.com/windows/uwp/data-binding/data-binding-in-depth).
