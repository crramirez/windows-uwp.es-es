...
<li>Navegación global hacia atrás dentro de la aplicación y entre aplicaciones.</li>
</ul>
</td>
     </tr>
     <tr>
...
<li>Navegación global hacia atrás dentro de la aplicación y entre aplicaciones.</li></ul>        
        </td>
     </tr>
    <tr>
...
<ul>
<li>Opcional.</li>
<li>Deshabilitado de manera predeterminada. Los usuarios deben habilitarlo manualmente.</li>
<li>Un botón de software situado en la barra de título de la aplicación.</li>
<li>Navegación hacia atrás solo dentro de la aplicación. No es compatible con la navegación entre aplicaciones.</li></ul>        
        </td>
     </tr>     
...
<tr><td>Teclado</td><td>![keyboard](images/keyboard-wireframe.png)</td><td>Tecla Windows + Retroceso</td></tr>
<tr><td>Cortana</td><td>![speech](images/speech-wireframe.png)</td><td>Di: "Hola Cortana, retrocede"</td></tr>
</table>
...
## <span id="Enable_system_back_navigation_support"></span><span id="enable_system_back_navigation_support"></span><span id="ENABLE_SYSTEM_BACK_NAVIGATION_SUPPORT"></span>Cómo habilitar la compatibilidad con la navegación del botón Atrás del sistema
...
```
## <span id="Enable_the_title_bar_back_button"></span><span id="enable_the_title_bar_back_button"></span><span id="ENABLE_THE_TITLE_BAR_BACK_BUTTON"></span>Cómo habilitar el botón Atrás de la barra de título
...
### <span id="Resuming"></span><span id="resuming"></span><span id="RESUMING"></span>Reanudar
