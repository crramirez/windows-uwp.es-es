...
-   [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/hh968021): contribuye a la apariencia de los efectos visuales generados para los elementos de controles de elemento y coloca el espaciado interno especificado alrededor de cada elemento.
-   [
              **TextBlock.Padding**
