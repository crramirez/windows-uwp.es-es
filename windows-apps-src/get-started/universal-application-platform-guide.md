...
- Para obtener la lista completa de las API de Win32 disponibles para las aplicaciones para UWP, consulta los artículos sobre [conjuntos de API para aplicaciones para UWP](https://docs.microsoft.com/previous-versions/mt186421(v=vs.85)) y [DLL para aplicaciones para UWP](https://docs.microsoft.com/previous-versions/mt186422(v=vs.85)).
