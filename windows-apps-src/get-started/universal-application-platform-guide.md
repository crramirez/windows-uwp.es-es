...
![windows universal apps run on a variety of devices, support adaptive user interface, natural user input, one store, one dev center, y servicios en la nube ](images/universalapps-overview.png)
