        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <ul>
                        <li><a href="//developer.microsoft.com/windows/downloads">Descargar las herramientas y el SDK</a></li>
                        <li><a href="//docs.microsoft.com/windows/uwp/get-started/get-set-up">¿Necesitas un poco de ayuda?</a></li>
                    </ul>
                  </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <ul>
                            <li><a href="//docs.microsoft.com/windows/uwp/get-started/create-uwp-apps">Crear aplicaciones para Windows</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="cardSize">
        <div class="cardPadding">
            <div class="card">
                ...
                <div class="cardText">
                    <h3>Tutoriales</h3>
                    <p>¿Buscas una experiencia de aprendizaje guiado? Estos tutoriales te ayudarán.</p>
                    <br>
                    <p><a href="//docs.microsoft.com/windows/uwp/design/basics/xaml-basics-ui">Conceptos básicos de interfaces de usuario</a></p>
                    <p><a href="//docs.microsoft.com/windows/uwp/data-binding/xaml-basics-data-binding">Enlace de datos</a></p>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Lleva tus aplicaciones a Windows</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="//docs.microsoft.com/windows/uwpcommunitytoolkit/">Kit de herramientas de la comunidad de UWP</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Explorar documentos relacionados</h3>
                        <p><a href="//docs.microsoft.com/dotnet/csharp/index">Guía de C#</a></p>
