...
title: Preparación
description: Estar preparado es más fácil de lo que puedas imaginar. Siga estas instrucciones y comience a crear aplicaciones de plataforma Universal de Windows (UWP) para Windows 10.
ms.date: 05/07/2018
ms.topic: article
...
ms.locfileid: "57658650"
---
# <a name="get-set-up"></a>Preparación

![Prepárate para usar Visual Studio](images/VisualStudio2017Hero_ImageXL-LG.png)

Empezar es más fácil de lo que puedas imaginar. Siga estas instrucciones y comience a crear aplicaciones de plataforma Universal de Windows (UWP) para Windows 10.

## <a name="1-download-or-update-visual-studio"></a>1. Descargar o actualizar Visual Studio

Microsoft Visual Studio 2017 le ayuda a diseñar, codificar, probar y depurar las aplicaciones.

Si aún no tiene Visual Studio 2017, puede instalar la gratuita Microsoft Visual Studio Community 2017. Esta descarga incluye simuladores de dispositivo para probar tus aplicaciones:
...
Para obtener la lista completa de herramientas y descargas, consulta la página de [Descargas](https://go.microsoft.com/fwlink/p/?linkid=285935).
