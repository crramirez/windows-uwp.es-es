...
Un complemento debe estar asociado a una aplicación que haya creado en el centro de [Partners](https://partner.microsoft.com/dashboard) (incluso si todavía no lo ha enviado). Puedes encontrar el botón para **Crear un complemento nuevo** en la página **Introducción** de la aplicación o en su página **Complemento**.
