...
Esta casilla está activada de manera predeterminada, para permitir que los clientes instalen tu aplicación en almacenamiento extraíble o externa multimedia, como una tarjeta SD, o en un volumen del sistema que no son la unidad, como una unidad externa. (Para Windows Phone 8.1, esto se indicaba previamente a través de StoreManifest.xml.)
