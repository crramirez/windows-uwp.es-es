...
description: El informe de campaña de ad del centro de Partners le permite ver el rendimiento de las campañas publicitarias de promoción de la aplicación.
ms.date: 10/31/2018
ms.topic: article
...
ms.locfileid: "74260064"
---
# <a name="ad-campaign-report"></a>Informe de campaña publicitaria

El informe de **campaña de ad** del [centro de Partners](https://partner.microsoft.com/dashboard) le permite ver el rendimiento de las [campañas publicitarias](create-an-ad-campaign-for-your-app.md) de promoción de la aplicación. Para ver el informe, expanda **atraer** en el menú de navegación izquierdo y seleccione **campañas de anuncios**.
...
3.  El cliente cumple los requisitos [COPPA](https://www.ftc.gov/enforcement/rules/rulemaking-regulatory-reform-proceedings/childrens-online-privacy-protection-rule) (no se puede hacer un seguimiento de los clientes que no los cumplen).

En consecuencia, es posible que el seguimiento de instalaciones de la aplicación informe de una cantidad inferior al número real de instalaciones generadas por una campaña publicitaria. Tenga en cuenta que puede ver el número total de instalaciones de una aplicación (a través de campañas y de otro modo) en el informe de [adquisiciones](acquisitions-report.md) del centro de Partners.
