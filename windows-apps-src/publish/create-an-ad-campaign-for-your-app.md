...
6.  En **Tipo de campaña**, elige una de estas opciones:
    * **Anuncio de pago**: Estos anuncios se ejecutarán en cualquier aplicación que coincida con el dispositivo y la categoría de la aplicación. Para las campañas nuevas creadas a partir del 9 de enero de 2017, estos anuncios también aparecerán en MSN.com, Outlook.com, Skype y otras propiedades premium de Microsoft. Las campañas de promoción de aplicaciones dirigidas a aplicaciones y propiedades premium de Microsoft se conocen como campañas *universales*.
    * **Ad de la comunidad (gratis)** : Estos anuncios se ejecutarán en aplicaciones publicadas por otros desarrolladores que también creen campañas de ad de la comunidad. Para poder seleccionar esta opción, debes haber optado por mostrar los anuncios de la comunidad en la página **Monetizar** -> **Anuncios en la aplicación**. Para obtener más información, consulta [Acerca de la publicidad de la comunidad](about-community-ads.md).
    * **Ad de casa (gratis)** : Estos anuncios solo se ejecutarán en las aplicaciones que coincidan con el tipo de dispositivo de la aplicación anunciada. La publicidad interna es gratuita. Para obtener más información, consulta [Acerca de los anuncios internos](about-house-ads.md).
...
9.  En la página **Audiencia**, mostraremos la configuración de audiencia que recomendamos para la campaña. También puedes ajustar esta información:
    * **Países o regiones**: Elija hasta 5 países o regiones en los que desea que aparezca el anuncio. Para obtener una lista de los países o regiones admitidos, consulta [Preguntas comunes sobre las campañas publicitarias](common-questions.md#where-will-my-ad-appear).
    ...
    * **Superficie**: Elija **universal** para permitir que el anuncio aparezca dentro de las aplicaciones, además de MSN.com, Outlook.com, Skype y otras propiedades de Microsoft Premium. Elige **Aplicación** si solo quieres que tu anuncio aparezca en las aplicaciones.
    ...
    * **Sexo**: Elija si desea restringir la audiencia de su anuncio por sexo.
