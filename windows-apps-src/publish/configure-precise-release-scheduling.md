...
>
>Si la aplicación publicada previamente es compatible con versiones anteriores del sistema operativo, cualquier **detener adquisición** fecha seleccionada no se aplicará a los clientes; todavía podrán adquirir la aplicación (a menos que se envíe una actualización con una nueva selección en el [Visibilidad](choose-visibility-options.md#discoverability) sección, o si selecciona **aplicación Asegúrese de estar disponible** desde el **información general sobre aplicaciones** página).
...
Verá dos opciones aquí: **Versión** y **detener adquisición**. 
