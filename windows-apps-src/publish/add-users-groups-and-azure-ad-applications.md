...
> [!IMPORTANT]
> Para agregar usuarios a tu cuenta, primero debe primera [asociar tu cuenta del centro de partners con el inquilino de Azure Active Directory de la organización](associate-azure-ad-with-partner-center.md). 
...
Puedes agregar un grupo del directorio de la organización a tu cuenta del centro de partners. Al hacerlo, todos los usuarios que pertenezcan a dicho grupo podrán tener acceso a la cuenta, con los permisos asociados al rol asignado al grupo.
...
Si quieres conceder acceso al centro de partners a una cuenta de aplicación de Azure AD de marca de nuevo, puedes crear una en la sección de **los usuarios** . Ten en cuenta que esto creará una nueva cuenta en el directorio de la organización, no solo en tu cuenta del centro de partners.
