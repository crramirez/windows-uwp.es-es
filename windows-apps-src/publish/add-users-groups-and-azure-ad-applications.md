...
La sección [Usuarios](manage-account-users.md) del Centro de desarrollo te permite usar AzureActiveDirectory para agregar usuarios a tu cuenta del Centro de desarrollo. A cada usuario se le asigna un rol (o conjunto de permisos personalizados) que define su acceso a la cuenta. También puedes agregar [grupos de usuarios](#groups) y [aplicaciones de AzureAD](#azure-ad-applications) para concederles acceso a tu cuenta del Centro de desarrollo.
...
Si tu cuenta tiene [permisos de administrador global](http://go.microsoft.com/fwlink/p/?LinkId=746654), verás algunas otras maneras de agregar usuarios.

### <a name="additional-methods-for-adding-users"></a>Métodos adicionales para agregar usuarios

Si has iniciado sesión con una cuenta de administrador que también tiene permisos de [administrador global](http://go.microsoft.com/fwlink/?LinkId=746654) para el inquilino de Azure AD en el que estás trabajando, tendrás opciones adicionales para agregar usuarios a tu cuenta del Centro de desarrollo. Deberás seleccionar una de las opciones siguientes:

-   **Agregar usuarios existentes**: elige los usuarios que ya existen en el directorio de tu organización y dales acceso a tu cuenta del Centro de desarrollo, como se ha descrito anteriormente.
-   **Crear nuevos usuarios**: crea nuevas cuentas de usuario de marca para agregarlas tanto al directorio de tu organización como a tu cuenta del Centro de desarrollo.
...
1.  En la página **Usuarios**, haz clic en el nombre de la cuenta de usuario que quieres editar.
...
1.  En la página **Usuarios**, haz clic en **Agregar grupos**.
...
1.  Desde la página **Usuarios**, haz clic en el nombre de la aplicación de Azure AD.
    > [!TIP]
...
1.  En la página **Usuarios**, haz clic en el nombre de la cuenta del usuario, grupo o aplicación de AzureAD que quieres editar.
