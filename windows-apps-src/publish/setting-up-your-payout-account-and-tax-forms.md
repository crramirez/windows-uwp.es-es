...
-   Consulta [Tipos de cuenta, ubicaciones y tarifas](account-types-locations-and-fees.md) para ver si PayPal es un método de pago admitido en tu país o región.
...
1.  Certificado de aceptación (CoA): indica los importes de los pagos que se transfieren a tu cuenta.
...
Microsoft proporciona los tres documentos con el primer pago. En los pagos posteriores, solo recibirás el documento CoA. Guarda los documentos ADA y AA. Podrías necesitarlos para recibir pagos de tu banco en el futuro.
