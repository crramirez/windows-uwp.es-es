...
> [!NOTE]
> Consulta las [directrices de marketing de aplicación](app-marketing-guidelines.md) para obtener información y requisitos relacionados con el uso de la tarjeta de Microsoft Store.
