...
Cuando se [crea un envío de la aplicación](app-submissions.md) (por primera vez o como una actualización), puedes [cargar paquetes de aplicaciones](upload-app-packages.md) para cualquier versión de sistema operativo compatible y la tienda ofrecerá automáticamente a los clientes el paquete que mejor se adapte para ellos.
