---
Description: ¡Haz que tu aplicación se note! Además de lograr que tu aplicación sea lo mejor posible, hay cosas que puedes hacer para facilitar que Microsoft Store y otros sitios la presenten y capten una mayor atención hacia ella.
...
Microsoft Store presenta diferentes aplicaciones, agrupadas por categoría o tema. Hay demasiadas aplicaciones sobresalientes como para presentarlas a todas y es imposible garantizar que se seleccione la tuya. Sin embargo, hay cosas que puedes hacer para asegurarte de que tu aplicación sea elegible y considerada para su promoción en la Tienda. Si sigues estas instrucciones, también será más fácil para otros promocionar tu aplicación en revisiones, medios sociales y otros lugares.

-   **Incluya imágenes y excelentes capturas de pantalla**
...
-   **Publique su aplicación en todos los mercados y lenguajes.**
...
-   **Habilitar filtros para las aplicaciones que contienen contenido + 16 y 18 +**
