...
Puedes realizar cambios en un complemento publicado en cualquier momento. Los cambios de complemento se envió y publica independientemente de la aplicación, por lo que normalmente no es necesario actualizar la aplicación completa con el fin de realizar cambios en un complemento como la actualización de su precio o la descripción.
...
Para enviar actualizaciones, ve a la página del complemento en el panel y haz clic en **Actualizar**. Esto creará una nueva presentación para el complemento, utilizando la información de la presentación anterior como punto de partida. Realice los cambios que gustaría que y, a continuación, haga clic en **Enviar a la tienda**.
