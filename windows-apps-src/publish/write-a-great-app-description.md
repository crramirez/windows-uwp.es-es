...
Una descripción excelente puede hacer que tu aplicación destaque en la Tienda Windows y que los clientes se animen a descargarla. 
            [La descripción que escribiste al enviar la aplicación](create-app-descriptions.md) se muestra en la descripción de la Tienda de la aplicación. Las primeras líneas también pueden mostrarse en la Tienda en listas de algoritmos y resultados de búsqueda.
...
-   **Usa listas y párrafos cortos.** Es posible que los clientes potenciales echen un vistazo rápido a la descripción de la aplicación. Usar listas y párrafos breves en medio del contenido facilita el análisis.
    > 
            **Nota** Si agregas una lista de las [características de la aplicación](create-app-descriptions.md#app-features) también puedes ayudar a mostrar rápidamente lo que hace la aplicación. La lista aparece directamente debajo de la descripción de la aplicación.
...
-   **Usa una longitud adecuada.** Una buena descripción se lee rápidamente, pero también incluye la suficiente información como para mantener el interés del lector y explicar lo que hace la aplicación. Para describir una aplicación compleja, necesitarás más oraciones; para describir una aplicación sencilla, necesitarás solo unas pocas. En la mayoría de los casos, la longitud correcta tiene más de 200 palabras y mucho menos de 3000.
-   **Sé claro sobre las pruebas gratuitas y los productos desde la aplicación.** Si ofreces una prueba gratuita de la aplicación, asegúrate de explicar cómo funciona la prueba para que los clientes comprendan qué funciones son limitadas. También es una buena idea mencionar los tipos de productos desde la aplicación que están disponibles, particularmente si tienen un efecto importante en la funcionalidad de la aplicación.
...
-   **No incluyas vínculos ni información que pertenezca a otro contenido.** Las URL que especifiques en el campo de la descripción no serán interactivas, así que no intentes agregar vínculos a contenido como directivas de privacidad o sitios web de asistencia técnica. En su lugar, agrégalos en las áreas designadas de la página **Descripción de la aplicación**.
-   **No intentes usar etiquetas HTML.** El código HTML u otros códigos no se representarán. La descripción debe ser de solo texto sin formato.
