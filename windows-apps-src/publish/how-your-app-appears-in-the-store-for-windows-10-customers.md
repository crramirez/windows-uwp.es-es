...
## <a name="apps-that-shared-identity-in-the-windows-store-and-windows-phone-store"></a>Aplicaciones que compartían identidad en la Tienda Windows y en la Tienda de Windows Phone
...
| Aplicación para Windows8       | Aplicación de Windows Phone   | Configuración de prueba para Windows 10                                                  |
|---------------------|---------------------|-------------------------------------------------------------------------------|
...
| Versión de prueba con límite de tiempo  | La prueba nunca expira | Sin versión de prueba gratuita en Windows Phone8.1 y versiones anteriores; en otros casos, versión de prueba con límite de tiempo |
| Versión de prueba con límite de tiempo  | Sin prueba gratuita       | Sin versión de prueba gratuita en Windows Phone8.1 y versiones anteriores; en otros casos, versión de prueba con límite de tiempo |

### <a name="markets"></a>Mercados
La aplicación estará disponible para los clientes de Windows10 en todos los mercados en los que hubieras publicado la aplicación. Esto es así incluso si tenías distintas selecciones de mercado para cada Tienda.

### <a name="categories"></a>Categorías
Si la aplicación aparecía en distintas categorías en las dos Tiendas, se usará la de la Tienda Windows para determinar su nueva categoría. Ten en cuenta que algunas categorías son diferentes en la Tienda para clientes de Windows 10, así que asegúrate de revisar la [tabla](#category-changes) que se muestra a continuación.
...
Si la aplicación tiene una directiva de privacidad, la que proporcionaste al enviar la aplicación para Windows8 se mostrará también a los clientes de Windows10.
...
**Cambios de categorías para aplicaciones para Windows8:**
