...
<table>
  ...
  <tr> 
    ...
    <td valign="top"><b>1099-K</b>:<br>Contribuyente: Microsoft Corporation<br>EIN: *** 4442<br><br><b>Importante</b>: el formulario 1099-K contiene importes de <b>compra bruta</b> , no los pagos que te efectuamos.</td>
  </tr>
  <tr> 
...
Recibí al menos 600USD por pagos no relacionados con las ventas de aplicaciones de Microsoft en el año fiscal aplicable (por ejemplo, pagos de incentivos o pagos de un concurso o una promoción).</td>
    <td valign="top"><b>1099-MISC</b>:<br>Pagador: Microsoft Corporation<br>EIN: *** 4442<br><br><b>Importante</b>: determinadas entidades comerciales no recibirán formularios 1099-MISC, independientemente de los importes de pago recibidos de Microsoft.  Para obtener más información, consulta a tu profesional en materia fiscal.</td>
  </tr>
  <tr>
  ...
  <tr>
     <th>Si soy un desarrollador de Estados Unidos vender anuncios en aplicaciones y … </th>
     <th> Debo recibir este formulario</th>
  </tr>
  <tr> 
     <td valign="top">Recibí <b>al menos 600USD en pagos</b> provenientes de anuncios en aplicaciones en el año fiscal aplicable.</td>
    <td valign="top"><b>1099-MISC</b>:<br>Pagador: Microsoft Online, Inc.<br>EIN: *** 0505<br><br><b>Importante</b>: determinadas entidades comerciales no recibirán formularios 1099-MISC, independientemente de los importes de pago recibidos de Microsoft.  Para obtener más información, consulta a tu profesional en materia fiscal.</td>
  </tr>
  <tr> 
...
<table>
  ...
  <tr>
    ...
    <td valign="top">La retención de impuestos se realiza si:<br>
     ...
     2. Resides en un país que no tiene un tratado fiscal con los Estados Unidos.<br><br>Puedes visitar el centro de partners en cualquier momento para enviar un formulario W8 actualizado.<br><br><b>Nota</b>: no todos los ingresos están sujeto a retención de impuestos.</td>
  </tr>
  <tr>
