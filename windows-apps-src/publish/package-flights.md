...
Con los paquetes piloto, solo los paquetes son diferentes; la información de descripción de la tienda serán los mismos para todos los clientes. Cualquier persona del grupo piloto recibirán los paquetes que se incluyen en el paquete piloto, mientras que los clientes que no están en el grupo piloto continuarán recibiendo los paquetes normales (versión final).  Si más adelante decides que quieres que los paquetes de un paquete piloto disponible para todos los clientes, puede usar esos paquetes de la mismas en un envío de versión final. Ten en cuenta que los paquetes piloto debe pasar el [proceso de certificación](the-app-certification-process.md), al igual que cualquier envío.
...
Ten en cuenta que el envío de versión final siempre están clasificado el más bajo (1). Es decir, aquellas personas que no estén en ninguno de tus grupos piloto solo podrán obtener paquetes del envío de versión final a través de la Tienda. Las personas de un grupo piloto siempre obtendrán paquetes del paquete de la clasificación más alta piloto disponible para ellos (pero nunca el envío de versión final, ya que tiene la clasificación más baja). Esto proporciona flexibilidad para determinar cómo distribuir los paquetes a las personas que puedan ser miembros de más de uno de tus grupos piloto.
