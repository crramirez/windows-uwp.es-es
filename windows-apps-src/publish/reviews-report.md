...
El gráfico de **desglose de clasificaciones** aparece en la parte superior de este informe para que pueda obtener una vista rápida de lo siguiente: 
...
< Id. de span = "categorías de detalles de valoración de revisión / >

## <a name="insight-categories"></a>Categorías de detalles de valoración

Los grupos de gráficos de **categorías de detalles de valoración** tus valoraciones según las categorías que hemos determinado pueden asociarse con la valoración.
...
También puedes usar el cuadro de búsqueda para buscar palabras o frases en las opiniones de la aplicación específicas. Ten en cuenta que se busca solo el texto de revisión original escrito por el cliente, incluso si la opinión se ha escrito en un idioma diferente. No se busca texto de crítica traducidas.
...
Como se indicó anteriormente, cuando buscan en tus valoraciones, busca el texto original aportados por el cliente (y no cualquier texto traducido), incluso si tienes activada la casilla **traducir opiniones** .
