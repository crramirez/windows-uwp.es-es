...
|    Informe de mantenimiento (incluyendo datos casi en tiempo Real)      |    Puede ver                      |    Puede ver                      |    Puede ver                      |    Puede ver                |    Sin acceso              |    Sin acceso                     |
...
<table>
    ...
    <tr><td align="left">    <b>Mantenimiento</b> (incluyendo datos casi en tiempo Real) </td><td>    Permite ver el <a href="health-report.md">informe Mantenimiento</a> del producto.    </td><td>    N/D     </td><td>    N/D     </td><td>    N/D         </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Configuración del producto</b>  </td><td>    Puede ver la página de instalación del producto de productos.     </td><td>    Puede ver y editar la página de instalación del producto de productos. </td><td>    Puede ver la página de instalación del producto de complementos.   </td><td>    Puede ver y modificar los complementos de página del programa de instalación del producto.          </td></tr>
    <tr><td align="left">    <b>Precios y disponibilidad</b>  </td><td>    Puede ver el <a href="set-app-pricing-and-availability.md">precios y disponibilidad</a> página de productos.     </td><td>    Puede ver y editar la <a href="set-app-pricing-and-availability.md">precios y disponibilidad</a> página de productos. </td><td>    Puede ver el <a href="set-add-on-pricing-and-availability.md">precios y disponibilidad</a> página de complementos.   </td><td>    Puede ver y editar la <a href="set-add-on-pricing-and-availability.md">precios y disponibilidad</a> página de complementos.          </td></tr>
    <tr><td align="left">    <b>Propiedades</b>   </td><td>    Puede ver el <a href="enter-app-properties.md">propiedades</a> página de productos.      </td><td>    Puede ver y editar la <a href="enter-app-properties.md">propiedades</a> página de productos.       </td><td>    Puede ver el <a href="enter-add-on-properties.md">propiedades</a> página de complementos.     </td><td>    Puede ver y editar la <a href="enter-add-on-properties.md">propiedades</a> página de complementos.               </td></tr>
    <tr><td align="left">    <b>Clasificaciones por edades</b>    </td><td>    Puede ver el <a href="age-ratings.md">Age clasificaciones</a> página de productos.       </td><td>    Puede ver y editar la <a href="age-ratings.md">Age clasificaciones</a> página de productos.    </td><td>    Puede ver la página de la clasificación de antigüedad de los complementos.          </td><td>     Puede ver y editar la página de la clasificación de antigüedad de los complementos.       </td></tr>
    <tr><td align="left">    <b>Paquetes</b>        </td><td>    Puede ver el <a href="upload-app-packages.md">paquetes</a> página de productos.  </td><td>    Puede ver y editar la <a href="upload-app-packages.md">paquetes</a> página de productos, incluidas la carga de paquetes.     </td><td>   Puede ver el <a href="upload-app-packages.md">paquetes</a> página de complementos (si procede).   </td><td>     Puede ver y editar <a href="upload-app-packages.md">paquetes</a> página de complementos (si procede).             </td></tr>
    <tr><td align="left">    <b>Anuncios de Store</b>  </td><td>    Puede ver el <a href="create-app-store-listings.md">Store lista páginas</a> de productos.  </td><td>    Puede ver y editar la <a href="create-app-store-listings.md">Store lista páginas</a> de productos y puede agregar nuevos anuncios Store para distintos idiomas.     </td><td>    Puede ver el <a href="create-add-on-store-listings.md">Store lista páginas</a> de complementos.            </td><td>    Puede ver y editar la <a href="create-add-on-store-listings.md">Store lista páginas</a> de complementos y puede agregar los listados de Store para distintos idiomas.                 </td></tr>
    ...
    <tr><td align="left">    <b>Solicitud de disco</b>   </td><td>    Puede ver la página de solicitud de disco. </td><td>    Puede crear solicitudes de disco. </td><td>   N/D    </td><td>   N/D          </td></tr>
    <tr><td align="left">    <b>Derechos de autor de disco </b>   </td><td>    Puede ver la página de derechos de autor de disco.</td><td>    Puede crear derechos de autor de disco. </td><td>   N/D    </td><td>   N/D          </td></tr>
    </tbody>
    </table>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Usuarios de confianza</b>&nbsp;*</td><td>    Puede ver la página de entidades de usuario de confianza de una cuenta.   </td><td>    Puede ver y editar la página de entidades de usuario de confianza de una cuenta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Servicios de asociados</b>&nbsp;*</td><td>    Puede ver la página de servicios Web de una cuenta.  </td><td>    Puede ver y editar la página de servicios Web de una cuenta.      </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Cuentas de prueba de Xbox</b>&nbsp;*</td><td>    Puede ver la página de cuentas de prueba de Xbox de una cuenta.  </td><td>    Puede ver y editar la página de cuentas de prueba de Xbox de una cuenta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Cuentas de prueba de Xbox por espacio aislado</b>&nbsp;*</td><td>    Puede ver la página de cuentas de prueba de Xbox para solo los espacios aislados especificados de una cuenta.  </td><td>    Puede ver y editar la prueba de Xbox.   <tr><td align="left">    <b>Página de cuentas para solo los espacios aislados especificados de una cuenta    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Dispositivos de Xbox</b>&nbsp;*</td><td>    Puede ver la página de las consolas Xbox un desarrollo de una cuenta.  </td><td>    Puede ver y editar la página de las consolas Xbox un desarrollo de una cuenta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Dispositivos de Xbox por espacio aislado</b>&nbsp;*</td><td>    Puede ver la página de las consolas Xbox un desarrollo para solo los espacios aislados especificados de una cuenta.  </td><td>    Puede ver y editar la página de las consolas Xbox un desarrollo para solo los espacios aislados especificados de una cuenta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Los canales de aplicación</b>&nbsp;*</td><td>    N/D  </td><td>    Permite publicar promocionales canales de vídeo en la consola Xbox para su visualización a través de OneGuide.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Configuración del servicio</b>&nbsp;*</td><td>    Puede ver la página de configuración de servicio de Xbox Live de un producto.  </td><td>    Puede ver y editar la página de configuración de servicio de Xbox Live de un producto.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Acceso a las herramientas</b>&nbsp;*</td><td>    Puede ejecutar las herramientas de Xbox Live en un producto para ver solo los datos.  </td><td>    Puede ejecutar herramientas de Xbox Live en un producto para ver y editar datos.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
</tbody>
</table>
