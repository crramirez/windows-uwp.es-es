...
<tr><td align="left">    <b>Informe de rendimiento de anuncios de nivel de cuenta</b> </td><td align="left">  Permite ver el <a href="advertising-performance-report.md">Informe Rendimiento de la publicidad</a> de nivel de cuenta.      </td><td align="left">  N/D   </td></tr>
...
<tr><td align="left">    <b>Mediación de anuncios</b>                        </td><td align="left">  Permite ver las <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">configuraciones de mediación de anuncios</a> de todos los productos de la cuenta.    </td><td align="left">  Permite ver y cargar las <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">configuraciones de mediación de anuncios</a> de todos los productos de la cuenta.        </td></tr>
...
<tr><td align="left">    <b>Informes del rendimiento de anuncios</b>              </td><td align="left">  Permite ver los <a href="advertising-performance-report.md">Informes Rendimiento de la publicidad</a> de todos los productos de la cuenta.       </td><td align="left">  N/D         </td></tr>
...
<tr><td align="left">    <b>Anuncios de filiales</b>                       </td><td align="left">  Permite ver la utilización de <a href="about-affiliate-ads.md">anuncios de filiales</a> de todos los productos de la cuenta.    </td><td align="left">  Permite administrar y ver la utilización de los <a href="about-affiliate-ads.md">anuncios de filiales</a> de todos los productos de la cuenta.                </td></tr>
<tr><td align="left">    <b>Informe de rendimiento de filiales</b>      </td><td align="left">  Permite ver el <a href="affiliates-performance-report.md">informe de rendimiento de filiales</a> de todos los productos de la cuenta.   </td><td align="left">  N/D   </td></tr>
<tr><td align="left">    <b>Informes Anuncios para instalación de aplicaciones</b>             </td><td align="left">  Puedes ver el <a href="promote-your-app-report.md">Informe Campaña publicitaria</a>.           </td><td align="left">  N/D   </td></tr>
...
<tr><td align="left">    <b>Grupos de clientes</b>                     </td><td align="left">  Permite ver <a href="create-customer-groups.md">grupos de clientes</a> (segmentos y grupos piloto) en la sección <b>Clientes</b>.      </td><td align="left">  Permite crear, editar y ver <a href="create-customer-groups.md">grupos de clientes</a> (segmentos y grupos piloto) en la sección <b>Clientes</b>.       </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Adquisiciones</b>     </td><td>    Permite ver los informes de <a href="acquisitions-report.md">adquisiciones</a> y de <a href="add-on-acquisitions-report.md">adquisiciones de complementos</a> del producto.        </td><td>    N/D    </td><td>    N/D (la configuración para el producto principal incluye informes de adquisición de complementos)        </td><td>    N/D                         </td></tr>
    ...
    <tr><td align="left">    <b>Análisis de Xbox</b> </td><td>    Permite ver el informe de análisis de Xbox del producto. (Nota: este informe aún no está disponible).    </td><td>    N/C   </td><td>    N/D       </td><td>    N/D          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Reservas de nombre</b>   </td><td>    Permite ver la página <a href="manage-app-names.md">Administrar nombres de aplicación</a> del producto.</td><td>    Permite ver y editar la página <a href="manage-app-names.md">Administrar nombres de aplicación</a> del producto, incluso reservar nombres adicionales y eliminar nombres reservados. </td><td>   <i> Permite ver los nombres reservados del complemento.    </td><td>   </i> Permite ver y editar nombres reservados del complemento.          </td></tr>
    </tbody>
    </table>
