...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Adquisiciones</b>     </td><td>    Permite ver los informes de <a href="acquisitions-report.md">adquisiciones</a> y de <a href="add-on-acquisitions-report.md">adquisiciones de complementos</a> del producto.        </td><td>    N/D    </td><td>    N/a (configuración de producto principal incluye el informe de **adquisiciones de complemento** )        </td><td>    N/D                         </td></tr>
    ...
    <tr><td align="left">    <b>Análisis de Xbox</b> </td><td>    Puede ver el [informe de análisis de Xbox](xbox-analytics-report.md) para el producto.    </td><td>    N/D   </td><td>    N/D       </td><td>    N/D          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Reservas de nombre</b>   </td><td>    Permite ver la página <a href="manage-app-names.md">Administrar nombres de aplicación</a> del producto.</td><td>    Permite ver y editar la página <a href="manage-app-names.md">Administrar nombres de aplicación</a> del producto, incluso reservar nombres adicionales y eliminar nombres reservados. </td><td>   Permite ver los nombres reservados del complemento.    </td><td>   Permite ver y editar nombres reservados del complemento.          </td></tr>
    </tbody>
    </table>
