...
# Acerca de los anuncios internos
...
Para configurar uno, selecciona **Campaña interna gratuita** como el **Tipo de campaña** al [crear una campaña publicitaria](create-an-ad-campaign-for-your-app.md). El anuncio será apto automáticamente para aparecer en cualquiera de tus aplicaciones que cumpla los siguientes criterios:
...
> **Nota**: el usuario final verá un determinado anuncio interno un máximo de cinco veces al día.
