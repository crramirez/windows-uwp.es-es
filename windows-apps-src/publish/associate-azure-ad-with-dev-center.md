...
[El centro de partners](https://partner.microsoft.com/dashboard) aprovecha Azure AD para acceso a la cuenta de varios usuarios y la administración. Si la organización ya usa Office365 u otros servicios empresariales de Microsoft, ya tienes AzureAD. De lo contrario, puedes crear un nuevo inquilino de Azure AD desde dentro de centro de partners sin ningún coste adicional.
...
## <a name="associate-your-partner-center-account-with-your-organizations-existing-azure-ad-tenant"></a>Asociar tu cuenta del centro de partners con el inquilino de Azure AD existente de tu organización

Si la organización ya usa Azure AD, sigue estos pasos para vincular tu cuenta del centro de partners.

1.  Desde [El centro de partners](https://partner.microsoft.com/dashboard) , selecciona el icono de engranaje (cerca de la esquina superior derecha del panel) y, a continuación, selecciona la **configuración de desarrollador**. En el menú de **configuración** , selecciona **los inquilinos**.
...
## <a name="create-a-brand-new-azure-ad-to-associate-with-your-partner-center-account"></a>Crear un nuevo Azure AD para asociar con la cuenta del centro de partners

Si necesitas configurar un nuevo Azure AD para vincular con tu cuenta del centro de partners, sigue estos pasos.
