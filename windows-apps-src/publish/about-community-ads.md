...
ms.locfileid: "2883615"
---
# <a name="about-community-ads"></a>Acerca de los anuncios de la comunidad

Si la aplicación [muestra pancarta o anuncios intersticiales pancarta](../monetize/display-ads-in-your-app.md), puede entre-promover la aplicación con otros desarrolladores con aplicaciones en la Store Microsoft para gratis. Esta función se denomina *anuncios de la comunidad*.  

Así es cómo funciona este programa:

* Una vez que participar en los anuncios de la Comunidad tal y como se describe a continuación, puede [crear una campaña de ad de la Comunidad gratuito](create-an-ad-campaign-for-your-app.md). La aplicación compartirá, a continuación, espacio de anuncio promocional con otros programadores que también participación en los anuncios de la Comunidad. Tu aplicación mostrará anuncios de las aplicaciones publicadas por otros desarrolladores que participan en los anuncios de la comunidad y sus aplicaciones mostrarán anuncios de tu aplicación.
...
Antes de poder crear una campaña de ad de la Comunidad para uno de sus aplicaciones, debe participar en el **Monetize** &gt; **anuncios en la aplicación de** página en el panel del centro de desarrollo de Windows.

Para participar en los anuncios de la Comunidad para una aplicación de UWP:

1. En la sección **configuración de mediación** en la página de **anuncios en la aplicación** , seleccione una unidad de ad que va a usar en la aplicación.
2. Si se selecciona la opción de **Microsoft permiten elegir la mejor configuración de mediación para la aplicación** , los anuncios de la Comunidad se habilitan automáticamente para la unidad de ad. De lo contrario, seleccione la configuración de línea base o una configuración específica del mercado en la lista desplegable de **destino** y, a continuación, active la casilla de **los anuncios de la Comunidad de Microsoft** en la lista de **otras redes ad** .

    > [!NOTE]
    > Puede usar los campos de **peso** para especificar la proporción de anuncios que desea mostrar de las redes de pagadas y otras redes de ad, incluidos los anuncios de la Comunidad.

Para participar en los anuncios de la Comunidad para un Windows 8.x o aplicación de Windows Phone 8.x,

1. En la página **en la aplicación de anuncios** , active la casilla **Mostrar anuncios de la Comunidad en mi aplicación** .
