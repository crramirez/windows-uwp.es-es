...
ms.locfileid: "57635790"
---
# <a name="about-community-ads"></a>Acerca de los anuncios de la comunidad

Si la aplicación [muestra banner o anuncios de pancarta intersticial](../monetize/display-ads-in-your-app.md), puede entre-promueva su aplicación con otros desarrolladores de aplicaciones en la Microsoft Store gratuitamente. Esta función se denomina *anuncios de la comunidad*.  

Así es cómo funciona este programa:

* Al participar en los anuncios de comunidad tal como se describe a continuación, puede [crear una campaña de publicidad de comunidad gratuita](create-an-ad-campaign-for-your-app.md). La aplicación, a continuación, compartirán el espacio del anuncio de promoción con otros desarrolladores que participación también en anuncios de la Comunidad. Tu aplicación mostrará anuncios de las aplicaciones publicadas por otros desarrolladores que participan en los anuncios de la comunidad y sus aplicaciones mostrarán anuncios de tu aplicación.
...
Para poder crear una campaña de anuncio de comunidad para uno de sus aplicaciones, debe participar en el **Monetize** &gt; **anuncios en la aplicación** página [centro de partners](https://partner.microsoft.com/dashboard).

Para participar en los anuncios de comunidad para una aplicación para UWP:

1. Seleccione una unidad de anuncio que se usa en la aplicación y desplácese hacia abajo hasta **configuración mediación**.
2. Si **Microsoft permiten optimizar la configuración de mi** está seleccionado, anuncios de la Comunidad están habilitadas para la unidad de anuncio automáticamente. En caso contrario, seleccione la configuración de referencia o una configuración específica del mercado en el **destino** lista desplegable y, a continuación, compruebe el **anuncios de Microsoft Community** cuadro la **otras redes publicitarias** lista.

    > [!NOTE]
    > Puede usar el **peso** campos para especificar la relación de anuncios que desea mostrar desde redes de pago y otras redes publicitarias, incluidos anuncios de la Comunidad.
