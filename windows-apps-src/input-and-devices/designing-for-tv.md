...
> [!NOTE]
> Los colores hexadecimales se especifican en **ARGB** (alfa, rojo, verde y azul).
...
> [!NOTE] 
> La `IsTenFoot` variable se define en [Desencadenador de estado visual personalizado para Xbox.](#custom-visual-state-trigger-for-xbox)
