---
Description: Crea aplicaciones para la Plataforma universal de Windows (UWP) que admitan interacciones personalizadas de dispositivos de lápiz y pluma, incluyendo la entrada de lápiz digital, para ofrecer experiencias de escritura y dibujo naturales.
title: Interacciones de pluma y lápiz
...
Optimiza el diseño de tu aplicación para la Plataforma universal de Windows (UWP) para mejorar la entrada táctil y obtén compatibilidad básica con el lápiz de manera predeterminada.

La plataforma de entrada de lápiz de la aplicación para UWP ofrece, junto con un dispositivo de lápiz, una forma natural de crear notas, dibujos y anotaciones manuscritas. La plataforma admite la captura de datos de entrada de lápiz desde el digitalizador, la generación de datos de lápiz, la representación de los datos como trazos de lápiz en el dispositivo de salida, la administración de los datos de lápiz y la ejecución del reconocimiento de escritura a mano.
...
Además de servir como un [**dispositivo señalador**](https://msdn.microsoft.com/library/windows/apps/br225633) (similar al mouse y a la función táctil), un lápiz o una pluma se suelen asociar a los modos de escribir o dibujar directamente en una pantalla mediante la entrada de lápiz digital.

La plataforma de entrada de lápiz de la Plataforma universal de Windows (UWP), junto con un dispositivo de lápiz o pluma, te ofrecen una forma natural de crear dibujos, anotaciones y notas manuscritas digitales. La plataforma te permite capturar los datos de entrada del digitalizador a modo de datos de entrada de lápiz, generar datos de entrada de lápiz, administrarlos, representarlos como trazos de lápiz y convertirlos en texto a través del reconocimiento de escritura a mano.
...
**Nota** La aplicación también puede ser compatible con la entrada de lápiz de otros dispositivos señaladores, como digitalizadores táctiles y dispositivos de mouse.
...
-   [**InkCanvas**](https://msdn.microsoft.com/library/windows/apps/dn858535): es un control de plataforma de interfaz de usuario XAML que, de manera predeterminada, recibe y muestra todas las entradas de lápiz como un trazo de lápiz o un trazo de borrado.
...
Esta serie de imágenes muestra cómo se representa la entrada manuscrita mediante este control [**InkCanvas**](https://msdn.microsoft.com/library/windows/apps/dn858535).
...
<tr class="even">
<td align="left">Elemento [<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) en blanco con una imagen de fondo.</td>
<td align="left">Elemento [<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) con trazos de lápiz.</td>
<td align="left">Elemento [<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) con un trazo borrado.
<p>Debes observar que el borrador funciona en todo un trazo, no en una parte.</p></td>
</tr>
</tbody>
</table>
...
Para obtener un ejemplo completo de esta funcionalidad, consulta [Complex ink sample (Muestra de entrada de lápiz compleja)](http://go.microsoft.com/fwlink/p/?LinkID=620314).
...
<td align="left"><p>Almacena datos de trazo de lápiz en un archivo de formato de intercambio de gráficos (GIF) con los metadatos de Ink Serialized Format (ISF) incrustados.</p></td>
</tr>
</tbody>
</table>
...
* [Identificar los dispositivos de entrada](identify-input-devices.md)
**Muestras**
