...
5.  La primera vez que hagas esto, Visual Studio te pedirá un PIN para Xbox One. Puedes obtener un PIN iniciando Dev Home en tu Xbox One y seleccionando el botón de **pin de mostrar Visual Studio** .
