...
#### <a name="snap-mode"></a>Modo acoplado
...
#### <a name="tool-descriptions"></a>Descripciones de herramientas
...
<br/>
### <a name="managing-the-size-of-the-developer-storage-allocation"></a>Administrar el tamaño de la asignación de almacenamiento de desarrollador
...
### <a name="setting-a-hostname-for-the-console"></a>Establecer un nombre de host para la consola
...
Windows Device Portal (WDP) es una herramienta de administración de dispositivos OneCore que permite una experiencia de administración de dispositivos basada en explorador.

> [!NOTE]
> Para obtener más información sobre WDP, consulta [Introducción a Windows Device Portal](../debug-test-perf/device-portal.md).
...
## <a name="xbox-dev-mode-companion"></a>Complemento de modo de desarrollo de Xbox
