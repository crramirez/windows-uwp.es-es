...
Fiddler es un software gratuito y puede descargarse desde el [sitio web de Fiddler](https://www.telerik.com/download/fiddler). 
...
1. Instala Fiddler en el equipo de desarrollo; para ello, sigue las instrucciones que se proporcionan en el [sitio web de Fiddler](https://www.telerik.com/download/fiddler). 
...
5. Configura la regla de firewall necesaria para permitir a los equipos remotos conectarse. Iniciar el applet del Panel de Control del Firewall de Windows. Haz clic en **Configuración avanzada** y después en **Regla de entrada**. Busca la regla denominada "FiddlerProxy" y desplázate hacia la derecha, para comprobar que todas de las configuraciones de la siguiente tabla aparecen para esa regla.
  ...
  | Parámetro           | Valor preferido                |
  | ----              | ----                           |
  | Name              | FiddlerProxy                   |
  | Agrupar             | *Ningún valor* |
  | Perfil           | Todos                            |
  | Enabled           | Sí                            |
  | Acción            | Permitir                          |
  | Invalidar          | No                             |
