...
author: TerryWarwick
title: POSPrinter
description: Este artículo muestra las características POSPrinter que están disponibles para aplicaciones para UWP, así como los vínculos a los artículos de procedimientos que muestran cómo usarlos.
ms.author: jken
ms.date: 05/1/2018
ms.topic: article
...
ms.locfileid: "6201228"
---
# <a name="posprinter"></a>POSPrinter

Esta sección proporciona instrucciones para crear aplicaciones de la Plataforma universal de Windows (UWP) que usan una POSPrinter.
