...
Para desarrollar una aplicación de emulación de tarjeta HCE para Windows 10 Mobile, debes obtener la configuración del entorno de desarrollo. Puedes realizar la configuración instalando Microsoft Visual Studio 2015, que incluye las herramientas de desarrollo de Windows y el emulador de Windows 10 Mobile con compatibilidad con la emulación de NFC. Para más información sobre cómo obtener la configuración, consulta [Preparación](https://docs.microsoft.com/windows/uwp/get-started/get-set-up)

Opcionalmente, si quieres hacer pruebas con un dispositivo real de Windows 10 Mobile en lugar de con el emulador de Windows 10 Mobile incluido, también necesitarás los elementos siguientes.
...
Windows 10 admite la emulación de tarjetas inteligentes que se basan en ISO-DEP (ISO-IEC 14443-4) y se comunica mediante APDU según se define en la especificación ISO-IEC 7816-4. Windows 10 admite la tecnología ISO/IEC 14443-4 de tipo A para aplicaciones HCE. Las tecnologías de tipo B, tipo F y no ISO-DEP (p. ej., MIFARE) se enrutan a la tarjeta SIM de manera predeterminada.
...
### <a name="coexistence-with-sim-based-nfc-applications"></a>Coexistencia con aplicaciones NFC basadas en SIM

En Windows 10 Mobile, el sistema configura la tabla de enrutamiento del controlador NFC que se usa para tomar decisiones de enrutamiento en la capa del controlador. La tabla contiene información de los siguientes elementos de distribución.
...
### <a name="event-notification-when-activation-policy-change"></a>Notificación de eventos al cambiar la directiva de activación
