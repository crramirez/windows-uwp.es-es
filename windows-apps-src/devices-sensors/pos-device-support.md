...
|---------------|--------------------------------|------------|--------------|--------------|---------------------------|
| Código          | Reader™ 950                    | 2D         | USB          | Dispositivo de mano     | Escáner de PDV HID           |
| Código          | Reader™ 1021                   | 2D         | USB          | Dispositivo de mano     | Escáner de PDV HID           |
| Código          | Reader™ 1421                   | 2D         | USB          | Dispositivo de mano     | Escáner de PDV HID           |
| Código          | Reader™ 5000                   | 2D         | USB          | Presentación | Escáner de PDV HID           |
| Honeywell     | Genesis 7580g                  | 2D         | USB          | Presentación | Escáner de PDV HID           |
| Honeywell     | Granit 198Xi                   | 2D         | USB          | Dispositivo de mano     | Escáner de PDV HID           |
| Honeywell     | Granit 191Xi                   | 2D         | USB          | Dispositivo de mano     | Escáner de PDV HID           |
...
| Socket Mobile | CHS IMF 7                        | 1D         | Bluetooth    | Dispositivo de mano     | Perfil de puerto serie (SPP) |
...
### <a name="windows-devices-with-built-in-barcode-scanner"></a>Dispositivos de Windows con el escáner integrados
...
| Conectividad | Soporte |
| -------------|-------------|
| Red o Bluetooth | <p> La conexión directa a la caja registradora se puede establecer a través de la red o Bluetooth, según las funcionalidades de la unidad de caja registradora. </p><p>APG caja registradora:  NetPRO, BluePRO</p> |
