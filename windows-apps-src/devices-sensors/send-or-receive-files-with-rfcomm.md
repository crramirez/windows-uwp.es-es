...
-   Use la **RfcommDeviceService.GetDeviceSelector\***  funciones para ayudar a generar una consulta AQS que puede usarse para enumerado emparejan instancias de dispositivo del servicio deseado.
