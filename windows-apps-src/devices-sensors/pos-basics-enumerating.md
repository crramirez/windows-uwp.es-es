...
> [!NOTE]
> Este método requiere el más reciente de [Windows SDK Insider Preview](https://www.microsoft.com/software-download/windowsinsiderpreviewSDK).
