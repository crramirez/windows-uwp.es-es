---
author: TerryWarwick
title: Configurar un escáner de código de barras
description: Aprenda a configurar un escáner de código de barras para la aplicación.
ms.author: jken
ms.date: 08/29/2018
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3931009"
---
# <a name="configure-a-barcode-scanner"></a>Configurar un escáner de código de barras
...
Para poder utilizar el escáner de código de barras de Bluetooth debe emparejarlo con **Configuración > dispositivos > Bluetooth & otros dispositivos > agregar Bluetooth u otro dispositivo de**.

Puede iniciar y controlar el proceso de emparejamiento con el espacio de nombres [Windows.Devices.Enumeration](https://docs.microsoft.com/uwp/api/windows.devices.enumeration) .  Para obtener más información, consulta [Emparejar dispositivos](https://docs.microsoft.com/windows/uwp/devices-sensors/pair-devices).
