...
## <a name="step-1-add-capability-declarations-to-your-app-manifest"></a>Paso 1: Agregar declaraciones de funcionalidades para el manifiesto de aplicación
...
## <a name="step-2-add-using-directives"></a>Paso 2: Agregue directivas using
...
### <a name="option-a-find-all-barcode-scanners"></a>**Opción A: Buscar todos los analizadores de código de barras**

```Csharp
string selector = BarcodeScanner.GetDeviceSelector();       
```

### <a name="option-b-scoping-device-selector-to-connection-type"></a>**Opción B: Selector de dispositivos al tipo de conexión de ámbito**
...
## <a name="step-4-enumerate-barcode-scanners"></a>Paso 4: Enumerar los analizadores de código de barras
...
### <a name="option-a-enumerate-a-snapshot-of-barcode-scanners"></a>**Opción A: Enumerar una instantánea de los analizadores de código de barras**
```Csharp
DeviceInformationCollection deviceCollection = await DeviceInformation.FindAllAsync(selector);
```
...
### <a name="option-b-enumerate-and-watch-for-changes-in-available-barcode-scanners"></a>**Opción B: Enumerar y ver los cambios en los analizadores de código de barras disponible**
```Csharp
...
## <a name="step-5-identify-camera-barcode-scanners"></a>Paso 5: Identificar los analizadores de código de barras de cámara
...
## <a name="step-6-claim-the-camera-barcode-scanner"></a>Paso 6: Reclamar el escáner de cámara 
...
## <a name="step-7-system-provided-preview"></a>Paso 7: Versión preliminar del sistema proporcionado
...
## <a name="step-8-initiate-scan"></a>Paso 8: Iniciar análisis 
