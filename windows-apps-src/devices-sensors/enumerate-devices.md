...
Para descargar una muestra que presente los usos más avanzados de las API de [**Windows.Devices.Enumeration**](https://msdn.microsoft.com/library/windows/apps/BR225459), haz clic [aquí](https://go.microsoft.com/fwlink/?LinkID=620536).
...
-   [**Detección e inicie (marcado)**](https://msdn.microsoft.com/library/windows/apps/Dn946818)
-   [**Detección de servicios DNS (DNS-SD)**](https://msdn.microsoft.com/library/windows/apps/Dn895183)
