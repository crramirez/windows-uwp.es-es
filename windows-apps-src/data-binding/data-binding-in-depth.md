...
| Origen | No necesaria | `<ListView ItemsSource="{Binding Orders, Source={StaticResource MyData}}"/>` | Para {x:Bind} puede usar directamente el elemento con nombre, usar una propiedad o una ruta de acceso estática. | 
