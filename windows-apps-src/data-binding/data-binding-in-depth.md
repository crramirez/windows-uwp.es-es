...
-   Puedes usar el modo único para enlazar un elemento [**Image**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Image) con la foto del usuario actual.
