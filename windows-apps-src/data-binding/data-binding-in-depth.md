...
-   Usar el modo unidireccional para enlazar una [**ListView**](https://msdn.microsoft.com/library/windows/apps/BR242878) a una colección de artículos de noticias en tiempo real agrupados por sección periódicos.
-   Usar el modo bidireccional para enlazar un [**cuadro de texto**](https://msdn.microsoft.com/library/windows/apps/BR209683) para el nombre de un cliente en un formulario.
