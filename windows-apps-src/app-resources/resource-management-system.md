...
- Cada archivo PRI contiene una colección de recursos con nombre que hace referencia a una asignación de recursos. Cuando se carga un archivo PRI desde un paquete, se comprueba si el nombre del mapa de recursos coincide con el nombre de identidad del paquete.
