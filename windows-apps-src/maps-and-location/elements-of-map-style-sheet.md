...
| >>> neighborhood             | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Etiquetas de área de barrio. |
...
| >>>> business                | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | Iconos que representan la ubicación de la empresa. |
...
| >>> countryRegion            | [BorderedMapElement](#borderedmapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Bordes de la región de país y etiquetas. |
...
| borderVisible                | Bool    |  ✔   |  ✔   |  ✔   |  ✔   |  |
| borderWidthScale             | Flotante   |  ✔   |  ✔   |  ✔   |  ✔   | El importe por el cual se escalan el trazo de los bordes. Por ejemplo, usa *1* para el valor predeterminado y *2* para el doble del tamaño. |
...
| Propiedad                     | Tipo    | 1703 | 1709 | 1803 | 1809 | Descripción |
|------------------------------|---------|------|------|------|------|-------------|
| Fondo de la forma             | Flotante   |      |      |      |  ✔   | Forma que se usará como el fondo del icono: reemplazar cualquier forma que existe. |
