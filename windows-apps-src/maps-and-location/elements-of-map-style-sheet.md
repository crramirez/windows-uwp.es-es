...
| useDefaultImageColors        | Bool    |  ✔   |  ✔   |  ✔   |  ✔   | Un marcador que indica si los colores originales en SVG se deben usar en lugar de inigualable la entrada de la paleta de colores en una imagen. |
