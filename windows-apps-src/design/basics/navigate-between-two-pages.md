---
Description: Obtenga información sobre cómo habilitar la navegación de punto a punto entre dos páginas básicas en una aplicación de plataforma Universal de Windows (UWP).
...
> **API importantes**: [**Windows.UI.Xaml.Controls.Frame** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Frame) (clase), [ **Windows.UI.Xaml.Controls.Page** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Page) (clase), [ **Windows.UI.Xaml.Navigation** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Navigation) espacio de nombres

![navegación punto a punto](images/peertopeer.png)

## <a name="1-create-a-blank-app"></a>1. Creación de una aplicación en blanco
...
En el archivo de código subyacente Page1.xaml, agrega el siguiente código para controlar el evento `Click` del objeto [**HyperlinkButton**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.HyperlinkButton) que has agregado para navegar a Page2.xaml.
...
En el archivo de código subyacente Page2.xaml, agrega el siguiente código para controlar el evento `Click` del objeto [**HyperlinkButton**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.HyperlinkButton) para navegar a Page1.xaml.
...
> [!NOTE]
> Este código utiliza el valor devuelto de [ **Navigate** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame.navigate) para producir una excepción de aplicación si se produce un error en el panel de navegación para el marco de ventana inicial de la aplicación. Cuando **Navigate** devuelve **true**, se produce la navegación.
...
En Page1.xaml, reemplace el **HyperlinkButton** que agregó anteriormente con el siguiente [ **StackPanel**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.StackPanel).

En este caso, agregamos un [ **TextBlock** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.TextBlock) etiqueta y un [ **TextBox** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.TextBox) `name` para escribir una cadena de texto.
...
* [Conceptos básicos del diseño de navegación para aplicaciones UWP](https://docs.microsoft.com/windows/uwp/layout/navigation-basics)
* [Directrices para las pestañas y tablas dinámicas](https://docs.microsoft.com/windows/uwp/controls-and-patterns/tabs-pivot)
* [Directrices para los paneles de navegación](https://docs.microsoft.com/windows/uwp/controls-and-patterns/nav-pane)
