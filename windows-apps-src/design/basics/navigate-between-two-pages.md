---
Description: Aprenda a habilitar la navegación de punto a punto entre dos páginas básicas en una aplicación de la Plataforma universal de Windows (UWP).
...
Una vez hecho esto, agregamos una etiqueta [**TextBlock**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.TextBlock) y una clase [**TextBox**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.TextBox) (`name`) para escribir una cadena de texto.
...
* [Conceptos básicos del diseño de navegación para las aplicaciones para UWP](https://docs.microsoft.com/windows/uwp/layout/navigation-basics)
* [Directrices para pestañas y tablas dinámicas](https://docs.microsoft.com/windows/uwp/controls-and-patterns/tabs-pivot)
* [Directrices sobre paneles de navegación](https://docs.microsoft.com/windows/uwp/controls-and-patterns/nav-pane)
