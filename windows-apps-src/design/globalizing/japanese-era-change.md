...
> [!NOTE]
> 1 de abril de 2019, se anunció el nombre de la nueva era: Reiwa (令和). 25 de abril, Microsoft publicó paquetes para los distintos sistemas operativos de Windows que contiene la clave del registro actualizados con el nombre de la nueva era. Actualizar el dispositivo y comprobar su registro para ver si tiene la nueva clave y, a continuación, pruebe la aplicación. Comprobar [este artículo de soporte técnico](https://support.microsoft.com/help/4469068/summary-of-new-japanese-era-updates-kb4469068) para asegurarse de que el sistema operativo debe haber recibido la clave del registro actualizado.

El calendario japonés se divide en eras, y para la mayoría de la era de la informática moderna, hemos sido de la era Heisei; Sin embargo, se iniciará una nueva era en el 1 de mayo de 2019. Dado que es la primera vez en décadas que cambiará la era, el software compatible con el calendario japonés deberá probarse para asegurar que funcionará correctamente cuando se inicie la nueva era.
...
> [!NOTE]
> Las instrucciones siguientes están diseñadas para los dispositivos que aún no se han actualizado con la nueva clave del registro. En primer lugar, compruebe si el dispositivo contiene la nueva clave del registro y si no, pruebe con las siguientes instrucciones.

Es importante comprobar problemas de compatibilidad antes de que ha cambiado la era, y puede hacer ahora con el nombre de la nueva era. Para ello, agrega una clave del Registro para la nueva era, mediante **Editor del Registro**:
...
4. En el **datos del valor** , introduzca**令和_令_Reiwa_R** (puede copiar y pegar desde esta página para que sea más fácil).
...
1 de abril de 2019, el nombre de la nueva era fue anunciado. 25 de abril, publicó una actualización con una nueva clave del registro para las versiones compatibles de Windows que contiene el nombre, lo que le permite validar la aplicación controla correctamente. Esta actualización se propaga a admite 7 y versiones anteriores de Windows 10, así como Windows 8.
...
Puede seguir junto con las actualizaciones para el sistema operativo y el SDK en [actualizaciones para pueden cambiar de 2019 Japón Era](https://support.microsoft.com/help/4470918/updates-for-may-2019-japan-era-change).
...
* [Control de una nueva era en el calendario japonés en .NET](https://devblogs.microsoft.com/dotnet/handling-a-new-era-in-the-japanese-calendar-in-net/)
