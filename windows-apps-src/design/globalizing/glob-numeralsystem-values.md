...
ms.locfileid: "7970159"
---
# <a name="numeralsystem-values"></a>Valores NumeralSystem

En este tema se enumeran los valores disponibles en la propiedad **NumeralSystem** de diversas clases en el espacio de nombres [**Windows.Globalization**](/uwp/api/windows.globalization?branch=live). Estas clases contienen una propiedad **NumeralSystem**.
...
La propiedad **NumeralSystem** indica el sistema numeral usado por la clase. La propiedad es una cadena como "Latn" para el sistema numeral latino (0123456789) o "Arab" para el sistema numeral indoarábigo (٠١٢٣٤٥٦٧٨٩).

Estos son los valores de **NumeralSystem** que se admiten en Windows.

| Valor de NumeralSystem | Descripción | Punto de código Unicode |
| -------------------- | ----------- | ------------------- |
| Arab | Indoarábigo | U+0660, U+0661, U+0662, U+0663, U+0664, U+0665, U+0666, U+0667, U+0668, U+0669 |
| ArabExt | Indoarábigo extendido | U+06F0, U+06F1, U+06F2, U+06F3, U+06F4, U+06F5, U+06F6, U+06F7, U+06F8, U+06F9 |
...
| FullWide | Caracteres de ancho completo | U+FF10, U+FF11, U+FF12, U+FF13, U+FF14, U+FF15, U+FF16, U+FF17, U+FF18, U+FF19 |
| Gujr | Gujarati | U+0AE6, U+0AE7, U+0AE8, U+0AE9, U+0AEA, U+0AEB, U+0AEC, U+0AED, U+0AEE, U+0AEF |
| Guru | Gurumukhi | U+0A66, U+0A67, U+0A68, U+0A69, U+0A6A, U+0A6B, U+0A6C, U+0A6D, U+0A6E, U+0A6F |
| Java | Javanés | U+A9D0, U+A9D1, U+A9D2, U+A9D3, U+A9D4, U+A9D5, U+A9D6, U+A9D7, U+A9D8, U+A9D9 |
