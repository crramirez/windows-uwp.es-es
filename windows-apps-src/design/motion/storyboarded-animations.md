...
-   [**Doble**](https://docs.microsoft.com/dotnet/api/system.double), se puede animar con cualquier [**DoubleAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.DoubleAnimation)
-   [**Point**](https://docs.microsoft.com/uwp/api/Windows.Foundation.Point) se puede animar con cualquier clase [**PointAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.PointAnimation)
-   [**Color**](https://docs.microsoft.com/uwp/api/Windows.UI.Color), se puede animar con cualquier clase [**ColorAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ColorAnimation)

También hay un tipo de animación [**Objeto**](https://docs.microsoft.com/dotnet/api/system.object) generalizada para los valores de referencia del objeto, que analizaremos más adelante.
...
Para obtener más información sobre los valores de [**duración**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Duration) y la sintaxis de XAML, vea [**Duration**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Duration).
...
Antes mencionamos que puedes omitir **De origen**, **De destino** o **Por** y, por ende, usar los valores actuales no aminados como sustitutos para un valor que falta. Las propiedades **from**, **to**o **by** de una animación no son del tipo que se puede adivinar. Por ejemplo, el tipo de la propiedad [**DoubleAnimation.To**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.doubleanimation.easingfunction) no es [**Doble**](https://docs.microsoft.com/dotnet/api/system.double). En su lugar, es un [**valor null**](https://docs.microsoft.com/dotnet/api/system.nullable-1) para **Double**. Y su valor predeterminado es **null**, no 0. Ese valor **null** es cómo distingue el sistema de animación que no ha establecido específicamente un valor para una propiedad **from**, **to**o **by** . Las extensiones del componente Visual C++ (C++/CX) no tienen un tipo **NULL**, por lo que usan [**IReference**](https://docs.microsoft.com/uwp/api/Windows.Foundation.IReference_T_) en su lugar.
...
-   La [**duración**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.timeline.duration) de la animación es de 0 segundos (vea la advertencia)
...
El controlador de eventos inicia el [**guion gráfico**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard) (la animación) mediante el método [**Begin**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.storyboard.begin) del **guión gráfico**.
...
* [Introducción a las propiedades de dependencia](https://docs.microsoft.com/windows/uwp/xaml-platform/dependency-properties-overview)
