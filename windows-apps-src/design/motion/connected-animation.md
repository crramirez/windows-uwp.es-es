...
| - |
| Este es el valor predeterminado (y solo) animación que se usan en las versiones anteriores a Windows 10, versión 1809 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)). |
