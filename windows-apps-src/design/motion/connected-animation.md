...
| - |
| Este es el valor predeterminado (y solo) animación que se usan en las versiones SDK anteriores RS5 (versión del SDK de Windows 10.0.NNNNN.0 (Windows 10, versión aamm). |
