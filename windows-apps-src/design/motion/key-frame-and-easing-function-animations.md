...
-   [**AutoReverse**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.timeline.autoreverse): una vez alcanzado el último fotograma clave, los fotogramas se repiten en orden inverso al final. Esto duplica la duración aparente de la animación.
...
-   [**SpeedRatio**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.timeline.speedratioproperty) (no se usa habitualmente)
...
-   [**Aceleración**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.BackEase): Retira ligeramente el movimiento de una animación antes de que empiece a animarse en la ruta de acceso indicada.
-   [**BounceEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.BounceEase): Crea un efecto de rebote.
-   [**CircleEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.CircleEase): Crea una animación que acelera o desacelera con una función circular.
-   [**CubicEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.CubicEase): Crea una animación que acelera o desacelera mediante la fórmula f (t) = T3.
-   [**ElasticEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ElasticEase): Crea una animación que se parece a un muelle que oscila hacia atrás y hacia delante hasta que llegue al resto.
-   [**ExponentialEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ExponentialEase): Crea una animación que acelera o desacelera mediante una fórmula exponencial.
-   [**PowerEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.PowerEase): Crea una animación que acelera o desacelera mediante la fórmula f (t) = TP, donde p es igual a la propiedad de [**energía**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.powerease.power) .
-   [**QuadraticEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuadraticEase): Crea una animación que acelera o desacelera mediante la fórmula f (t) = T2.
-   [**QuarticEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuarticEase): Crea una animación que acelera o desacelera mediante la fórmula f (t) = T4.
-   [**QuinticEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuinticEase): Cree una animación que acelere o ralentice el uso de la fórmula f (t) = T5.
-   [**SineEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.SineEase): Crea una animación que acelera o desacelera mediante una fórmula de seno.
