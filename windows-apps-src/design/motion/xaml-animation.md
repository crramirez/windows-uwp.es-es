...
-   [Transición de página](#page-transition): Anima las transiciones de página en un [**marco**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Frame).
