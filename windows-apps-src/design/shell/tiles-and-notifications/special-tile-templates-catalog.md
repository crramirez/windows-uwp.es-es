...
Crear los activos de icono para tu icono y situarlos en tus recursos del proyecto con tus otros activos. Como mínimo, crea un icono de 200 x 200 píxeles, que funcione tanto para iconos pequeños como medianos en teléfonos y en el escritorio. Para proporcionar la mejor experiencia de usuario, crea un icono para cada tamaño. No es necesario ningún relleno en estos recursos. Consulta los detalles de ajuste de tamaño en la imagen a continuación.
...
Del mismo modo que en el paso 3, este paso puede variar en función de si la notificación se envía de forma local o a través de inserción del servidor, pero la carga de XML que envíes sigue siendo la misma. Para enviar una notificación local, crea un [**BadgeUpdater**](/uwp/api/Windows.UI.Notifications.BadgeUpdater) para tu icono (ya sea un icono principal o secundario) y después envía una notificación con tu valor deseado (o borra el distintivo).
