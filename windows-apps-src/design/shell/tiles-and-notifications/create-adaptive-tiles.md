...
(Si lo deseas, puedes seguir usar las plantillas preestablecidas del [catálogo de plantillas de iconos de Windows8](https://msdn.microsoft.com/library/windows/apps/hh761491) al diseñar las notificaciones para Windows 10.)
...
Lee nuestro artículo [Inicio rápido sobre cómo enviar notificaciones de icono locales](sending-a-local-tile-notification.md). La documentación siguiente explica todas las posibilidades visuales de la interfaz de usuario que tienes con los iconos adaptables.
...
El contenido para cada tamaño de icono se especifica de forma individual en diferentes elementos [TileBinding](../tiles-and-notifications/tile-schema.md#tilebinding) dentro de la carga XML. Elige el tamaño de destino estableciendo el atributo de plantilla a uno de los siguientes valores:
...
1. Mediante la aplicación del atributo en el elemento [TileBinding](../tiles-and-notifications/tile-schema.md#tilebinding)
2. Mediante la aplicación del atributo en el elemento [TileVisual](../tiles-and-notifications/tile-schema.md#tilevisual), que afecta a toda la carga de notificaciones. Si no especificas la personalización de marca de un enlace, se usará la personalización de marca que se proporciona en el elemento visual.
...
**Nota**el estilo de forma predeterminada en modo de subtítulo si no se especifica hint-style.
...
Si no se especifica ningún comportamiento adicional, las imágenes se reducirán o expandirán uniformemente para rellenar el ancho disponible. En este ejemplo se muestra un icono con dos columnas e imágenes alineadas. Las imágenes alineadas se ajustan para rellenar el ancho de la columna.
...
Puedes controlar la alineación vertical del contenido del icono mediante el atributo **hint-textStacking** tanto en el elemento [TileBinding](../tiles-and-notifications/tile-schema.md#tilebinding) como en el elemento [AdaptiveSubgroup](../tiles-and-notifications/tile-schema.md#adaptivesubgroup). De manera predeterminada, todo el contenido se alinea de forma vertical en la parte superior, pero también puedes alinear contenido en la parte inferior o en el centro.

### <a name="text-stacking-on-binding-element"></a>Apilamiento de texto en el elemento binding

Cuando se aplica al nivel [TileBinding](../tiles-and-notifications/tile-schema.md#tilebinding), el apilamiento de texto define la alineación vertical de todo el contenido de la notificación y se alinea en el espacio vertical disponible por encima del área de notificación o la personalización de marca.
...
Cuando se aplica al nivel [AdaptiveSubgroup](../tiles-and-notifications/tile-schema.md#adaptivesubgroup), el apilamiento de texto define la alineación vertical del contenido del subgrupo (columna) y se alinea en el espacio vertical disponible en todo el grupo.
