...
Si prefiere usar XML sin formato en lugar de la [biblioteca de notificaciones](https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/), consulte [el esquema XML](toast-xml-schema.md).
...
| **Aviso** | Una notificación de recordatorio. Esto se mostrará previamente expandido y permanecerá en la pantalla del usuario hasta que se descarte. |
...
| **Inferior** | Alineación vertical en la parte inferior. |
