...
Si prefiere usar XML sin formato en lugar de la [biblioteca de notificaciones](https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/), consulte [el esquema XML]().
...
| **Elemento visual** | [ToastVisual](#toastvisual) | true | Describe la parte visual de la notificación del sistema. |
...
| **Header** | [ToastHeader](#toastheader) | false | Novedad en Creators Update: Agregue un encabezado personalizado a la notificación para agrupar varias notificaciones en el centro de actividades. |
...
| **Título** | Menor que el tamaño de fuente del párrafo. |
...
| **Básicas** | Tamaño de fuente de H4. |
