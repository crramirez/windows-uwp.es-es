...
- [**SpeechRecognitionTopicConstraint**](https://msdn.microsoft.com/library/windows/apps/dn631446), una restricción en función de una gramática predefinida (búsqueda de dictado o web).
