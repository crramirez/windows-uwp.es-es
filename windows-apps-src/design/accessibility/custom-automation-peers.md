...
* [**GetBoundingRectangleCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getboundingrectanglecore): Devuelve un [ **Rect** ](https://msdn.microsoft.com/library/windows/apps/BR225994) estructura según las características de diseño conocido. Devuelve un valor de 0 **Rect** si [**IsOffscreen**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreen) es **true**.
* [**GetClickablePointCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getclickablepointcore): Devuelve un [ **punto** ](https://msdn.microsoft.com/library/windows/apps/BR225870) estructura según las características de diseño conocido, siempre y cuando hay un distinto de cero **BoundingRectangle**.
* [**GetNameCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getnamecore): Comportamiento más amplio que se pueden resumir aquí; consulte [ **GetNameCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getnamecore). Básicamente, intenta una conversión de cadena en cualquier contenido conocido de un [**ContentControl**](https://msdn.microsoft.com/library/windows/apps/BR209365) o clases relacionadas que tienen contenido. Además, si existe un valor para [**LabeledBy**](https://msdn.microsoft.com/library/windows/apps/Hh759769), ese valor **Name** del elemento se usa como **Nombre**
* [**HasKeyboardFocusCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.haskeyboardfocuscore): Evalúa basándose en el propietario [ **FocusState** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.focusstate) y [ **IsEnabled** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.isenabled) propiedades. Los elementos que no son controles siempre devuelven **false**.
* [**IsEnabledCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isenabledcore): Evalúa basándose en el propietario [ **IsEnabled** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.isenabled) propiedad si es un [ **Control**](https://msdn.microsoft.com/library/windows/apps/BR209390). Los elementos que no son controles siempre devuelven **true**. Esto no significa que el propietario esté habilitado en el sentido convencional de interacción; significa que el sistema del mismo nivel está habilitado a pesar de que el propietario no tiene una propiedad **IsEnabled**.
* [**IsKeyboardFocusableCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.iskeyboardfocusablecore): Devuelve **true** si es propietario de un [ **Control**](https://msdn.microsoft.com/library/windows/apps/BR209390); de lo contrario es **false**.
* [**IsOffscreenCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreencore): Un [ **visibilidad** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.visibility) de [ **Collapsed** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.visibility) en el propietario del elemento o cualquiera de sus elementos primarios equivale a un **true** valor de [ **IsOffscreen**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreen). Excepción: un objeto [**Popup**](https://msdn.microsoft.com/library/windows/apps/BR227842) puede ser visible incluso si los elementos principales de su propietario no lo son.
* [**SetFocusCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.setfocuscore): Las llamadas [ **foco**](https://msdn.microsoft.com/library/windows/apps/hh702161).
* [**GetParent**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getparent): Las llamadas [ **FrameworkElement.Parent** ](https://msdn.microsoft.com/library/windows/apps/BR208739) del propietario y busca el punto adecuado. Este no es un par de invalidación con un método "Core", por lo que no puedes cambiar este comportamiento.
