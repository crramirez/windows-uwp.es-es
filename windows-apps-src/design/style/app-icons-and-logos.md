...
Dado que los activos de icono de aplicación son mapas de bits y mapas de bits no se escalan bien, te recomendamos que proporciones una versión cada recurso de icono para cada factor de escala: 100%, 125%, 150%, 200% y 400%. ¡Eso es una gran cantidad de iconos! Fortunatly, Visual Studio proporciona una herramienta que facilita el proceso generar y actualizar estos iconos. 
...
Si no quieres que tu icono para ampliar hasta el borde de la ventana, puedes usar píxeles transparentes en su activo para crear el espaciado interno. 
