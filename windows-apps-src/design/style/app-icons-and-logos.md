...
:::row:::
    :::column:::
        * La barra de título de la ventana de la aplicación * la lista de aplicaciones en el menú Inicio * el Administrador de tareas y la barra de tareas * los iconos de la aplicación * pantalla de presentación de la aplicación * en la Microsoft Store :::column-end:::
    :::column:::
        ![windows 10 start and tiles](images/assetguidance01.jpg)
    :::column-end:::
:::row-end:::

En este artículo describe los conceptos básicos de creación de iconos de la aplicación, cómo usar Visual Studio para administrarlas y cómo administrarlos manualmente, si es necesario.
...
| Nombre del icono | Aparece en | Nombre de archivo de activos |
| ---      | ---        | --- |
...
| Logotipo de la tienda o logotipo de paquete | Instalador de aplicación, el centro de desarrollo, la opción "Informar de una aplicación" en la tienda, la opción "Escribir una opinión" en la tienda | StoreLogo.png  |
...
Para garantizar que estos iconos se ven nítidos en cada pantalla, puedes crear varias versiones del mismo icono de factores de escala de visualización diferentes. 

El factor de escala determina el tamaño de los elementos de la interfaz de usuario, como texto. Intervalo de factores de escala del 100% y 400%. Los valores más grandes crean los elementos de interfaz de usuario más grandes, lo que facilita su consulta en pantallas con valores altos de PPP. 
...
De manera predeterminada, usamos algunas de las imágenes de los paquetes en la tienda, tal como se describe en la tabla en la parte superior de esta página (junto con otras [imágenes que proporciones durante el proceso de envío](https://docs.microsoft.com/en-us/windows/uwp/publish/app-screenshots-and-images)). Sin embargo, tienes la opción de evitar que Store use las imágenes de logotipo en paquetes de la aplicación al mostrar la descripción a los clientes de Windows 10 (incluyendo Xbox) y en su lugar, hacer que Store utilice solo las imágenes que cargues. Esto te ofrece más control sobre el aspecto de la aplicación en diversas pantallas por todo Store. (Ten en cuenta que si tu producto es compatible con versiones anteriores del sistema operativo, los clientes pueden seguirán viendo las imágenes de los paquetes, incluso si usas esta opción.) Puedes hacerlo en la sección de **logotipos de Store** del paso del proceso de envío de la **Descripción de Store** .

![Especificar los logotipos de Store durante el proceso de envío de aplicación](images/app-icons/storelogodisplay.png)

Al marcar esta casilla, aparecerá una nueva sección denominada **tienda Mostrar imágenes** . En este caso, puedes cargar 3 tamaños de imagen que la tienda usará en lugar de las imágenes de logotipos de tus paquetes de aplicaciones: 71 x 71, 150 x 150 y 300 x 300 píxeles. Solo el tamaño de 300 x 300 es obligatorio, aunque se recomienda proporcionar todos los tamaños de 3.

Para obtener más información, consulta la [pantalla solo carga las imágenes de logotipos de la tienda](/windows/uwp/publish/app-screenshots-and-images#display-only-uploaded-logo-images-in-the-store).
...
## <a name="managing-app-icons-with-the-visual-studio-manifest-designer"></a>Administrar los iconos de la aplicación con el Diseñador de manifiestos de Visual Studio
...
:::row:::
    :::column:::
        2. en el **Explorador de soluciones**, haz doble clic en el archivo package.appmanifest.
    :::column-end:::
    :::column:::
...
El primer elemento de menú en la pestaña de **Activos visuales** , **Todos los activos visuales**, es exactamente lo que sugiere su nombre: genera todos los activos visuales que necesite tu aplicación con la presión de un botón.

![Generar todos los activos visuales en Visual Studio](images/app-icons/all-visual-assets.png)

Todo lo que debes hacer es una sola imagen de suministro y Visual Studio generará el icono pequeño icono mediano, icono grande, icono ancho, icono grande, icono de la aplicación, pantalla de presentación y el paquete de activos de logotipo para cada factor de escala.

Para generar todos los activos a la vez:
1. Haga clic en el **** junto al campo de **origen** y seleccionar la imagen que quieras usar. Si estás usando una imagen de mapa de bits, asegúrate de que es al menos 400 por 400 píxeles para que obtengas resultados nítidos. Imágenes basado en vectores funcionan mejor; Visual Studio te permite usar AI (Adobe Illustrator) y archivos PDF. 
...
Ten en cuenta que Visual Studio no genera un logotipo del distintivo de manera predeterminada. Eso es porque el logotipo del distintivo es único y probablemente no debe coincidir con los iconos de la aplicación. Para obtener más información, consulta las [notificaciones para el artículo de las aplicaciones para UWP](/windows/uwp/design/shell/tiles-and-notifications/badges). 


## <a name="more-about-app-icon-assets"></a>Más información acerca de los activos de icono de aplicación
Visual Studio generará todos los activos de icono de aplicación requeridos tu proyecto, pero si lo deseas personalizarlos, ayuda a comprender cómo están diferentes de otros activos de la aplicación. 

El activo de icono de la aplicación aparece en una gran cantidad de lugares: la barra de tareas de Windows, la vista de tareas, ALT+TAB y la esquina inferior derecha de los iconos de inicio. Dado que el activo de icono de la aplicación aparece en muchos lugares, tiene alguna variación de tamaño adicional y placas opciones carecen de otros activos: activos de "tamaño de destino" y "sin placa" activos. 
...
Al usar el generador de activos para generar todos los activos que necesita, hay una razón por qué, no generará distintivo logotipos de manera predeterminada: son muy distintos de otros activos de la aplicación. El logotipo del distintivo es una imagen de estado que aparece en las notificaciones y los iconos de la aplicación. 
...
De manera predeterminada, generador de activos de Visual Studio aplica espaciado recomendada a cualquier imagen. Si tus imágenes ya contengan espaciado interno o quieres imágenes sin bordes que se extienden hasta el final de la ventana, puedes desactivar esta característica desactivando la casilla de verificación **Aplicar recomendada espaciado interno** . 
...
![Icono que muestra sin bordes](images/app-icons/tile-assets1.png)

Si no quieres que tu icono para llegar hasta el borde de la ventana, puedes usar píxeles transparentes en el activo para crear el relleno. 
