...
Este artículo describe los conceptos básicos de creación de iconos de la aplicación, cómo usar Visual Studio para administrarlas y cómo administrarlos manualmente, si es necesario.
...
Dado que los activos de icono de aplicación son mapas de bits y mapas de bits no se escalan bien, recomendamos proporcionar una versión de cada recurso de icono para cada factor de escala: 100%, 125%, 150%, 200% y 400%. Es una gran cantidad de iconos. Fortunatly, Visual Studio proporciona una herramienta que facilita el proceso generar y actualizar estos iconos. 

## <a name="microsoft-store-listing-image"></a>Imagen de la descripción de Microsoft Store

"¿Cómo especifica imágenes para la descripción de la aplicación en Microsoft Store?"
...
> Si aún no tienes Visual Studio 2017, existen varias versiones disponibles, como una versión gratuita, (Visual Studio 2017 Community Edition), y las otras versiones ofrecen evaluaciones gratuitas. Se pueden descargar aquí:[https://developer.microsoft.com/windows/downloads](https://developer.microsoft.com/windows/downloads)
...
El primer elemento de menú en la pestaña de **Activos visuales** , **Todos los activos visuales**, hace lo que sugiere su nombre: genera cada activo visual que se necesita la aplicación con la presión de un botón.
...
2. (Opcional). En la sección de **Configuración de pantalla** , configurar estas opciones:
    ...
    c. **En segundo plano de iconos**: especifica el valor hexadecimal o el nombre de un color para el color de fondo del icono. Por ejemplo, `#464646`. El valor predeterminado es `transparent`.
...
Square150x150Logo-scale-100.png, 200.png de escala de Square150x150Logo, 400.png de escala de Square150x150Logo
...
Al usar el generador de activos para generar todos los activos que necesitas, hay un motivo de por qué, no generará distintivo logotipos de manera predeterminada: son muy diferentes de otros activos de la aplicación. El logotipo del distintivo es una imagen de estado que aparece en las notificaciones y los iconos de la aplicación. 
...
De manera predeterminada, generador de activos de Visual Studio aplica recomendada de espaciado interno a cualquier imagen. Si tus imágenes ya contienen el espaciado interno o quieres que las imágenes de bordes que se extienden hasta el final de la ventana, desactivar esta característica desactivando la casilla de verificación **Aplicar recomendada espaciado interno** . 
