...
En la aplicación, usa los iconos para representar una acción, como copiar texto o navegar a la página de configuración.
    :::column-end:::
    :::column:::
