...
- Todos los estados visuales, animaciones y variaciones de opacidad sin necesidad de crear una nueva plantilla de efectos
...
Ahora, todos los recursos, los temas y colores personalizados pueden colocarse en un diccionario de recursos **MyCustomTheme** único y ámbito donde se necesita sin tener que preocuparse de desorden adicional en el marcado de diseño.
