...
ColorSchemeResources es una API que le indica al sistema qué recursos se están donde el ámbito. ColorSchemeResources debe tener un [Atributo x: Key](https://docs.microsoft.com/windows/uwp/xaml-platform/x-key-attribute), que puede ser una de las tres opciones:
- Predeterminado
...
Establecimiento del ámbito de recursos a través de la **ColorSchemeResources** API en XAML te permite realizar cualquier color del sistema o un pincel que se encuentra en nuestra biblioteca de [recursos de temas](https://docs.microsoft.com/windows/uwp/design/controls-and-patterns/xaml-theme-resources) y definirlos dentro del ámbito de una página o el contenedor.
...
Ahora, todos los recursos de temas y colores personalizados pueden colocarse en un diccionario de recursos de **MyCustomTheme** único y ámbito donde se necesita sin tener que preocuparse de desorden adicional en el marcado de diseño.
