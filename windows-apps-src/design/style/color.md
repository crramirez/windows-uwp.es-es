...
Sin embargo, dado que todos los colores de nuestro sistema demasiado en cascada hacia abajo en otros controles, establecer **SystemBaseLowColor** y **SystemBaseMediumLowColor** afectará más que simplemente botones. En este caso, los controles como **ToggleButton**, **RadioButton** y **control deslizante** también se verán afectados estos cambios de color del sistema, estos controles se deben colocar por encima del ámbito de la cuadrícula de ejemplo.
Si quieres definir el ámbito de un sistema color cambiar *a un solo los controles solo* puedes hacerlo mediante la definición **ColorSchemeResources** dentro de los recursos de ese control:
...
Ahora, todos los recursos de temas y colores personalizados pueden colocados en un diccionario de recursos de **MyCustomTheme** único y el ámbito cuando sea necesario sin tener que preocuparse desorden adicional en el marcado de diseño.
