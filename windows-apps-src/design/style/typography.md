...
<div class="uwpd-image-with-caption">
    ...
    <div>Todos los tamaños están en píxeles efectivos. Para obtener más información, consulta [Introducción al diseño de aplicaciones para UWP](../basics/design-and-ui-intro.md).</div>
</div>
...
Para crear otras jerarquías no incluidas en la rampa de tipos, establece el texto secundario en el 60% de opacidad. En la [paleta de colores de temas](color.md#themes), se usaría BaseMedium. El texto principal siempre debe tener un 100% de opacidad, o BaseHigh.
