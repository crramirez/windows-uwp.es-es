...
Por ejemplo, puedes agregar una clase [CommandBar](https://docs.microsoft.com/en-us/windows/uwp/controls-and-patterns/app-bars) en la propiedad RightHeader de Pivot.
