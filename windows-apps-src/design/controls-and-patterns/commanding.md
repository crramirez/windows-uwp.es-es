...
En este ejemplo básico, se muestra cómo se puede invocar un comando único con un botón Girar la rueda del mouse, un acelerador de teclado y haga clic en.
