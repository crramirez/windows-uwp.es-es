...
Botones de radio en la configuración del explorador.

![Botones de radio en la configuración del explorador](images/control-examples/radio-buttons-edge.png)
