...
>
> Algunas características de NavigationView, como la navegación de la _parte superior_ , requieren Windows 10, versión 1809 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)) o una versión posterior, o la [Biblioteca de la interfaz de usuario de Windows](https://docs.microsoft.com/uwp/toolkits/winui/).
...
> La propiedad PaneDisplayMode requiere Windows 10, versión 1809 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)) o una versión posterior, o la [Biblioteca de la interfaz de usuario de Windows](https://docs.microsoft.com/uwp/toolkits/winui/).
...
Se recomienda la navegación de la _parte superior_ cuando:
...
De manera predeterminada, PaneDisplayMode se establece en Auto. En modo automático, la vista de navegación se adapta entre LeftMinimal cuando la ventana es estrecha, para LeftCompact y, a continuación, quedan aumenta la ventana. Para obtener más información, consulta la sección de [comportamiento adaptable](#adaptive-behavior) .
...
Puedes colocar contenido de forma libre en pie de página del panel agregando a la propiedad de la [PaneFooter](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.navigationview.PaneFooter) .
...
:::row:::
    ...
    _El pie de página de panel izquierdo_<br>
    :::column-end:::
:::row-end:::
...
Puedes colocar contenido de forma libre en el panel mediante la adición de la propiedad [PaneCustomContent](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.navigationview.PaneCustomContent) .
...
Este ejemplo muestra cómo puedes usar NavigationView con un panel de navegación superior a tamaños de ventana grande y un panel de navegación izquierdo de tamaños de ventana pequeña. Se puedan adaptar a la navegación izquierda mediante la eliminación de la configuración de navegación de la _parte superior_ de la VisualStateManager.

El ejemplo muestra una forma recomendada para configurar los datos de navegación que funcionan para muchos escenarios comunes. También muestra cómo implementar la navegación con la navegación de teclado y el botón de retroceso de NavigationView hacia atrás.
...
Para modificar el fondo del panel, puedes invalidar los recursos de tema XAML usados para representar el fondo en cada modo. (Esta técnica se usará en lugar de una sola propiedad de PaneBackground con el fin de admitir diferentes fondos para diferentes modos de presentación).
