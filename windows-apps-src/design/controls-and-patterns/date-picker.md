...
> **API importantes**: [Clase DatePicker](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.DatePicker), [Propiedad Date](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.datepicker.date)
