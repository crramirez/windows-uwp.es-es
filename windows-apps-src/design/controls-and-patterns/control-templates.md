...
> **API importantes**: [**Clase ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate), [**Propiedad Control.Template**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.template)
...
Este código XAML muestra los objetos [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) para los estados `Checked`, `Unchecked` e `Indeterminate`. El ejemplo establece la propiedad adjunta [**VisualStateManager.VisualStateGroups**](https://docs.microsoft.com/dotnet/api/system.windows.visualstatemanager?view=netframework-4.8) en [**Border**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Border), que es el elemento raíz de [**ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate). **VisualState** `Checked` especifica que el valor de [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de la clase [**Path**](/uwp/api/Windows.UI.Xaml.Shapes.Path) con nombre `CheckGlyph` (que mostramos en el ejemplo anterior) es 1. **VisualState** `Indeterminate` especifica que el valor de **Opacity** de la clase [**Ellipse**](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse) con nombre `IndeterminateGlyph` es 1. **VisualState** `Unchecked` no tiene ninguna clase [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) o [**Storyboard**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard), por lo que [**CheckBox**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.CheckBox) vuelve a su apariencia predeterminada.
...
| De `Unchecked` a `Checked`.       | Se aplica el valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) de [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) `Checked`. Por lo tanto, el valor de [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `CheckGlyph` es 1.                                                                                                                                                         | Se muestra una X.                                |
| De `Checked` a `Indeterminate`.   | Se aplica el valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) de [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) `Indeterminate`. Por lo tanto, el valor de [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` es 1. Se quita el valor **Setter** de **VisualState** `Checked`. Por lo tanto, el valor de [**Opacity**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.opacity) de `CheckGlyph` es 0. | Se muestra un círculo.                            |
| De `Indeterminate` a `Unchecked`. | Se quita el valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) de [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) `Indeterminate`. Por lo tanto, el valor de [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` es 0.                                                                                                                                           | No se muestra nada.                             |
...
* [Ejemplo XAML Controls Gallery](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/XamlUIBasics)
