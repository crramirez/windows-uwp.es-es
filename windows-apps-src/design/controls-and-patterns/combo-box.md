...
Puedes obtener o establecer el cuadro combinado Seleccionar elemento mediante la propiedad [SelectedItem](/uwp/api/windows.ui.xaml.controls.primitives.selector.selecteditem) y obtener o establecer el índice del elemento seleccionado mediante la propiedad [SelectedIndex](/uwp/api/windows.ui.xaml.controls.primitives.selector.selectedindex) .
...
Si el valor introducido recién no es válido, que puedes usar el SelectedValue para volver a la última de la propiedad Text conoce buen valor.
