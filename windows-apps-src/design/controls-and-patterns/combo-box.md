...
Si el valor introducido recientemente no es válido, que puedes usar el valor SelectedValue para revertir la propiedad Text a la última conoce buen valor.
