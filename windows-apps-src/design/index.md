...
title: Diseño e interfaz de usuario de UWP
ms.date: 05/06/2019
ms.topic: article
...
:::row:::
    :::column:::
       ...
       Sugerencias dinámicas y API para una interfaz de usuario que tenga un aspecto excelente en cada tamaño de pantalla. 
       <br/>
    :::column-end:::
    :::column:::
