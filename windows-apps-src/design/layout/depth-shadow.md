...
## <a name="what-is-z-depth"></a>¿Qué es la profundidad z?
...
Además proporcionar significativa jerarquía visual, profundidad z también permite crear experiencias que fluyan sin problemas desde 2D a entornos 3D, escalado de la aplicación en todos los dispositivos y factores de forma. 
...
### <a name="recommendations-for-z-depth"></a>Recomendaciones de profundidad z
...
Sombra es una manera percibir la elevación. Cuando se produce la luz por encima de un objeto con privilegios elevados, hay una sombra en la siguiente superficie. Cuanto mayor sea el objeto, más grande y más suave se convierte en la sombra. Ten en cuenta que los objetos con privilegios elevados no es necesario tener sombras, pero sombras indicar la elevación.

En aplicaciones para UWP, sombras deben intencionada, no estéticos. Si las sombras reducen el foco y la productividad, a continuación, limitar el uso de instantáneas.
...
ThemeShadow automáticamente proyecta sombras cuando se aplica a cualquier elemento XAML en un [elemento emergente](/uwp/api/windows.ui.xaml.controls.primitives.popup). Transmitirá sombras sobre el contenido de la aplicación en segundo plano detrás de él y los elementos emergentes otros abiertos por debajo de él.
...
Para la mayoría de la interfaz de usuario de elemento emergente, la elevación de predeterminada recomendada en relación con el contenido de la aplicación en segundo plano es 32 píxeles efectivos.
...
![sombras de ejemplo de código](images/elevation-shadow/smartshadow-example.svg)
