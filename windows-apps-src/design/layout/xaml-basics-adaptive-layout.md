...
ms.locfileid: "1635808"
---
# <a name="tutorial-create-adaptive-layouts"></a>Tutorial: crear diseños adaptativos
...
Esto mostrará el título, tipo de archivo y dimensiones de una imagen cuando se coloque el ratón sobre la miniatura (o pulsar y mantener en una pantalla táctil).
...
Si te quedas bloqueado, puedes encontrar más información en estas secciones de [Definir diseños de página con XAML](layouts-with-xaml.md).
