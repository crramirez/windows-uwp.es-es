...
Esta información también está disponible en el [informe de adquisiciones de complemento](../publish/add-on-acquisitions-report.md#add-on-page-views-and-conversions-by-campaign-id) en el centro de partners.
...
|---------------|--------|---------------|------|
| applicationId | string | El [identificador de la Store](in-app-purchases-and-trials.md#store-ids) de la aplicación para la que quieres recuperar los datos de conversión de complementos. Un ejemplo de un id. de la Tienda sería 9WZDNCRFJ3Q8. |  Sí  |
...
| startDate | fecha | La fecha de inicio del intervalo de fechas de los datos conversión que se van a recuperar. El valor predeterminado es 1/1/2016. |  No  |
| endDate | fecha | Fecha de finalización del intervalo de fechas de los datos de conversión que se van a recuperar. El valor predeterminado es la fecha actual. |  No  |
...
| orderby | string | Instrucción que ordena los valores de datos resultantes de cada conversión. La sintaxis es <em>orderby=field [order],field [order],...</em>. El parámetro <em>field</em> puede ser una de las siguientes cadenas:<ul><li><strong>Fecha</strong></li><li><strong>ApplicationName</strong></li><li><strong>inAppProductName</strong></li><li><strong>tipo de aplicación</strong></li><li><strong>customCampaignId</strong></li><li><strong>referrerUriDomain</strong></li><li><strong>channelType</strong></li><li><strong>cliente de la tienda</strong></li><li><strong>tipo de dispositivo</strong></li><li><strong>mercado</strong></li></ul><p>El parámetro <em>order</em>, en cambio, es opcional y puede ser <strong>asc</strong> o <strong>desc</strong> para especificar el orden ascendente o descendente de cada campo. El valor predeterminado es <strong>asc</strong>.</p><p>Aquí tienes un ejemplo de una cadena <em>orderby</em>: <em>orderby=date,market</em></p> |  No  |
| groupby | string | Una instrucción que aplica la agregación de datos únicamente a los campos especificados. Puedes especificar los siguientes campos:<p/><ul><li><strong>Fecha</strong></li><li><strong>ApplicationName</strong></li><li><strong>inAppProductName</strong></li><li><strong>tipo de aplicación</strong></li><li><strong>customCampaignId</strong></li><li><strong>referrerUriDomain</strong></li><li><strong>channelType</strong></li><li><strong>cliente de la tienda</strong></li><li><strong>tipo de dispositivo</strong></li><li><strong>mercado</strong></li></ul><p>Las filas de datos que se devuelvan contendrán los campos especificados en el parámetro <em>groupby</em> y en los siguientes:</p><ul><li><strong>Fecha</strong></li><li><strong>applicationId</strong></li><li><strong>inAppProductId</strong></li><li><strong>inAppProductName</strong></li><li><strong>conversionCount</strong></li><li><strong>clickCount</strong></li></ul><p>Puedes usar el parámetro <em>groupby</em> con <em>aggregationLevel</em>. Por ejemplo: <em>groupby=ageGroup,market&amp;aggregationLevel=week</em></p> |  No  |
...
| channelType           | string |  Una de las siguientes cadenas que especifica el canal para la conversión:<ul><li><strong>customCampaignId</strong></li><li><strong>Tráfico de Store</strong></li><li><strong>Otros</strong></li></ul>    |
| storeClient         | string | Versión de la Store donde se realizó la conversión. Actualmente, el único valor admitido es **SFC**.    |
| deviceType          | string | Una de las cadenas siguientes:<ul><li><strong>PC</strong></li><li><strong>Teléfono</strong></li><li><strong>Consola de</strong></li><li><strong>IoT</strong></li><li><strong>Holográfica</strong></li><li><strong>Desconocido</strong></li></ul>            |
| market              | string | Código de país ISO 3166 del mercado donde se realizó la conversión.    |
| clickCount              | número  |     Número de clics del cliente en el vínculo descriptivo de la aplicación.      |           
| conversionCount            | número  |   Número de conversiones del cliente.         |         
