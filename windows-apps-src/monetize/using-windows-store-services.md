...
description: Microsoft Store expone varios servicios que se pueden llamar a través de las API de REST acceder mediante programación a determinados tipos de datos para las aplicaciones que están registradas en la cuenta de centro de partners de tu o tu organización.
...
ms.locfileid: "8192485"
---
# <a name="microsoft-store-services"></a>Servicios de Microsoft Store

Microsoft Store expone varios servicios que se pueden llamar a través de las API de REST acceder mediante programación a determinados tipos de datos para las aplicaciones que están registradas en la cuenta de centro de partners de tu o tu organización.
