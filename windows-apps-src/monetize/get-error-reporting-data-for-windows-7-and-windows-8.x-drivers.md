...
description: "Usa este método en la API de análisis de la Tienda Windows para obtener los datos agregados del informe de errores de controladores de Windows 7 y Windows 8.x para un intervalo de fechas y otros filtros opcionales. Este método está previsto solo para IHV."
...
Usa este método en la API de análisis de la Tienda Windows para obtener los datos agregados del informe de los errores de controladores de Windows 7 y Windows 8.x para un intervalo de fechas y otros filtros opcionales. Puedes recuperar información adicional de los errores con el método para [Obtener los detalles de un error de controlador de Windows 7 o Windows 8.x](get-details-for-a-windows-7-or-windows-8.x-driver-error.md).
