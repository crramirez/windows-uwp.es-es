...
Usa este método en la API de análisis de Microsoft Store para obtener datos de informes de error adicionales de una aplicación de escritorio que agregaste al [Programa de aplicaciones de escritorio de Windows](https://msdn.microsoft.com/library/windows/desktop/mt826504). Esta información también está disponible en el [informe Mantenimiento](https://msdn.microsoft.com/library/windows/desktop/mt826504) para aplicaciones de escritorio del panel del Centro de desarrollo de Windows.
...
| startDate | fecha | La fecha de inicio del intervalo de fechas de los datos del informe de errores que se han de recuperar con el formato ```mm/dd/yyyy```. El valor siempre es la fecha actual.  |  No  |
