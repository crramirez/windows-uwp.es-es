...
1. Asigna el evento **ErrorOccurred** del objeto **AdControl**, **InterstitialAd** o **NativeAdsManager** al nombre de un delegado de controlador de eventos.
