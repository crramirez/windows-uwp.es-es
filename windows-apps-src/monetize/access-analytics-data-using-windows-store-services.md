...
| Insights | <ul><li>[Obtener los datos de información de la aplicación](get-insights-data-for-your-app.md)</li></ul>  |
...
| Insights | <ul><li>[Obtener los datos de información de la aplicación de escritorio](get-insights-data-for-your-desktop-app.md)</li></ul>  |
