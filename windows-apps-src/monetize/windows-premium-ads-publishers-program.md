---
author: Xansky
description: El programa de editores de anuncios de premium consta de una colección de aplicaciones habilitadas para anuncios pueden destinados a redes de anuncios de partners con premium, protegida de Windows alto rendimiento anuncios. Las aplicaciones de este programa están mejores en su clase en términos de uso, la participación y la experiencia.
...
## <a name="how-does-microsoft-add-apps-to-this-program"></a>¿Cómo agregar Microsoft las aplicaciones de este programa? 

Revisamos continuamente las aplicaciones de la tienda con los [criterios de calificación](#what-are-the-criteria-for-apps-in-the-program). Las aplicaciones que cumplan los criterios de calificación se someten a un proceso de revisión manual rigurosos que busque una experiencia de usuario suave, bien definido y para asegurarse de que los anuncios se colocan bien para evitar clics no intencionados. Las aplicaciones que se desactive la automático y el proceso de filtrado de manual, a continuación, se agregan en el programa.

Actualmente es un programa solo de invitación y simplemente convocatorias de reunión los criterios de calificación no automáticamente tendrá derecho una aplicación para formar parte del programa premium.Si quieres saber más acerca de cómo mejorar la experiencia de tu aplicación para participar en el programa de, ponte en contacto con nosotros en aiacare@microsoft.com.
...
* Sigue los métodos de colocación y tamaños de anuncio estándar de Interactive Advertising Bureau (IAB). No haya anuncios ocultos.
* Limpia colocación de anuncios de banner (por ejemplo, los anuncios no son adyacentes unos a otros).
* Unidades de anuncios no se usan en múltiples aplicaciones.
...
* Presencia de la tienda Great con borrar descripciones de la aplicación, capturas de pantalla de alta fidelidad y los iconos que se cargan en la tienda. Se recomiendan encarecidamente tráileres de vídeo.
* No hay actividad fraudulenta.

## <a name="can-apps-get-removed-from-the-program"></a>¿Las aplicaciones pueden obtener quitan desde el programa?

Las aplicaciones en el programa se supervisan con regularidad para garantizar que continúa a cumplir con los criterios de calificación. Para mantener un volumen diario mínimo de solicitud de anuncio, asegúrate de que el uso de la aplicación no colocar significativamente con el tiempo. Una excelente manera de hacerlo es mediante la [ejecución de campañas de promoción normal](https://developer.microsoft.com/en-us/store/promote-your-apps).
...
Cualquier contenido cargado como parte del envío de tienda automáticamente se usa para mostrar aplicaciones premium. Además, si quieres usar más aplicación o capturas de pantalla de juego, tráileres de juegos y descripciones enriquecidas, ponte en contacto con nosotros en aiacare@microsoft.com.
