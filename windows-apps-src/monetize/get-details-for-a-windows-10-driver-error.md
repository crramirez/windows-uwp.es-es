...
description: Usa este método en la API de análisis de Microsoft Store para obtener información detallada sobre un error de controlador de Windows 10. Este método está previsto solo para IHV.
