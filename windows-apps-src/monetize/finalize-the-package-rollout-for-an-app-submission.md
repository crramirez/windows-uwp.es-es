---
description: Use este método en la API de envío de Microsoft Store para finalizar el lanzamiento de paquetes para un envío de aplicación.
title: Finalizar el lanzamiento del envío de una aplicación
ms.date: 04/17/2018
ms.topic: article
keywords: Windows 10, UWP, API de envío de Microsoft Store, implementación de paquetes, envío de aplicaciones, finalizar
...
ms.locfileid: "89171519"
---
# <a name="finalize-the-rollout-for-an-app-submission"></a>Finalizar el lanzamiento del envío de una aplicación
...
* Cree un envío para una aplicación en su cuenta del centro de Partners. Puede hacerlo en el centro de Partners o puede hacerlo mediante el método [crear un envío de aplicación](create-an-app-submission.md) .
...
|---------------|--------|-----------------------------------------------------------------------------|
| applicationId | string | Necesario. El Id. de la Tienda de la aplicación que contiene el envío con el lanzamiento de paquetes que quieres finalizar. Para obtener más información sobre el identificador de la Tienda, consulta [Ver detalles de identidad de las aplicaciones](../publish/view-app-identity-details.md).  |
