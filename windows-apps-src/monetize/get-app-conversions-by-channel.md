...
|---------------|--------|---------------|------|
| applicationId | string | El [Id. de la Store](in-app-purchases-and-trials.md#store-ids) de la aplicación para la que quieres recuperar datos de conversión. Un ejemplo de id. de la Store sería 9WZDNCRFJ3Q8. |  Sí  |
