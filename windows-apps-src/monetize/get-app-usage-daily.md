...
| dailyActiveUsers          | long    | El número de clientes que usan la aplicación ese día.                           |
| dailyActiveDevices        | long    | El número de dispositivos diarios usados para interactuar con la aplicación por todos los usuarios.  |
| dailyNewUsers             | long    | El número de clientes que usaron la aplicación por primera vez ese día.    |
