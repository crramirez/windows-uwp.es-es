...
description: Usa este método en la API de análisis de Microsoft Store para obtener datos de uso diario de un intervalo de fechas dado y según otros filtros opcionales.
title: Obtener uso diario de la aplicación
ms.author: mhopkins
ms.date: 08/15/2018
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3849519"
---
# <a name="get-daily-app-usage"></a>Obtener uso diario de la aplicación
...
El siguiente ejemplo muestra una solicitud para obtener datos de uso diario de aplicación. Reemplaza el valor *applicationId* por el Id. de la Store de la aplicación.
...
|------------|--------|-------------------------------------------------------------------------------------------------------------------------------------|
| Valor      | matriz  | Una matriz de objetos que contienen datos de uso agregados. Para más información sobre los datos de cada objeto, consulta la tabla siguiente. |
