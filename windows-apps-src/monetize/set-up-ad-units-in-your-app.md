...
description: Obtenga información sobre cómo agregar valores de Id. de unidad de ad y de Id. de aplicación desde el centro de partners a la aplicación antes de enviar su aplicación en el Store.
...
Cuando termine de probar la aplicación para UWP y ya está listo para enviarlo al centro de partners, debe [crear una unidad de anuncios en directo](#live-ad-units) desde el [anuncios en la aplicación](../publish/in-app-ads.md) página en el centro de partners y actualizar el código de aplicación para usar la aplicación Valores ID y ad unidad Id. de esta unidad de ad.
...
Para obtener una unidad de anuncios en directo desde el centro de partners y usarlo en su aplicación:

1.  [Crear una unidad de anuncio](../publish/in-app-ads.md#create-ad-unit) en el **anuncios en la aplicación** página en el centro de partners. Asegúrate de especificar el tipo correcto de la unidad de anuncio para el control de anuncios que usas en tu aplicación.
    > [!NOTE]
...
2.  Después de crear la nueva unidad de ad, recuperar el **Id. de aplicación** y **Ad Id. de unidad** para la unidad de ad en la tabla de las unidades de anuncios disponibles en el **Monetize** &gt;  **En la aplicación anuncios** página.
    > [!NOTE]
