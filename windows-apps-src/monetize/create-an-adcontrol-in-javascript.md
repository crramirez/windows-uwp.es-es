...
> [!NOTE]
> Los valores de *applicationId* y *adUnitId* que se muestran en este ejemplo son [valores de modo de prueba](test-mode-values.md). Debes [reemplazar estos valores por valores dinámicos](set-up-ad-units-in-your-app.md) en el Centro de desarrollo de Windows antes de enviar tu aplicación.
