---
description: Use este método en la API de envío de Microsoft Store para detener un lanzamiento de paquetes para un paquete piloto.
title: Detener la implementación de un vuelo
ms.date: 04/17/2018
ms.topic: article
keywords: Windows 10, UWP, API de envío de Microsoft Store, implementación de paquetes, envío de vuelos, detención
...
ms.locfileid: "89158519"
---
# <a name="halt-the-rollout-for-a-flight"></a>Detener la implementación de un vuelo

Use este método en la API de envío de Microsoft Store para [detener la implementación](../publish/gradual-package-rollout.md#completing-the-rollout) de un envío de paquetes piloto. Para obtener más información sobre el proceso de creación de un envío de paquetes piloto mediante el Microsoft Store API de envío, vea Administrar envíos de [paquetes de paquetes](manage-flight-submissions.md).

> [!NOTE]
> Si detiene el lanzamiento para un envío de paquetes piloto y luego [crea un nuevo envío de paquetes piloto](create-a-flight-submission.md), el nuevo envío es un clon del envío detenido.
