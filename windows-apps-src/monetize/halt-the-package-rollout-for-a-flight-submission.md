...
# Detener el lanzamiento de un paquete piloto con la API de envío de la Tienda Windows
...
En el siguiente ejemplo se muestra el cuerpo de la respuesta JSON a una llamada satisfactoria a este método. Para obtener más información acerca de los valores que se encuentran en el cuerpo de respuesta, consulta el [recurso de lanzamiento de paquete](manage-flight-submissions.md#package-rollout-object).
