...
| fileName | string | Nombre del ejecutable bloqueado |
...
* [Get upgrade blocks for your desktop application](get-desktop-block-data.md) (Obtener bloques de actualización para la aplicación de escritorio)