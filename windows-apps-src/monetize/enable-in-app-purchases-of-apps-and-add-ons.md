...
* Si desea habilitar la adquisición de la aplicación para un complemento de la aplicación, también debe [crear el complemento en el centro de partners](../publish/add-on-submissions.md).
...
En este ejemplo se muestra cómo usar el método [RequestPurchaseAsync](https://docs.microsoft.com/uwp/api/windows.services.store.storecontext.requestpurchaseasync) de la clase [StoreContext](https://docs.microsoft.com/uwp/api/windows.services.store.storecontext) para comprar una aplicación o complemento con un [Id. de la Tienda](in-app-purchases-and-trials.md#store-ids) conocido. Para obtener una aplicación de ejemplo completa, consulta la [muestra de la Tienda](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/Store).
