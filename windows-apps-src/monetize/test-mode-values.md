...
description: "Usa los valores del identificador de aplicación y del identificador de la unidad de anuncios de prueba de este artículo para ver cómo la aplicación representa los anuncios durante las pruebas."
