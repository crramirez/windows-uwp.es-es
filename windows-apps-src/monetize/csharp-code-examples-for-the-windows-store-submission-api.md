...
ms.locfileid: "57627520"
---
# <a name="c-sample-submissions-for-apps-add-ons-and-flights"></a>C\# ejemplo: envíos de aplicaciones, complementos y vuelos
...
* [Actualizar un complemento de envío](#update-add-on-submission)
...
4. A continuación, lo [confirma el nuevo envío al centro de partners](commit-an-add-on-submission.md).
