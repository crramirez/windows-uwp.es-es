...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API de envío de la Tienda Windows, Windows Store submission API, envío de complemento, add-on submission, producto desde la aplicación, in-app product, IAP"
...
# <a name="get-an-add-on-submission-using-the-windows-store-submission-api"></a>Obtener un envío de complemento con el uso de la API de envío de la Tienda Windows
