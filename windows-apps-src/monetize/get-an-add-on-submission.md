...
|---------------|--------|-----------------------------------------------------------------------------|
| inAppProductId | cadena | Obligatorio. El Id. de la Store del complemento que contiene el envío que quieres obtener. El Id. de la Store está disponible en el panel del Centro de desarrollo y se incluye en los datos de respuesta de las solicitudes para [crear complementos](create-an-add-on.md) u [obtener detalles de complementos](get-all-add-ons.md).  |
...
| 409  | El envío no pertenece al complemento especificado o el complemento usa una característica de panel del Centro de desarrollo que [la API de envío de Microsoft Store no admite actualmente](create-and-manage-submissions-using-windows-store-services.md#not_supported). |   
