...
1. Si la aplicación ofrece complementos que los clientes pueden adquirir, [crear presentaciones de complemento para la aplicación en el centro de partners ](https://msdn.microsoft.com/windows/uwp/publish/add-on-submissions).
...
2. Después, asegúrate de haber seguido estos pasos:
    ...
    * Si la aplicación ofrece un complemento que los clientes pueden adquirir, [crear un envío de complemento para la aplicación en el centro de partners](https://msdn.microsoft.com/windows/uwp/publish/add-on-submissions).
