...
| [Rentabilizar la aplicación y atraer clientes con el SDK de Microsoft Store Engagement and Monetization.](monetize-your-app-with-the-microsoft-store-engagement-and-monetization-sdk.md)      | El SDK de Microsoft Store Engagement and Monetization proporciona bibliotecas y herramientas que puedes usar para agregar características a las aplicaciones (por ejemplo, mostrar anuncios en tus aplicaciones o ejecutar experimentos con un pruebas A/B) que te ayudarán a realizar más dinero y conseguir clientes.   |
