...
description: Utilice este método en la API de envío de Microsoft Store para recuperar información sobre la adquisición de la aplicación para una aplicación que está registrado en el centro de partners.
...
Use este método en la API de envío de Microsoft Store para enumerar los complementos para una aplicación que está registrado en la cuenta del centro de partners.
...
|------|------|------|------|
|  applicationId  |  string  |  El identificador de la Tienda de la aplicación para la que quieres recuperar los complementos. Para obtener más información sobre el identificador de la Tienda, consulta [Ver detalles de identidad de las aplicaciones](https://msdn.microsoft.com/windows/uwp/publish/view-app-identity-details).  |  Sí  |
...
| 409  | Los complementos que usan características centro de partners [no compatible actualmente con la API de envío de Microsoft Store](create-and-manage-submissions-using-windows-store-services.md#not_supported).  |
