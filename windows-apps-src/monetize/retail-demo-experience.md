...
* **No solicites información de identificación personal (PII)**. Esto incluye información de inicio de sesión, la información de cuenta de Microsoft o de contacto detalles.
...
Paso 2: Implementar la lógica de limpieza personalizada en la función case _AppdataCleanup_ utilizando la plantilla de ejemplo siguiente.
``` CSharp
using System;
using System.IO;
