...
Una aplicación de experiencia de demostración comercial viene en una única compilación que puede iniciarse en uno de dos modos diferentes: _normal_ o _comercial_. Desde la perspectiva de nuestros clientes, hay una sola aplicación y para ayudarlos a distinguir entre las dos versiones, se recomienda que la aplicación que se ejecuta en el modo comercial muestre la palabra "Comercial" en un lugar destacado en la barra de título o en una ubicación adecuada.
