...
Además de los requisitos de Microsoft Store para las aplicaciones, las aplicaciones con reconocimiento RDX también deben ser compatibles con el programa de instalación RDX, limpieza y los procesos de actualización para garantizar que los clientes tengan una experiencia positiva coherente en la tienda.
...
* **Experiencia de contenido actualizado**. La aplicación nunca se puede solicitar actualizaciones cuando esté conectado. Si se necesitan actualizaciones, se deben realizar de forma silenciosa.
...
* **Cumplir los requisitos de tamaño de aplicación de la tienda comercial**. El tamaño de la aplicación debe ser inferior a 800MB. Ponte en contacto con el equipo de la tienda Windows directamente para obtener más información si tu aplicación compatible con RDX no cumple los requisitos de tamaño.
...
Los escenarios donde se necesita una lógica de limpieza personalizada incluyen la ejecución de una configuración amplia, descarga y almacenamiento en caché de datos o no se *LocalState* datos se eliminarán.
