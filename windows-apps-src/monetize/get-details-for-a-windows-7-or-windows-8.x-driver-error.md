...
description: Usa este método en la API de análisis de Microsoft Store para obtener información detallada para un error de controlador de Windows 7 o Windows 8.x. Este método está previsto solo para IHV.
