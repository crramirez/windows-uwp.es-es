...
# Código de ejemplo de anuncios intersticiales en JavaScript




En este tema se muestra cómo iniciar un anuncio intersticial con JavaScript/HTML. Para obtener instrucciones paso a paso que ilustran cómo configurar el proyecto para usar este código, consulta [Anuncios intersticiales](interstitial-ads.md). Para obtener un proyecto de ejemplo completo que demuestra cómo agregar anuncios intersticiales en vídeo a una aplicación de JavaScript/HTML, consulta las [muestras de publicidad en GitHub](http://aka.ms/githubads).

## Ejemplo de código


En este ejemplo de JavaScript/HTML se muestra el código en una aplicación para la Plataforma universal de Windows (UWP) que implementa un anuncio intersticial. En este ejemplo, crea un nuevo proyecto de Visual Studio de 2015 mediante la plantilla de aplicación vacía universal de Windows para JavaScript.

Este código usa un botón para desencadenar un evento que inicia el anuncio intersticial. Los archivos default.js y default.html generados por Visual Studio se han modificado y se muestran a continuación. El archivo script.js, que se muestra a continuación, se agrega al proyecto en la carpeta/ruta de acceso **js**.

Reemplaza el texto en las asignaciones **applicationId** y **adUnitId** con valores que funcionen.
