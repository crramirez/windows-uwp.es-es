...
|------------|--------|---------------|
| Valor      | array  | Una matriz de objetos que contiene datos agregados de rendimiento de una campaña de anuncios. Para obtener más información sobre los datos de cada objeto, consulta la sección siguiente [Objeto de rendimiento de campañas](#campaign-performance-object).          |
...
| activeUsers            | largo | El número de usuarios que han hecho clic en un anuncio que forma parte de la campaña y han vuelto a la aplicación.      |
