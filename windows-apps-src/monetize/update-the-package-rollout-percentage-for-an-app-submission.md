---
description: Use este método en la API de envío de Microsoft Store para actualizar el porcentaje de lanzamiento del paquete para un envío de aplicación.
title: Actualizar el porcentaje de lanzamiento del envío de una aplicación
ms.date: 04/17/2018
ms.topic: article
keywords: Windows 10, UWP, API de envío de Microsoft Store, lanzamiento de paquetes, envío de aplicaciones, actualización, porcentaje
...
ms.locfileid: "89158299"
---
# <a name="update-the-rollout-percentage-for-an-app-submission"></a>Actualizar el porcentaje de lanzamiento del envío de una aplicación
...
* Habilita un lanzamiento de paquete gradual para el envío. Puede hacerlo en el [centro de Partners](../publish/gradual-package-rollout.md), o bien puede hacerlo mediante [el Microsoft Store API de envío](manage-app-submissions.md#manage-gradual-package-rollout).
