...
description: Usa estos métodos en la API de envío de Microsoft Store para administrar paquetes piloto para las aplicaciones que están registradas en tu cuenta del centro de partners.
