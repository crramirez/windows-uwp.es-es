...
| inAppProductId | cadena | El Id. de la Tienda del complemento para el que quieres recuperar los datos de compra. El Id. de la Tienda está disponible en la dirección URL de la página de introducción del complemento del panel del Centro de desarrollo de Windows. Por ejemplo, si la dirección URL de la página del panel de un complemento es ```https://developer.microsoft.com/en-us/dashboard/iaps/9NBLGGH4SCZS?appId=9NBLGGH29DM8```, el Id. de la Tienda del complemento es la cadena 9NBLGGH4SCZS. | Sí  |
