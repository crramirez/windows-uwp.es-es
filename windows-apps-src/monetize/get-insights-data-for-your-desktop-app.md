...
title: Obtener los datos de información de la aplicación de escritorio
ms.author: mcleans
ms.date: 07/31/2018
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3963875"
---
# <a name="get-insights-data-for-your-desktop-application"></a>Obtener los datos de información de la aplicación de escritorio
...
| Valor               | Tipo   | Descripción                           |
|---------------------|--------|-------------------------------------------|
| FactName           | cadena | Una cadena que indica la métrica que describe la información actual o dimensión actual. Actualmente, este método solo admite el valor de **recuento de visitas**.  |
