...
Este evento se genera cuando **AdScheduler** encuentra un error. Para obtener más información acerca de los valores de los códigos de error, consulta [ErrorCode](https://msdn.microsoft.com/library/windows/apps/microsoft.advertising.errorcode.aspx).
