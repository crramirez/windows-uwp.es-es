...
|--------|---------------------------------------------------------------|
| EXPONER   | ```https://collections.mp.microsoft.com/v6.0/collections/consume``` |
