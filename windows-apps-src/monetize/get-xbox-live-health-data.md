...
|---------------|--------|---------------|------|
| applicationId | string | El [Id. de Store](in-app-purchases-and-trials.md#store-ids) del juego para la que quieres recuperar los datos de estado de Xbox Live.  |  Sí  |
| metricType | string | Una cadena que especifica el tipo de datos de análisis de Xbox Live que recuperar. En este método, especifica el valor **callingpattern**.  |  Sí  |
| startDate | date | La fecha de inicio del intervalo de fechas de los datos de estado que se han de recuperar. El valor predeterminado es 30 días antes de la fecha actual. |  No  |
| endDate | date | Fecha de finalización del intervalo de fechas de los datos de estado que se han de recuperar. El valor predeterminado es la fecha actual. |  No  |
...
|------------|--------|-------------------------------------------------------|
| Valor      | array  | Matriz de objetos que contienen los datos de estado. Para más información sobre los datos de cada objeto, consulta la tabla siguiente.                                                                                                                      |
...
| date                | string | La primera fecha del intervalo de fechas de los datos de estado. Si la solicitud especifica un solo día, este valor será esa fecha. Si, por el contrario, la solicitud especifica una semana, un mes u otro intervalo de fechas, este valor será la primera fecha de ese intervalo de fechas. |
