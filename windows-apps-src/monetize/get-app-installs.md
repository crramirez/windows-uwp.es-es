...
description: "Usa este método en la API de análisis de la Tienda Windows para obtener los datos de instalación agregados de una aplicación durante un intervalo de fechas especificado y según otros filtros opcionales."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, Windows 10, uwp, UWP, Store services, servicios de la Tienda, Windows Store analytics API, API de análisis de la Tienda Windows, app installs, instalaciones de la aplicación"
...
| applicationId       | cadena | El id. de la Tienda de la aplicación para la que estás recuperando los datos de instalación.     |
