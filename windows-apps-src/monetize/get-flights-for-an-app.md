...
description: Utilice este método en la API de envío de Microsoft Store para recuperar información de vuelo de paquete para una aplicación que está registrada en la cuenta del centro de partners.
