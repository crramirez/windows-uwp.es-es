...
El siguiente ejemplo muestra una solicitud para obtener datos de uso de aplicación mensual. Reemplaza el valor *applicationId* por el Id. de la Store de la aplicación.
