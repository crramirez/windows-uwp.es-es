...
description: "Aprende a usar el espacio de nombres Windows.Services.Store para obtener información sobre licencias de la aplicación actual y sus complementos."
