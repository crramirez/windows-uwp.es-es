...
* [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getclickablepointcore): devuelve una estructura [**Point**](https://msdn.microsoft.com/library/windows/apps/BR225870) basada en las características de diseño conocidas, siempre que exista un **BoundingRectangle** no nulo.
* [
              **GetNameCore**
...
* [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.iskeyboardfocusablecore): devuelve **true** si el propietario es un [**Control**](https://msdn.microsoft.com/library/windows/apps/BR209390); de lo contrario, devuelve **false**.
* [
              **IsOffscreenCore**
...
* [
              **SetFocusCore**
            ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.setfocuscore): llama a [**Focus**](https://msdn.microsoft.com/library/windows/apps/hh702161).
* [
              **GetParent**
