...
<span id="Accessibility_and_your_app"></span><span id="accessibility_and_your_app"></span><span id="ACCESSIBILITY_AND_YOUR_APP"></span>Accesibilidad y la aplicación
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="UI_Automation"></span><span id="ui_automation"></span><span id="UI_AUTOMATION"></span>Automatización de la interfaz de usuario
-------------------------------------------------------------------------------------------------------------
...
<span id="Assistive_technology"></span><span id="assistive_technology"></span><span id="ASSISTIVE_TECHNOLOGY"></span>Tecnología de asistencia
-----------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Screen_reader_support_and_basic_accessibility_information"></span><span id="screen_reader_support_and_basic_accessibility_information"></span><span id="SCREEN_READER_SUPPORT_AND_BASIC_ACCESSIBILITY_INFORMATION"></span>Información de accesibilidad básica y compatibilidad con lectores de pantalla
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Keyboard_support"></span><span id="keyboard_support"></span><span id="KEYBOARD_SUPPORT"></span>Compatibilidad con teclado
-------------------------------------------------------------------------------------------------------------------------
...
<span id="Media_and_captioning"></span><span id="media_and_captioning"></span><span id="MEDIA_AND_CAPTIONING"></span>Medios y subtítulos
-----------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_text"></span><span id="accessible_text"></span><span id="ACCESSIBLE_TEXT"></span>Texto accesible
---------------------------------------------------------------------------------------------------------------------
...
-   Muchos usuarios tienen dificultades en leer texto que es demasiado pequeño. En primer lugar, puedes evitar este problema si creas un tamaño de texto lo suficientemente grande para la interfaz de usuario de la aplicación. Pero eso resulta complicado en las aplicaciones que muestran grandes cantidades de texto o texto intercalado con otros elementos visuales. En estos casos, asegúrate de que la aplicación interactúe correctamente con las funciones del sistema que pueden aumentar el tamaño de la pantalla para que el texto de las aplicaciones aumente de tamaño con estas. (Algunos usuarios cambian los valores de ppp como opción de accesibilidad. Esta opción está disponible en **Aumentar el tamaño de los objetos en pantalla** de **Accesibilidad**, que redirige una interfaz de usuario de **Panel de control** para la **Apariencia y personalización** / **Pantalla**).

<span id="Supporting_high-contrast_themes"></span><span id="supporting_high-contrast_themes"></span><span id="SUPPORTING_HIGH-CONTRAST_THEMES"></span>Compatibilidad con temas de contraste alto
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Design_for_alternative_UI"></span><span id="design_for_alternative_ui"></span><span id="DESIGN_FOR_ALTERNATIVE_UI"></span>Diseño para interfaces de usuario alternativas
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Verification_and_publishing"></span><span id="verification_and_publishing"></span><span id="VERIFICATION_AND_PUBLISHING"></span>Comprobación y publicación
---------------------------------------------------------------------------------------------------------------------------------------------------------------------

Para obtener más información sobre las declaraciones de accesibilidad y la publicación de tu aplicación, consulta [Accesibilidad en la Tienda](accessibility-in-the-store.md).

**Nota**: Declarar la aplicación como accesible solo es relevante para la Tienda Windows.

<span id="Assistive_technology_support_in_custom_controls"></span><span id="assistive_technology_support_in_custom_controls"></span><span id="ASSISTIVE_TECHNOLOGY_SUPPORT_IN_CUSTOM_CONTROLS"></span>Compatibilidad con tecnologías de asistencia en controles personalizados
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Assistive_technology_support_in_apps_that_support_XAML___Microsoft_DirectX_interop"></span><span id="assistive_technology_support_in_apps_that_support_xaml___microsoft_directx_interop"></span><span id="ASSISTIVE_TECHNOLOGY_SUPPORT_IN_APPS_THAT_SUPPORT_XAML___MICROSOFT_DIRECTX_INTEROP"></span>Compatibilidad con tecnología de asistencia en aplicaciones que admiten la interoperabilidad de XAML o Microsoft DirectX
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
