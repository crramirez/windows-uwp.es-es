...
-   INF en un formato de intervalo inferior se convertirá en la representación de INF del formato de intervalo superior, si está disponible en el formato de intervalo superior. Si el formato más alto no tiene una representación de INF, se convertirá en el valor máximo que se puede representar (MAX\_FLOAT en ese formato). El signo se conservará si está disponible en el formato de destino.
