...
Las reglas de representación de líneas sin suavizado de contorno son exactamente las mismas que para las [líneas GDI](https://docs.microsoft.com/windows/desktop/gdi/lines).
