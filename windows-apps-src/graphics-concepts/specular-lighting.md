...
## <a name="span-idspecularlightingequationspanspan-idspecularlightingequationspanspan-idspecularlightingequationspanspecular-lighting-equation"></a><span id="Specular_Lighting_Equation"></span><span id="specular_lighting_equation"></span><span id="SPECULAR_LIGHTING_EQUATION"></span>Ecuación de iluminación especular
...
|                                                                             |
|-----------------------------------------------------------------------------|
| Iluminación especular = Cₛ \* suma\[Lₛ \* (N ¿ (H)<sup>P</sup> \* Atten \* terreno\] |
...
| sum          | N/D           | N/D                                                              | La suma del componente especular de cada luz.                                                          |
| N            | N/D           | Vector 3D (valores de punto flotante x, y, z)                    | Vértice normal.                                                                                         |
| H            | N/D           | Vector 3D (valores de punto flotante x, y, z)                    | Vector medio. Consulta la sección sobre el vector medio.                                                |
...
| Atten        | N/D           | Punto flotante                                                   | El valor de atenuación de la luz. Consulta [Atenuación y factor de foco de luz](attenuation-and-spotlight-factor.md). |
| Spot         | N/D           | Punto flotante                                                   | Factor de foco de luz Consulta [Atenuación y factor de foco de luz](attenuation-and-spotlight-factor.md).        |
...
**Tenga en cuenta**    si se utilizan cualquiera de las opciones de origen de material de reflexión especular y no se proporciona el color de vértice, entonces se usa el color del material de reflexión especular.
...
## <a name="span-idthehalfwayvectorspanspan-idthehalfwayvectorspanspan-idthehalfwayvectorspanthe-halfway-vector"></a><span id="The_Halfway_Vector"></span><span id="the_halfway_vector"></span><span id="THE_HALFWAY_VECTOR"></span>El Vector a medio camino
...
| Parámetro       | Valor predeterminado | Tipo                                          | Descripción                                                  |
|-----------------|---------------|-----------------------------------------------|--------------------------------------------------------------|
| Cₚ              | N/D           | Vector 3D (valores de punto flotante x, y, z) | La posición de la cámara.                                             |
| Vₚ              | N/D           | Vector 3D (valores de punto flotante x, y, z) | La posición del vértice.                                             |
| L<sub>dir</sub> | N/D           | Vector 3D (valores de punto flotante x, y, z) | El vector de dirección de la posición del vértice respecto a la posición de la luz. |
