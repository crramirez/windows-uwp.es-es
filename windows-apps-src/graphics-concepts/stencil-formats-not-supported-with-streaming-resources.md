...
Los formatos que contienen la Galería de símbolos incluyen DXGI\_formato\_D24\_UNORM\_S8\_UINT (y relacionados con los formatos de la familia R24G8) y DXGI\_formato\_D32\_FLOAT\_S8X24\_UINT (y relacionados con los formatos de la familia R32G8X24).
...
[Streaming de recursos entre procesos y el uso compartido del dispositivo](streaming-resource-cross-process-and-device-sharing.md)
