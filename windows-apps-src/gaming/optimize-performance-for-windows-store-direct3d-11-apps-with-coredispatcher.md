...
## Escenario 1: Representar a petición
...
## Escenario 2: Representar a petición con animaciones transitorias
...
## Otras formas de reducir la latencia de entrada


### Usar cadenas de intercambio que pueden esperar
...
En Windows 8.1, DXGI incorporó la marca **DXGI\_SWAP\_CHAIN\_FLAG\_FRAME\_LATENCY\_WAITABLE\_OBJECT** de la cadena de intercambio, que permite que las aplicaciones puedan reducir fácilmente la latencia sin tener que implementar ninguna heurística con la que mantener la cola de eventos presentes vacía. Las cadenas de intercambio creadas con esta etiqueta se conocen como cadenas de intercambio que pueden esperar. En la figura 2 se muestran el ciclo de vida y respuesta aproximados a un evento de entrada cuando se usan cadenas de intercambio que pueden esperar:
