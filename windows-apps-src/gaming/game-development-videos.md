...
* [Que enfoque de Lean del esponjosas al escenario hada al desarrollo de juegos: cómo un independientes studio aumentó una disminución del juego después de solo 8 semanas](https://channel9.msdn.com/Shows/Level-Up/Fluffy-Fairys-Lean-Approach-to-Game-Development-How-an-Indie-Studio-Grew-a-Hit-Game-After-Only-8-W) - Oliver Löffler desde hada esponjosas al escenario
...
* [El programa de instalación el CD de CI la canalización de Node.js, Python,. NET, ir, Ruby o Java - en minutos](https://channel9.msdn.com/Shows/Level-Up/Setup-your-CICD-pipeline-for-Nodejs-Python-NET-Go-Ruby-or-Java-in-Minutes) , Wang de etiqueta
...
* [El CVAA y lo que significa que para el acceso de juegos](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-The-CVAA-and-What-it-Means-for-Gaming-Access) -Karen Petlz Strauss desde la Comisión Federal de comunicaciones
...
* Protector de accesibilidad de [Reproducción de vídeo de juegos estándar sin vista](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-Playing-Mainstream-Video-Games-Without-Sight) - SightlessKombat,
...
* [Todos los jugadores de personas con quieres hacer es tienen algunos divertida](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-All-Deaf-Gamers-Wanna-Do-is-Have-Some-Fun) - altavoces de Panel: Chris Robinson y Kristen Piersa, sirve de accesibilidad. Michael Anthony de Microsoft
...
* [Representación holográfica de Windows: un SDK para Target VR y AREcosystems](https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-008) -Alex Pfaffe, Alex Turner
