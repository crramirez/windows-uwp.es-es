...
-   Los archivos de activos se almacenan en carpetas con nombres arbitrarios, pero los nombres de los archivos en sí tienen una etiqueta común que se anexa a las cadenas que el sistema reserva para indicar el idioma u otro calificador. En concreto, las cadenas de calificador se colocan en el nombre de archivo generalizado después de un carácter de subrayado ("\_"). Por ejemplo, \\menú de\\de recursos\_Opción1\_lang-en-US. png, \\menú\\de recursos\_Opción1\_Scale-140. png, \\activos\\coolsign\_dxfl-DX11. DDS. También puedes combinar estas cadenas. Por ejemplo, \\menú de\\de activos\_Opción1\_Scale-140\_lang-en-US. png.
...
Puedes combinar los nombres de directorio de una especificidad adicional en el empaquetado de recursos. No obstante, no pueden ser redundantes. Por ejemplo, \\menú en-US\\\_Opción1\_lang-en-US. png es redundante.

Puedes especificar cualquier nombre de subdirectorio no reservado que necesites debajo de un directorio de recursos, siempre y cuando la estructura del directorio sea idéntica en cada directorio de recursos. Por ejemplo, \\los activos de\\dxfl-contenido DX10\\las texturas\\coolsign. DDS. Cuando se carga un activo o se hace referencia a él, el nombre de ruta de acceso debe ser generalizado; esto es, se debe quitar cualquier calificador de idioma, escala o nivel de características de DirectX, independientemente de si están en nodos de carpeta o en los nombres de archivo. Por ejemplo, para hacer referencia en el código a un recurso para el que una de las variantes es \\los activos de\\de dxfl-contenido DX10\\texturas\\coolsign. DDS, use \\activos\\texturas\\coolsign. DDS. Del mismo modo, para hacer referencia a un recurso con una variante \\imágenes\\Background\_Scale-140. png, use \\imágenes\\background. png.
...
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| Activos localizados             | Todos los idiomas posibles, o combinaciones de idioma y configuración regional, para Windows 10. (El prefijo de calificador "lang-" no es necesario en un nombre de carpeta). | "\_" seguido del especificador de idioma, configuración regional o idioma-configuración regional. Por ejemplo, "\_en", "\_EE. UU." o "\_en-US", respectivamente. |
...
-   Asegúrate de que cada archivo de recursos de cadena o activo (.resw) tenga el mismo nombre en cada directorio. Por ejemplo, el menú\_Opción1. png debe tener el mismo nombre en los directorios \\en-US y \\JP-JP aunque el contenido del archivo sea para un idioma diferente. En este caso, los vería como \\menú en-US\\\_Opción1. png y \\JP-JP\\menú\_Opción1. png.
    > **Tenga en cuenta**   puede anexar opcionalmente la configuración regional al nombre de archivo y almacenarla en el mismo directorio. por ejemplo, \\menú de\\de activos\_Opción1\_lang-en-US. png, \\menú\\activos\_Opción1\_lang-JP-JP. png.
...
-   Asegúrate de que cada activo tenga el mismo nombre en cada directorio. Por ejemplo, el menú\_Opción1. png debe tener el mismo nombre en los directorios \\Scale-100 y \\Scale-180 incluso si el contenido del archivo es diferente. En este caso, los vería como \\menú de\\Scale-100\_Opción1. png y \\el menú Scale-140\\\_Opción1. png.
    > **Tenga en cuenta**   de nuevo. opcionalmente, puede anexar el sufijo de factor de escala al nombre de archivo y almacenarlo en el mismo directorio. por ejemplo, \\menú de\\de activos\_Opción1\_Scale-100. png, \\menú\\activos\_Opción1\_Scale-140. png.
...
-   Asegúrate de que cada activo (si está disponible para varios niveles de características) tenga el mismo nombre en cada directorio. Por ejemplo, coolsign. DDS debe tener el mismo nombre en los directorios \\dxfl-DX9 y \\dxfl-DX11, incluso si el contenido del archivo es diferente. En este caso, los vería como \\dxfl-DX9\\coolsign. DDS y \\dxfl-DX11\\coolsign. DDS.
    > **Tenga en cuenta**   de nuevo, si lo desea, puede anexar el sufijo de nivel de característica al nombre de archivo y almacenarlo en el mismo directorio. por ejemplo, \\texturas\\coolsign\_dxfl-DX9. DDS, \\texturas\\coolsign\_dxfl-DX11. DDS.
