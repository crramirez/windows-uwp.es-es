...
Debe crearse el recurso subyacente con propiedades que son compatibles con el tipo de vistas que se crearán a partir de él. Por ejemplo, si un [ **ID3D11RenderTargetView** ](https://msdn.microsoft.com/library/windows/desktop/ff476582) se aplica a una superficie, que se muestran se crea con el [ **D3D11\_enlazar\_representación\_ DESTINO** ](https://msdn.microsoft.com/library/windows/desktop/ff476085) marca. La superficie también debe tener un formato de superficie DXGI compatible con la representación (consulte [ **DXGI\_formato**](https://msdn.microsoft.com/library/windows/desktop/bb173059)).
