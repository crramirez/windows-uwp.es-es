...
* [Lista de tiendas](https://docs.microsoft.com/windows/uwp/publish/create-add-on-store-listings)

Si el juego tiene muchos complementos, puede crearlos mediante programación con la __API de envío de Microsoft Store__. Para obtener más información, vea [crear y administrar envíos con Microsoft Store Services](https://docs.microsoft.com/windows/uwp/monetize/create-and-manage-submissions-using-windows-store-services).
...
* [Crear anuncios de banner en XAML y .NET](https://docs.microsoft.com/windows/uwp/monetize/adcontrol-in-xaml-and--net)
* [Creación de anuncios de banner en HTML5 y JavaScript](https://docs.microsoft.com/windows/uwp/monetize/adcontrol-in-html-5-and-javascript)
...
* [Prácticas recomendadas para anuncios de banner](https://docs.microsoft.com/windows/uwp/monetize/ui-and-user-experience-guidelines)
...
* [Tipos de cuenta, ubicaciones y tarifas](https://docs.microsoft.com/windows/uwp/publish/account-types-locations-and-fees)
...
* [Ejecutar experimentos de aplicaciones con pruebas A/B](https://docs.microsoft.com/windows/uwp/monetize/run-app-experiments-with-a-b-testing)
