...
Bucle de un juego de Direct3D 11 de la Tienda Windows
...
Para obtener información detallada sobre el desarrollo de juegos de la Tienda Windows, consulta estos artículos:

-   [Tutorial: un juego simple para UWP con DirectX](tutorial--create-your-first-metro-style-directx-game.md)
