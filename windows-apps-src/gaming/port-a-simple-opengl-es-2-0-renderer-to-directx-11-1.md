...
ms.date: 02/08/2017
ms.topic: article
keywords: Windows 10, UWP, juegos, OpenGL, Direct3D 11, Puerto
...
Este tema empieza tras la creación de un nuevo proyecto en DirectX 11. Para obtener información sobre cómo crear un nuevo proyecto de DirectX 11, lea [creación de un nuevo proyecto de DirectX 11 para plataforma universal de Windows (UWP)](user-interface.md).

El proyecto creado a partir de alguno de estos vínculos tiene todo el código preparado para la infraestructura de [Direct3D](/windows/desktop/direct3d11/dx-graphics-overviews). Puedes empezar a portar el representador de Open GL ES 2.0 a Direct3D 11 inmediatamente.
...
## <a name="span-idkeylinks_steps_headingspansteps"></a><span id="keylinks_steps_heading"></span>Pasos
...
## <a name="span-idadditional_resourcesspanadditional-resources"></a><span id="additional_resources"></span>Recursos adicionales
