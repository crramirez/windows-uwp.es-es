...
- Si el objeto implementa la interfaz [IAgileObject](https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-iagileobject) o tiene el atributo [MarshalingBehaviorAttribute](https://msdn.microsoft.com/library/windows/apps/windows.foundation.metadata.marshalingbehaviorattribute.aspx) con [MarshalingType.Agile](https://msdn.microsoft.com/library/windows/apps/windows.foundation.metadata.marshalingtype.aspx), CLR lo trata como ágil.
...
Puedes acceder al botón de forma segura mediante su propiedad [Dispatcher](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.dependencyobject.dispatcher.aspx) o la propiedad `Dispatcher` de cualquier objeto que existe en el contexto del subproceso de la interfaz de usuario (como la página en la que está el botón). El siguiente código usa el método [RunAsync](https://msdn.microsoft.com/library/windows/apps/windows.ui.core.coredispatcher.aspx) del objeto [CoreDispatcher](https://msdn.microsoft.com/library/windows/apps/windows.ui.core.coredispatcher.runasync.aspx) para enviar la llamada en el subproceso de la interfaz de usuario.
...
Las clases de Windows Runtime que no proporcionan información de serialización tienen el atributo [MarshalingBehaviorAttribute](https://msdn.microsoft.com/library/windows/apps/windows.foundation.metadata.marshalingbehaviorattribute.aspx) con [MarshalingType.None](https://msdn.microsoft.com/library/windows/apps/windows.foundation.metadata.marshalingtype.aspx). La documentación para una clase como esta muestra "MarshalingBehaviorAttribute(None)" entre sus atributos.

El siguiente código crea un objeto [CameraCaptureUI](https://msdn.microsoft.com/library/windows/apps/windows.media.capture.cameracaptureui.aspx) en el subproceso de la interfaz de usuario y luego intenta establecer una propiedad del objeto de un subproceso del grupo de subprocesos. CLR no puede serializar la llamada e inicia una excepción [System.InvalidCastException](/dotnet/api/system.invalidcastexception) con un mensaje que indica que el objeto puede usarse únicamente en el contexto del subproceso donde se creó.
...
La documentación de [CameraCaptureUI](https://msdn.microsoft.com/library/windows/apps/windows.media.capture.cameracaptureui.aspx) también enumera "ThreadingAttribute(STA)" entre los atributos de la clase, porque debe crearse en un contexto de subproceso único, como el subproceso de la interfaz de usuario.

Si quieres acceder al objeto [CameraCaptureUI](https://msdn.microsoft.com/library/windows/apps/windows.media.capture.cameracaptureui.aspx) desde otro subproceso, puedes almacenar en caché el objeto [CoreDispatcher](https://msdn.microsoft.com/library/windows/apps/windows.ui.core.coredispatcher.aspx) para el subproceso de la interfaz de usuario y usarlo más adelante para enviar la llamada en ese subproceso. O bien, puedes obtener el distribuidor de un objeto XAML, como la página, como se muestra en el siguiente código.
...
Para los objetos que se ejecutan en el subproceso de la interfaz de usuario e inician excepciones cuando se las llama desde un subproceso distinto del subproceso de la interfaz de usuario, puedes usar el objeto [CoreDispatcher](https://msdn.microsoft.com/library/windows/apps/windows.ui.core.coredispatcher.aspx) del subproceso de la interfaz de usuario para enviar la llamada.
