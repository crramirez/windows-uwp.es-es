...
### [Crear una aplicación "Hello, world" (JS)](get-started/create-a-hello-world-app-js-uwp.md)
### [Crear una aplicación "Hello, world" (C++)](get-started/create-a-basic-windows-10-app-in-cpp.md)
### [Compatibilidad con la entrada de lápiz en tu aplicación para UWP](get-started/ink-walkthrough.md)
### [Compatibilidad con Surface Dial (y otros dispositivos de rueda) en tu aplicación para UWP](get-started/radialcontroller-walkthrough.md)
### [Una aplicación web de una página y API de REST](get-started/get-started-tutorial-fullstack-web-app.md)
### [Un juego para UWP 2D en JavaScript](get-started/get-started-tutorial-game-js2d.md)
### [Un juego para UWP 3D en JavaScript](get-started/get-started-tutorial-game-js3d.md)
### [Un juego para UWP en MonoGame](get-started/get-started-tutorial-game-mg2d.md)
### [Agregar WebVR a un juego de Babylon.js](get-started/adding-webvr-to-a-babylonjs-game.md)
...
#### [Implementación de la navegación básica](layout/navigate-between-two-pages.md)
#### [Admitir el historial y la navegación hacia atrás](layout/navigation-history-and-backwards-navigation.md)
...
### [Movimiento y animación](style/motion.md)
#### [Animación conectada](style/connected-animation.md)
#### [Transición de contenido](style/content-transition-animations.md)
#### [Agregar y eliminar](style/motion-list.md)
#### [Atenuación](style/motion-fade.md)
...
##### [Instrucciones de activos de iconos y ventanas](controls-and-patterns/tiles-and-notifications-app-assets.md)
##### [Iconos secundarios](controls-and-patterns/tiles-and-notifications-secondary-tiles.md)
###### [Guía](controls-and-patterns/tiles-and-notifications-secondary-tiles-guidance.md)
###### [Anclar iconos secundarios](controls-and-patterns/tiles-and-notifications-secondary-tiles-pinning.md)
###### [Aplicaciones de escritorio](controls-and-patterns/tiles-and-notifications-secondary-tiles-desktop-pinning.md)
##### [Contenido de icono](controls-and-patterns/tiles-and-notifications-create-adaptive-tiles.md)
##### [Esquema de contenido de icono](controls-and-patterns/tiles-and-notifications-adaptive-tiles-schema.md)
##### [Plantillas de iconos especiales](controls-and-patterns/tiles-and-notifications-special-tile-templates-catalog.md)
##### [Enviar notificación de icono local](controls-and-patterns/tiles-and-notifications-sending-a-local-tile-notification.md)
##### [API de icono principal](controls-and-patterns/tiles-and-notifications-primary-tile-apis.md)
#### [Anclar tu aplicación a la barra de tareas](controls-and-patterns/pin-to-taskbar.md)
#### [Notificaciones del sistema](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [Contenido de notificaciones del sistema](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [Esquema de contenido de las notificaciones del sistema](controls-and-patterns/tiles-and-notifications-toast-schema.md)
##### [Enviar notificaciones del sistema local](controls-and-patterns/tiles-and-notifications-send-local-toast.md)
...
##### [Tipos de canales de notificaciones](controls-and-patterns/tiles-and-notifications/channel-types.md)
...
##### [Interacciones de teclado personalizadas](input-and-devices/custom-keyboard-interactions.md)
...
#### [Administrar la navegación del foco](input-and-devices/managing-focus-navigation.md)
...
#### [Migrar recursos heredados](globalizing/using-mrt-for-converted-desktop-apps-and-games.md)
...
## [Novedades para desarrolladores en Windows 10, versión 1703](whats-new/windows-10-version-latest.md)
### [API añadidas en Windows10, versión 1703](whats-new/windows-10-version-1703-api-diff.md)
### [API de versión preliminar en la compilación 16257 de Windows 10 SDK Preview](whats-new/windows-10-latest-preview-api-diff.md)
### [Novedades de Windows10 Build 2017 Preview](whats-new/windows-10-build-16190.md)
### [Novedades de Windows10, versión 1607](whats-new/windows-10-version-1607.md)
...
## [Novedades de los documentos de Windows, agosto de 2017](whats-new/windows-docs-latest.md)
...
### [Entity Framework Core con SQLite para aplicaciones de C#](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
#### [Escribir un complemento personalizado para Device Portal](debug-test-perf/device-portal-plugin.md)
...
#### [Introducción a POS](devices-sensors/pos-get-started.md)
#### [Compatibilidad con dispositivos POS](devices-sensors/pos-device-support.md)
#### [Emparejamiento fuera de banda](devices-sensors/out-of-band-pairing.md)
#### [ESC/POS de Epson con formato](devices-sensors/epson-esc-pos-with-formatting.md)
#### [Implementar perfiles de escáner de códigos de barras](devices-sensors/deploy-scanner-profiles-with-mdm.md)
...
### [Permisos de acceso de archivos](files/file-access-permissions.md)
...
#### [Objeto de aplicación](gaming/about-the-metro-style-user-interface-and-directx.md)
...
#### [Juego sencillo para UWP](gaming/tutorial--create-your-first-metro-style-directx-game.md)
##### [Configurar el proyecto](gaming/tutorial--setting-up-the-games-infrastructure.md)
##### [Marco de UWP](gaming/tutorial--building-the-games-metro-style-app-framework.md)
##### [Objeto principal del juego](gaming/tutorial--defining-the-main-game-loop.md)
##### [Marco de representación](gaming/tutorial--assembling-the-rendering-pipeline.md)
...
#### [Ampliar la aplicación con servicios de aplicaciones, extensiones y paquetes](launch-resume/extend-your-app-with-services-extensions-packages.md)
### [Compatibilidad de la aplicación con tareas en segundo plano](launch-resume/support-your-app-with-background-tasks.md)
...
## [Monetización, interacción y servicios de la Tienda](monetize/index.md)
...
#### [Esquemas de datos para productos de la Tienda](monetize/data-schemas-for-store-products.md)
...
#### [Introducción](monetize/get-started-with-microsoft-advertising-libraries.md)
##### [Instalar el SDK de Microsoft Advertising](monetize/install-the-microsoft-advertising-libraries.md)
##### [Actualizar la aplicación con las bibliotecas más recientes](monetize/update-your-app-to-the-latest-advertising-libraries.md)
...
##### [Administración de errores](monetize/error-handling-with-advertising-libraries.md)
##### [Tamaños admitidos de anuncios de banner](monetize/supported-ad-sizes-for-banner-ads.md)
#### [Tutoriales para desarrolladores](monetize/developer-walkthroughs.md)
...
### [Captar a clientes con Microsoft Store Services SDK](monetize/microsoft-store-services-sdk.md)
#### [Ejecución de experimentos de aplicaciones con pruebas A/B](monetize/run-app-experiments-with-a-b-testing.md)
##### [Crear un proyecto de experimento en el panel](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
...
##### [Obtener clasificaciones de la aplicación](monetize/get-app-ratings.md)
...
##### [Obtener datos de informes de errores para la aplicación](monetize/get-error-reporting-data.md)
###### [Obtener los detalles de un error de la aplicación](monetize/get-details-for-an-error-in-your-app.md)
###### [Obtener el seguimiento de la pila de un error de la aplicación](monetize/get-the-stack-trace-for-an-error-in-your-app.md)
###### [Descargar el archivo .CAB para un error de la aplicación](monetize/download-the-cab-file-for-an-error-in-your-app.md)
##### [Obtener datos de informes de errores para controladores de Windows 10](monetize/get-error-reporting-data-for-windows-10-drivers.md)
###### [Obtener los detalles de un error de controlador de Windows 10](monetize/get-details-for-a-windows-10-driver-error.md)
###### [Descargar el archivo .cab para un error de controlador de Windows 10](monetize/download-the-cab-file-for-a-windows-10-driver-error.md)
##### [Obtener datos de informes de errores para controladores de Windows 7 y Windows 8.x](monetize/get-error-reporting-data-for-windows-7-and-windows-8.x-drivers.md)
###### [Obtener los detalles para un error de controlador de Windows 7 o Windows 8.x](monetize/get-details-for-a-windows-7-or-windows-8.x-driver-error.md)
###### [Descargar el archivo .cab para un error de controlador de Windows 7 o Windows 8.x](monetize/download-the-cab-file-for-a-windows-7-or-windows-8.x-driver-error.md)
##### [Obtener datos de informes de errores de hardware OEM](monetize/get-oem-hardware-error-reporting-data.md)
###### [Obtener detalles para un error de hardware OEM](monetize/get-details-for-an-oem-hardware-error.md)
###### [Descargar el archivo .cab para un error de hardware OEM](monetize/download-the-cab-file-for-an-oem-hardware-error.md)
...
###### [Actualización de un envío de aplicación](monetize/update-an-app-submission.md)
...
###### [Actualización de un envío de complemento](monetize/update-an-add-on-submission.md)
...
##### [Reclamar una oferta dirigida](monetize/claim-a-targeted-offer.md)
#### [Administrar los derechos de producto de un servicio](monetize/view-and-grant-products-from-a-service.md)
...
### [Enviar solicitudes a la Tienda](monetize/send-requests-to-the-store.md)
...
#### [Firmar un paquete de la aplicación con SignTool](packaging/sign-app-package-using-signtool.md)
...
### [Paquetes opcionales y creación de conjuntos relacionados](packaging/optional-packages.md)
...
### [Puente de dispositivo de escritorio](porting/desktop-to-uwp-root.md)
...
##### [Probar para Windows 10 S](porting/desktop-to-uwp-test-windows-s.md)
...
### [Iluminación de composición](composition/lighting.md)
### [Usar XAML](composition/using-the-visual-layer-with-xaml.md)
...
#### [Configurar la programación de lanzamiento precisa](publish/configure-precise-release-scheduling.md)
...
#### [Creación de descripciones de la Tienda específicas de la plataforma](publish/create-platform-specific-store-listings.md)
...
### [Acerca de los anuncios de filial](publish/about-affiliate-ads.md)
...
## [Analizar el rendimiento de la aplicación](publish/analytics.md)
