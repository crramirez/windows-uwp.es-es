...
#### [Responder a las opiniones de los clientes](monetize/respond-to-reviews-using-windows-store-services.md)
##### [Obtención de información acerca de las respuesta a las opiniones sobre la aplicación](monetize/get-response-info-for-app-reviews.md)
##### [Envío de respuestas a las opiniones sobre la aplicación](monetize/submit-responses-to-app-reviews.md)
#### [Ejecución de campañas publicitarias](monetize/run-ad-campaigns-using-windows-store-services.md)
##### [Administración de las campañas publicitarias](monetize/manage-ad-campaigns.md)
##### [Administración de las líneas de entrega de las campañas publicitarias](monetize/manage-delivery-lines-for-ad-campaigns.md)
##### [Administración de los perfiles de selección de destino de las campañas publicitarias](monetize/manage-targeting-profiles-for-ad-campaigns.md)
##### [Administración de los creativos de las campañas publicitarias](monetize/manage-creatives-for-ad-campaigns.md)
...
#### [Administración de los derechos de producto desde un servicio](monetize/view-and-grant-products-from-a-service.md)
...
### [Creación de un certificado para la firma de un paquete](packaging/create-certificate-package-signing.md)
### [Firmar un paquete de aplicación con SignTool](packaging/sign-app-package-using-signtool.md)
...
#### [API de UWP admitidas para aplicaciones convertidas con el Puente de dispositivo de escritorio](porting/desktop-to-uwp-supported-api.md)
#### [Guía de empaquetado del Puente de dispositivo de escritorio para aplicaciones de escritorio .NET con Visual Studio](porting/desktop-to-uwp-packaging-dot-net.md)
#### [Depurar aplicaciones convertidas con el Puente de dispositivo de escritorio](porting/desktop-to-uwp-debug.md)
#### [Firmar una aplicación convertida con el Puente de dispositivo de escritorio](porting/desktop-to-uwp-signing.md)
...
## [Novedades para desarrolladores de Windows 10](whats-new/windows-10-creators-preview.md)
### [Novedades de Windows 10, versión 1607](whats-new/windows-10-version-1607.md)
...
### [Informe Clasificaciones](publish/ratings-report.md)
...
### [Informe de rendimiento de filial](publish/affiliates-performance-report.md)
### [Informe de promoción de la aplicación](publish/promote-your-app-report.md)
