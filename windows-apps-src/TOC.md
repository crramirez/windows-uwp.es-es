...
#### [Administrar la reanudación de la aplicación](launch-resume/resume-an-app.md)
#### [Liberar memoria cuando la aplicación pase a segundo plano](launch-resume/reduce-memory-usage.md)
### [Administrar la activación de los identificadores URI](launch-resume/launch-app-with-uri.md)
#### [Iniciar la aplicación predeterminada de un URI](launch-resume/launch-default-app.md)
#### [Administrar la activación de los identificadores URI](launch-resume/handle-uri-activation.md)
...
### [Aplicación de demostración comercial](monetize/retail-demo-experience.md)
## [Servicios web y redes](networking/index.md)
### [Conceptos básicos de redes](networking/networking-basics.md)
### [¿Qué tecnología de redes?](networking/which-networking-technology.md)
