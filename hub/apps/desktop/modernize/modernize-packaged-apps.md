...
## <a name="use-uwp-apis-that-require-package-identity"></a>Uso de las API de UWP que requieren la identidad del paquete

La siguiente lista de API de UWP requieren que se use la identidad de paquete: [lista de API](desktop-to-uwp-supported-api.md#list-of-apis).
