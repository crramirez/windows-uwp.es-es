...
4. En el terminal de VS Code, abra Python simplemente escribiendo el comando:`python`
...
6. Cuente el número de veces que se usa la letra "l" en la variable `variable.count("l")`de cadena:.
